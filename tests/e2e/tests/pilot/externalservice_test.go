...
func TestServiceEntry(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:              "REACHABLE_in.google.com_over_google_wildcard",
			config:            "testdata/networking/v1alpha3/wildcard-tls-google.yaml",
			url:               "https://www.google.co.in/",
			shouldBeReachable: true,
		},
		{
			name:              "REACHABLE_uk.google.com_over_google_wildcard",
			config:            "testdata/networking/v1alpha3/wildcard-tls-google.yaml",
			url:               "https://www.google.co.uk/",
			shouldBeReachable: true,
		},
		{
			name:              "UNREACHABLE_www.bing.org_over_google_wildcard",
			config:            "testdata/networking/v1alpha3/wildcard-tls-google.yaml",
			url:               "https://www.bing.com",
			shouldBeReachable: false,
		},
		...
		{
			name:              "UNREACHABLE_google.com_no_vs_over_google_wildcard_80",
			config:            "testdata/networking/v1alpha3/wildcard-tls-google-no-vs.yaml",
			url:               "http://www.google.com",
			shouldBeReachable: false,
		},
		{
			name:              "UNREACHABLE_uk.google.com_no_vs_over_google_wildcard_80",
			config:            "testdata/networking/v1alpha3/wildcard-tls-google-no-vs.yaml",
			url:               "http://www.google.co.uk/",
			shouldBeReachable: false,
		},
		{
			name:              "UNREACHABLE_in.google.com_no_vs_over_google_wildcard_80",
			config:            "testdata/networking/v1alpha3/wildcard-tls-google-no-vs.yaml",
		...
		{
			name:              "UNREACHABLE_google.com_no_vs_over_google_wildcard_",
			config:            "testdata/networking/v1alpha3/wildcard-https-google-no-vs.yaml",
			url:               "https://www.google.com",
			shouldBeReachable: false,
		},

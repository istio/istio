...
type NodeMetadata struct {
	...
	// SdsEnabled indicates if SDS is enabled or not. This is set to "1" if true
	SdsEnabled StringBool `json:"SDS,omitempty"`
	// SdsTrustJwt indicates if SDS trust jwt is enabled or not. This is set to "1" if true

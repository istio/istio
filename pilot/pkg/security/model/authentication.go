...
// ConstructSdsSecretConfigForSDSEndpoint constructs SDS Secret Configuration based on GatewayCertSocketPath
// if GatewayCertSocketPath exists, use a static cluster 'sds-external'

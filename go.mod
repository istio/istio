...
replace (
	github.com/envoyproxy/go-control-plane => github.com/higress-group/go-control-plane v0.0.0-20240130032431-b9243474e0a8
...
require (
	...
	istio.io/client-go v1.19.5-0.20231206015206-8cdf6a3b3cfd
	k8s.io/api v0.28.1

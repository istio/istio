			...
			wantServices: []*model.Service{
				{
					...
					Resolution:               model.ClientSideLB,
					DefaultAddress:           "0.0.0.0",
					AutoAllocatedIPv4Address: "240.240.90.107",
					AutoAllocatedIPv6Address: "2001:2::f0f0:5a6b",
				},
			},
		},
		{
			...
			wantServices: []*model.Service{
				{
					...
					Resolution:               model.DNSLB,
					DefaultAddress:           "0.0.0.0",
					AutoAllocatedIPv4Address: "240.240.204.151",
					AutoAllocatedIPv6Address: "2001:2::f0f0:cc97",
				},
				{
					Hostname:                 "a44155.example.com",
					Resolution:               model.DNSLB,
					DefaultAddress:           "0.0.0.0",
					AutoAllocatedIPv4Address: "240.240.94.141",
					AutoAllocatedIPv6Address: "2001:2::f0f0:5e8d",
				},
			},
		},
		{
			...
			wantServices: []*model.Service{
				{
					...
					Resolution:               model.DNSLB,
					DefaultAddress:           "0.0.0.0",
					AutoAllocatedIPv4Address: "240.240.75.9",
					AutoAllocatedIPv6Address: "2001:2::f0f0:4b9",
				},
			},
		},
		{
			...
			wantServices: []*model.Service{
				...
				},
				{
					...
					Resolution:               model.DNSLB,
					DefaultAddress:           "0.0.0.0",
					AutoAllocatedIPv4Address: "240.240.244.248",
					AutoAllocatedIPv6Address: "2001:2::f0f0:f4f8",
				},
			},
		},
	}
...
func Test_autoAllocateIP_values(t *testing.T) {
	inServices := make([]*model.Service, maxIPs)
	for i := 0; i < int(maxIPs); i++ {
		temp := model.Service{

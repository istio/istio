...
=======
	"testdata": {nil, map[string]*bintree{
		...
		"config-v1alpha2-kubernetes-valid-skipped.yaml":         {testdataConfigV1alpha2KubernetesValidSkippedYaml, map[string]*bintree{}},
		...
		"networking-v1alpha3-ServiceEntry-valid-skipped.yaml":   {testdataNetworkingV1alpha3ServiceentryValidSkippedYaml, map[string]*bintree{}},
		...
		"rbac-v1alpha1-ServiceRole-invalid.yaml":                {testdataRbacV1alpha1ServiceroleInvalidYaml, map[string]*bintree{}},
		"rbac-v1alpha1-ServiceRole-valid.yaml":                  {testdataRbacV1alpha1ServiceroleValidYaml, map[string]*bintree{}},
		"rbac-v1alpha1-ServiceRoleBinding-invalid.yaml":         {testdataRbacV1alpha1ServicerolebindingInvalidYaml, map[string]*bintree{}},
		"rbac-v1alpha1-ServiceRoleBinding-valid.yaml":           {testdataRbacV1alpha1ServicerolebindingValidYaml, map[string]*bintree{}},
>>>>>>> upstream/master
	}},
}}

...
func createTestDestinationRuleConfig(name, namespace, host string) *Config {
	return &Config{
...
func TestDestinationRule(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "when proxy is nil, check for a public rule in all namespaces, then return a matching rule else return nil",
		...
		{
			name:        "when proxy is not nil, and does not have a sidecar scope, and if proxy's namespace is different from root namespace, then return a matching rule in the proxy's namespace",
		...
		{
			name:        "when proxy is not nil, and does not have a sidecar scope and there are no private/public rules matched in the calling proxy's namespace, then return matching rule in the target's namespace",
		...
		{
			name:        "when proxy is not nil, and does not have a sidecar scope, and there are no public or private rule in the calling proxy's namespace, then return a matching public rule in the config root's namespace",
		...
		{
			name:        "when proxy is not nil, and does not have a sidecar scope, and there are no public or private rule in the calling proxy's namespace, and no matching public rule in the config root's namespace then return nil",

...
type InstanceMsg struct {
	...
	//
	// Optional.
	ForceSample bool `protobuf:"varint,11,opt,name=force_sample,json=forceSample,proto3" json:"force_sample,omitempty"`
}
...
type InstanceParam struct {
	...
	//
	// Optional.
	ForceSample string `protobuf:"bytes,11,opt,name=force_sample,json=forceSample,proto3" json:"force_sample,omitempty"`
}
...
func (m *InstanceParam) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ForceSample) > 0 {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintTracespanHandlerService(dAtA, i, uint64(len(m.ForceSample)))
		i += copy(dAtA[i:], m.ForceSample)
	}
	return i, nil
}
...
func (this *InstanceMsg) String() string {
	...
	s := strings.Join([]string{`&InstanceMsg{`,
		...
		`ForceSample:` + fmt.Sprintf("%v", this.ForceSample) + `,`,
...
func (m *InstanceMsg) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ForceSample", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *InstanceParam) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			...
			m.ForceSample = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTracespanHandlerService(dAtA[iNdEx:])
...
var fileDescriptorTracespanHandlerService = []byte{
	...
	,
}

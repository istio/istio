...
func TestECDSGenerate(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			watchedResources: []string{"istio.io/wasmplugin/default.default-plugin"},
			wantExtensions:   sets.String{"istio.io/wasmplugin/default.default-plugin": {}},
			wantSecrets:      sets.String{},
		},
		{
			...
			proxyNamespace:   "default",
			request:          &model.PushRequest{Full: true},
			watchedResources: []string{"istio.io/wasmplugin/default.default-plugin-with-sec"},
			wantExtensions:   sets.String{"istio.io/wasmplugin/default.default-plugin-with-sec": {}},
		...
		},
		{
			...
			proxyNamespace:   "default",
			request:          &model.PushRequest{Full: true},
			watchedResources: []string{"istio.io/wasmplugin/default.default-plugin-wrong-sec"},
			wantExtensions:   sets.String{"istio.io/wasmplugin/default.default-plugin-wrong-sec": {}},
			wantSecrets:      sets.String{},
		},
		{
			...
			proxyNamespace:   "default",
			request:          &model.PushRequest{Full: true},
			watchedResources: []string{"istio.io/wasmplugin/default.default-plugin-wrong-sec-type"},
			wantExtensions:   sets.String{"istio.io/wasmplugin/default.default-plugin-wrong-sec-type": {}},
			wantSecrets:      sets.String{},
		},
		{
			...
			proxyNamespace:   "default",
			request:          &model.PushRequest{Full: true},
			watchedResources: []string{"istio.io/wasmplugin/default.default-plugin-with-sec", "istio.io/wasmplugin/istio-system.root-plugin"},
			wantExtensions:   sets.String{"istio.io/wasmplugin/default.default-plugin-with-sec": {}, "istio.io/wasmplugin/istio-system.root-plugin": {}},
		...
		},
		{
			...
			request:          &model.PushRequest{Full: true},
			watchedResources: []string{"istio.io/wasmplugin/istio-system.root-plugin"},
			wantExtensions:   sets.String{"istio.io/wasmplugin/istio-system.root-plugin": {}},

...
resources:
  ...
  - kind: "VirtualService"
    ...
    description: "describes v1beta1 route rules"
  ...
  - kind: "Gateway"
    ...
    protoPackage: "istio.io/api/networking/v1alpha3"
    description: "describes a v1alpha3 gateway (how a proxy is exposed on the network)"
  ...
  - kind: "Gateway"
    ...
    protoPackage: "istio.io/api/networking/v1beta1"
    description: "describes a v1beta1 gateway (how a proxy is exposed on the network)"
  ...
  - kind: "ServiceEntry"
    ...
    protoPackage: "istio.io/api/networking/v1alpha3"
    description: "describes v1alpha3 service entries"
  ...
  - kind: "ServiceEntry"
    ...
    protoPackage: "istio.io/api/networking/v1beta1"
    description: "describes v1beta1 service entries"
  ...
  - kind: "WorkloadEntry"
    ...
    protoPackage: "istio.io/api/networking/v1alpha3"
    description: "describes v1alpha3 workload entries"
  ...
  - kind: "WorkloadEntry"
    ...
    protoPackage: "istio.io/api/networking/v1beta1"
    description: "describes v1beta1 workload entries"
  ...
  - kind: "DestinationRule"
    ...
    protoPackage: "istio.io/api/networking/v1alpha3"
    description: "describes v1alpha3 destination rules"
  ...
  - kind: "DestinationRule"
    ...
    protoPackage: "istio.io/api/networking/v1beta1"
    description: "describes v1beta1 destination rules"
...
transforms:
  - type: direct
    mapping:
      ...
      "k8s/networking.istio.io/v1beta1/destinationrules": "istio/networking/v1beta1/destinationrules"
      "k8s/networking.istio.io/v1beta1/gateways": "istio/networking/v1beta1/gateways"
      "k8s/networking.istio.io/v1beta1/serviceentries": "istio/networking/v1beta1/serviceentries"
      "k8s/networking.istio.io/v1beta1/workloadentries": "istio/networking/v1beta1/workloadentries"
      "k8s/networking.istio.io/v1beta1/sidecars": "istio/networking/v1beta1/sidecars"
      "k8s/networking.istio.io/v1beta1/virtualservices": "istio/networking/v1beta1/virtualservices"

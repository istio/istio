...
type MeshConfig struct {
	...
	// will cause the sidecars to route traffic to the any unknown traffic
	// originating from the application to its requested destination.  Users
	// are strongly encouraged to use ServiceEntries to explicitly declare
	// any external dependencies, instead of using allow_any, so that traffic
	// to these services can be monitored.
...
var fileDescriptorConfig = []byte{
	...
	,
}

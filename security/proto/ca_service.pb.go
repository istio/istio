...
func (*CsrRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca_service_1c8f6a408fa7ab3b, []int{0}
}
...
func (dst *CsrRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CsrRequest.Merge(dst, src)
}
...
type CsrResponse struct {
	...
	Status     *rpc.Status `protobuf:"bytes,2,opt,name=status" json:"status,omitempty"`
...
func (*CsrResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca_service_1c8f6a408fa7ab3b, []int{1}
}
...
func (dst *CsrResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CsrResponse.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("security/proto/ca_service.proto", fileDescriptor_ca_service_1c8f6a408fa7ab3b)
}

var fileDescriptor_ca_service_1c8f6a408fa7ab3b = []byte{

...
require (
	...
	istio.io/api v0.0.0-20220412170844-98b86b0a79ee
	istio.io/client-go v1.12.0-alpha.5.0.20220412171342-f891b6af6bd5
...
require (
	...
	github.com/docker/distribution v2.8.1gti diff+incompatible // indirect

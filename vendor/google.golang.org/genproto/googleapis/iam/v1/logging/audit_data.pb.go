...
func (*AuditData) Descriptor() ([]byte, []int) {
	return fileDescriptor_audit_data_ce2b3115f2617916, []int{0}
}
...
func init() {
	proto.RegisterFile("google/iam/v1/logging/audit_data.proto", fileDescriptor_audit_data_ce2b3115f2617916)
}

var fileDescriptor_audit_data_ce2b3115f2617916 = []byte{

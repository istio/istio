...
func (*Reference) Descriptor() ([]byte, []int) {
	return fileDescriptor_references_5de88386bc96d288, []int{0}
}
...
func (*ReferenceSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_references_5de88386bc96d288, []int{1}
}
...
func (*SearchReferenceSetsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_references_5de88386bc96d288, []int{2}
}
...
func (*SearchReferenceSetsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_references_5de88386bc96d288, []int{3}
}
...
func (*GetReferenceSetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_references_5de88386bc96d288, []int{4}
}
...
func (*SearchReferencesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_references_5de88386bc96d288, []int{5}
}
...
func (*SearchReferencesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_references_5de88386bc96d288, []int{6}
}
...
func (*GetReferenceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_references_5de88386bc96d288, []int{7}
}
...
func (*ListBasesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_references_5de88386bc96d288, []int{8}
}
...
func (*ListBasesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_references_5de88386bc96d288, []int{9}
}
...
func init() {
	proto.RegisterFile("google/genomics/v1/references.proto", fileDescriptor_references_5de88386bc96d288)
}

var fileDescriptor_references_5de88386bc96d288 = []byte{

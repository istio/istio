...
func (BuildStatus_Result) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_build_status_1099fd04a2329418, []int{0, 0}
}
...
func (*BuildStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_build_status_1099fd04a2329418, []int{0}
}
...
func init() {
	proto.RegisterFile("google/devtools/build/v1/build_status.proto", fileDescriptor_build_status_1099fd04a2329418)
}

var fileDescriptor_build_status_1099fd04a2329418 = []byte{

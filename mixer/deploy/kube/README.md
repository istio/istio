All the configuration below and in this directory is for test/dev of
Mixer and potentially out of date. Official Istio install files are
under [`/insall/kubernetes`](/install/kubernetes).
...
[`/addons/grafana/grafana-dashboard.json`](/addons/grafana/grafana-dashboard.json). It

...
data:
  ...
  config: |-
    ...
    template: |
      {{- $holdProxy := default .Values.global.proxy.holdApplicationUntilProxyStarts .ProxyConfig.HoldApplicationUntilProxyStarts.GetValue }}
      ...
      {{- end }}
        ...
        - name: AM_I_HOLD
          value: "Val: {{- .Values.global.proxy.holdApplicationUntilProxyStarts }}; PC: {{- .ProxyConfig.HoldApplicationUntilProxyStarts.GetValue }}; Var: {{- $holdProxy }}"
...
global:
  ...
  # External istiod controls all remote clusters: disabled by default
  externalIstiod: false
  # Deprecated: central istiod controls all remote clusters: disabled by default
  centralIstiod: false
...
var _profilesProfilesMd = []byte(`# Kubernetes Vendor Optimized Profiles
...
func profilesProfilesMdBytes() ([]byte, error) {
	return _profilesProfilesMd, nil
}

func profilesProfilesMd() (*asset, error) {
	bytes, err := profilesProfilesMdBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "profiles/PROFILES.md", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"profiles/PROFILES.md":                                                          profilesProfilesMd,
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"profiles": &bintree{nil, map[string]*bintree{
		"PROFILES.md":    &bintree{profilesProfilesMd, map[string]*bintree{}},

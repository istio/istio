...
- name: istio-proxy
  ...
  [[ else if ne "" (index .ObjectMeta.Labels "app.kubernetes.io/instance") -]]
  - "[[ index .ObjectMeta.Labels "app.kubernetes.io/instance" ]].[[ valueOrDefault .DeploymentMeta.Namespace "default" ]]"
  [[ else if ne "" (index .ObjectMeta.Labels "app.kubernetes.io/name") -]]
  - "[[ index .ObjectMeta.Labels "app.kubernetes.io/name" ]].[[ valueOrDefault .DeploymentMeta.Namespace "default" ]]"
  [[ else -]]

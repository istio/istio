...
func UpgradeCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) (e error) {
			l := log2.NewConsoleLogger(rootArgs.logToStdErr, cmd.OutOrStdout(), cmd.OutOrStderr())
...
func upgrade(rootArgs *rootArgs, args *upgradeArgs, l *log2.ConsoleLogger) (err error) {
...
func checkUpgradeIOPS(curIOPS, tarIOPS, ignoreIOPS string, l *log2.ConsoleLogger) {
...
func waitForConfirmation(skipConfirmation bool, l *log2.ConsoleLogger) {
	if skipConfirmation {
		return
	}
...
func retrieveControlPlaneVersion(kubeClient manifest.ExecClient, istioNamespace string, l *log2.ConsoleLogger) (string, error) {
...
func waitUpgradeComplete(kubeClient manifest.ExecClient, istioNamespace string, targetVer string, l *log2.ConsoleLogger) error {

...
copy-templates:
	...
	sed -e '1 i {{- if and .Values.global.configCluster (or (not .Values.base.ReleaseChannel) (eq .Values.base.ReleaseChannel "standard")) }}' -e '$$ a {{- end }}' manifests/charts/base/files/standard.gen.yaml > manifests/charts/istiod-remote/files/standard.gen.yaml

...
import (
	...
	"istio.io/istio/mixer/adapter/denier/cmd/server"
)
...
func GetCmd(_ []string) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "denier",
		Short: "Istio denier out of process adapter.",
...
func runServer(args *Args) {
	s, err := server.NewDenierNoSessionServer(args.AdapterPort, args.APIWorkerPoolSize, args.Cert)
	if err != nil {

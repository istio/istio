...
func init() {
	proto.RegisterFile("google/bigtable/admin/table/v1/bigtable_table_service.proto", fileDescriptor_bigtable_table_service_150d8fd4b53ea7fb)
}

var fileDescriptor_bigtable_table_service_150d8fd4b53ea7fb = []byte{

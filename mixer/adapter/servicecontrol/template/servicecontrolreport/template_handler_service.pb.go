...
func (*HandleServicecontrolReportRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_de58e20860112987, []int{0}
}
func (m *HandleServicecontrolReportRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HandleServicecontrolReportRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HandleServicecontrolReportRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *HandleServicecontrolReportRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HandleServicecontrolReportRequest.Merge(dst, src)
}
func (m *HandleServicecontrolReportRequest) XXX_Size() int {
	return m.Size()
}
func (m *HandleServicecontrolReportRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_HandleServicecontrolReportRequest.DiscardUnknown(m)
}

var xxx_messageInfo_HandleServicecontrolReportRequest proto.InternalMessageInfo
...
type InstanceMsg struct {
	...
	RequestTime          *v1beta1.TimeStamp `protobuf:"bytes,6,opt,name=request_time,json=requestTime" json:"request_time,omitempty"`
	...
	ResponseTime         *v1beta1.TimeStamp `protobuf:"bytes,10,opt,name=response_time,json=responseTime" json:"response_time,omitempty"`
	...
	ResponseLatency      *v1beta1.Duration  `protobuf:"bytes,13,opt,name=response_latency,json=responseLatency" json:"response_latency,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (*InstanceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_de58e20860112987, []int{1}
}
...
func (*Type) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_de58e20860112987, []int{2}
}
...
func (*InstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_de58e20860112987, []int{3}
}
...
type HandleServicecontrolReportServiceClient interface {
	...
	HandleServicecontrolReport(ctx context.Context, in *HandleServicecontrolReportRequest, opts ...grpc.CallOption) (*v1beta11.ReportResult, error)
}
...
func (c *handleServicecontrolReportServiceClient) HandleServicecontrolReport(ctx context.Context, in *HandleServicecontrolReportRequest, opts ...grpc.CallOption) (*v1beta11.ReportResult, error) {
	out := new(v1beta11.ReportResult)
	err := c.cc.Invoke(ctx, "/servicecontrolreport.HandleServicecontrolReportService/HandleServicecontrolReport", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HandleServicecontrolReportServiceServer interface {
	// HandleServicecontrolReport is called by Mixer at request-time to deliver 'servicecontrolreport' instances to the backend.
	HandleServicecontrolReport(context.Context, *HandleServicecontrolReportRequest) (*v1beta11.ReportResult, error)
}
...
func (this *InstanceMsg) String() string {
	...
	s := strings.Join([]string{`&InstanceMsg{`,
		...
		`RequestTime:` + strings.Replace(fmt.Sprintf("%v", this.RequestTime), "TimeStamp", "v1beta1.TimeStamp", 1) + `,`,
		...
		`ResponseTime:` + strings.Replace(fmt.Sprintf("%v", this.ResponseTime), "TimeStamp", "v1beta1.TimeStamp", 1) + `,`,
		`ResponseCode:` + fmt.Sprintf("%v", this.ResponseCode) + `,`,
		`ResponseBytes:` + fmt.Sprintf("%v", this.ResponseBytes) + `,`,
		`ResponseLatency:` + strings.Replace(fmt.Sprintf("%v", this.ResponseLatency), "Duration", "v1beta1.Duration", 1) + `,`,
...
func (m *InstanceMsg) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if m.RequestTime == nil {
				m.RequestTime = &v1beta1.TimeStamp{}
			}
		...
		case 10:
			...
			if m.ResponseTime == nil {
				m.ResponseTime = &v1beta1.TimeStamp{}
			}
		...
		case 13:
			...
			if m.ResponseLatency == nil {
				m.ResponseLatency = &v1beta1.Duration{}
			}
...
func init() {
	proto.RegisterFile("mixer/adapter/servicecontrol/template/servicecontrolreport/template_handler_service.proto", fileDescriptor_template_handler_service_de58e20860112987)
}

var fileDescriptor_template_handler_service_de58e20860112987 = []byte{

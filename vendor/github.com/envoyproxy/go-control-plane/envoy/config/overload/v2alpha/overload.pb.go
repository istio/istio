...
func (m *ResourceMonitor) GetConfig() *google_protobuf1.Struct {
	if m != nil {
		return m.Config
	}
	return nil
...
type OverloadManager struct {
	...
	RefreshInterval *google_protobuf.Duration `protobuf:"bytes,1,opt,name=refresh_interval,json=refreshInterval" json:"refresh_interval,omitempty"`
...
func (m *OverloadManager) GetRefreshInterval() *google_protobuf.Duration {
	if m != nil {
...
func (m *OverloadManager) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.RefreshInterval == nil {
				m.RefreshInterval = &google_protobuf.Duration{}
			}

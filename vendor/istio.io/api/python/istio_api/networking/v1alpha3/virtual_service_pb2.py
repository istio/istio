...
_DESTINATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='name', full_name='istio.networking.v1alpha3.Destination.name', index=3,
...
_HTTPMATCHREQUEST.fields_by_name['port'].message_type = _PORTSELECTOR
...
_L4MATCHATTRIBUTES.fields_by_name['port'].message_type = _PORTSELECTOR

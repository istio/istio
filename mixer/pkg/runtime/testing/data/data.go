...
// DynamicAdapter is the adapter generated from: https://github.com/istio/istio/wiki/Mixer-Out-Of-Process-Adapter-Walkthrough
// with the template reportnothing
var DynamicAdapter = `
apiVersion: "config.istio.io/v1alpha2"
kind: adapter
metadata:
...
// DynamicTemplate is copied from mixer/template/reportnothing/template.yaml and renamed to 'tdynreport'
var DynamicTemplate = `
apiVersion: "config.istio.io/v1alpha2"
kind: template
metadata:
  ...
  namespace: istio-system
spec:
  descriptor: ` + dynamicTemplateConfig

// FqnHandlerDynamic is full qualified name of hdyn1
var FqnHandlerDynamic = "hdyn1.handler.istio-system"

// HandlerDynamic1 is the handler of DynamicAdapter
var HandlerDynamic1 = `
apiVersion: "config.istio.io/v1alpha2"
kind: handler
metadata:
  ...
  namespace: istio-system
spec:
  adapter: tgrpcadapter
  connection:
    address: "tgrpcadapter:8888"
`

// HandlerDynamic2 is same to HandlerDynamic1 except for the address
var HandlerDynamic2 = `
apiVersion: "config.istio.io/v1alpha2"
kind: handler
metadata:
...
spec:
  adapter: tgrpcadapter
  connection:
    address: "tgrpcadapter:8889"
`

// InstanceDynamic is the instance of the template tdynreport
var InstanceDynamic = `
apiVersion: "config.istio.io/v1alpha2"
kind: instance
metadata:
...
// RuleDynamic is the rule for idynreport1 and hdyn1
var RuleDynamic = `
apiVersion: "config.istio.io/v1alpha2"
kind: rule
metadata:
...
spec:
  actions:
  - handler: hdyn1.handler
    instances:
    - idynreport1.istio-system
`

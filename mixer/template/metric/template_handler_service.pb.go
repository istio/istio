...
func (*HandleMetricRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_09f8e924e58c3f6d, []int{0}
}
...
func (dst *HandleMetricRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HandleMetricRequest.Merge(dst, src)
}
...
type InstanceMsg struct {
	...
	Value *v1beta1.Value `protobuf:"bytes,1,opt,name=value" json:"value,omitempty"`
	// The unique identity of the particular metric to report.
	Dimensions map[string]*v1beta1.Value `protobuf:"bytes,2,rep,name=dimensions" json:"dimensions,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	...
	// If the metric backend supports monitored resources, these fields are used to populate that resource. Otherwise
	// these fields will be ignored by the adapter.
	MonitoredResourceDimensions map[string]*v1beta1.Value `protobuf:"bytes,4,rep,name=monitored_resource_dimensions,json=monitoredResourceDimensions" json:"monitored_resource_dimensions,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	XXX_NoUnkeyedLiteral        struct{}                  `json:"-"`
	XXX_sizecache               int32                     `json:"-"`
}
...
func (*InstanceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_09f8e924e58c3f6d, []int{1}
}
...
type Type struct {
	...
	// The unique identity of the particular metric to report.
	Dimensions map[string]v1beta1.ValueType `protobuf:"bytes,2,rep,name=dimensions" json:"dimensions,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=istio.policy.v1beta1.ValueType"`
	// Optional. A set of expressions that will form the dimensions of the monitored resource this metric is being reported on.
	// If the metric backend supports monitored resources, these fields are used to populate that resource. Otherwise
	// these fields will be ignored by the adapter.
...
func (*Type) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_09f8e924e58c3f6d, []int{2}
}
...
func (*InstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_09f8e924e58c3f6d, []int{3}
}
...
func init() {
	proto.RegisterFile("mixer/template/metric/template_handler_service.proto", fileDescriptor_template_handler_service_09f8e924e58c3f6d)
}

var fileDescriptor_template_handler_service_09f8e924e58c3f6d = []byte{

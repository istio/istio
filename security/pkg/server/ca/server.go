...
func (s *Server) CreateCertificate(ctx context.Context, request *pb.IstioCertificateRequest) (
	*pb.IstioCertificateResponse, error) {
	...
	serverCaLog.Infof("ssssssssssCreateCertificatelllllll\n")
	serverCaLog.Infof("%+v\n", ctx)
	peer, _ := peer.FromContext(ctx)
	serverCaLog.Infof("ssssssppppoooooo\n")
	serverCaLog.Infof("%+v\n",ctx)
	serverCaLog.Infof("pppppkkkkkkkkk\n")
	serverCaLog.Infof("%+v\n",peer)
	//serverCaLog.Infof("nnnnnnnnnnnnnnnnn\n")
	//serverCaLog.Infof("%+v\n",peer.AuthInfo)
	//serverCaLog.Infof("ssssssssmmmm\n")

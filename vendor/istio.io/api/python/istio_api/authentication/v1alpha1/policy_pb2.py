...
from common.v1alpha1 import string_pb2 as common_dot_v1alpha1_dot_string__pb2
...
_JWT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='excluded_paths', full_name='istio.authentication.v1alpha1.Jwt.excluded_paths', index=5,
...
_JWT.fields_by_name['excluded_paths'].message_type = common_dot_v1alpha1_dot_string__pb2._STRINGMATCH

...
func (LogSeverity) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_log_severity_8ce61232bc3e5482, []int{0}
}
...
func init() {
	proto.RegisterFile("google/logging/type/log_severity.proto", fileDescriptor_log_severity_8ce61232bc3e5482)
}

var fileDescriptor_log_severity_8ce61232bc3e5482 = []byte{

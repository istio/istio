...
type xdsCache[K comparable] interface {
...
func newXdsCache[K comparable]() xdsCache[K] {
	cache := &lruCache[K]{
...
var _ xdsCache[uint64] = &lruCache[uint64]{}
...
var _ xdsCache[uint64] = &disabledCache[uint64]{}

...
func (*RegisterDebuggeeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_controller_6b454e426974140a, []int{0}
}
...
func (*RegisterDebuggeeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_controller_6b454e426974140a, []int{1}
}
...
func (*ListActiveBreakpointsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_controller_6b454e426974140a, []int{2}
}
...
func (*ListActiveBreakpointsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_controller_6b454e426974140a, []int{3}
}
...
func (*UpdateActiveBreakpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_controller_6b454e426974140a, []int{4}
}
...
func (*UpdateActiveBreakpointResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_controller_6b454e426974140a, []int{5}
}
...
func init() {
	proto.RegisterFile("google/devtools/clouddebugger/v2/controller.proto", fileDescriptor_controller_6b454e426974140a)
}

var fileDescriptor_controller_6b454e426974140a = []byte{

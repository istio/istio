...
func file_workloadapi_security_authorization_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_workloadapi_security_authorization_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_workloadapi_security_authorization_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Group); i {
			case 0:
				return &v.state
			case 1:
		...
		file_workloadapi_security_authorization_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Rules); i {
			case 0:
				return &v.state
			case 1:
		...
		file_workloadapi_security_authorization_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Match); i {
			case 0:
				return &v.state
			case 1:
		...
		file_workloadapi_security_authorization_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_workloadapi_security_authorization_proto_msgTypes[5].Exporter = func(v any, i int) any {

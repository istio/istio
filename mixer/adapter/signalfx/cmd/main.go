...
import (
	...
	"istio.io/istio/mixer/adapter/signalfx/cmd/server"
)
...
func GetCmd(_ []string) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "signalfx",
		Short: "Istio signalfx out of process adapter.",
...
func runServer(args *Args) {
	s, err := server.NewSignalfxNoSessionServer(args.AdapterPort, args.APIWorkerPoolSize, args.Cert)
	if err != nil {

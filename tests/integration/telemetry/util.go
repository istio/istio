...
func BuildQuery(ns namespace.Instance, sourceCluster string) (sourceQuery, destinationQuery, appQuery prometheus.Query) {
...
func BuildOutOfMeshServerQuery(ns namespace.Instance, sourceCluster string) prometheus.Query {
	labels := map[string]string{
		"request_protocol": "http",
		"response_code":    "200",

...
type IstioEndpoint struct {
	...
	// This change can support multiple addresses for an endpoint, then there are 2 use cases for it, such as
	// 1. An endpoint can have both ipv4 or ipv6.
	// 2. An endpoint can have multiple addresses, more then one IP addresses which are the same IP families.
	// There should be some constraints below:
	// 1. Each address of the endpoint must have the same metadata.
	// 2. The IstioEndpoint key generated by its function Key() should be the unique identifier.

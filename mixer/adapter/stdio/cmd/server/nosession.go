...
import (
	...
	config "istio.io/istio/mixer/adapter/stdio/config"
...
// NewStdioNoSessionServer creates a new no session server based on given args.
func NewStdioNoSessionServer(addr uint16, poolSize int, c *Cert) (*NoSession, error) {
	...
	s := &NoSession{
		...
		env:        handler.NewEnv(0, "stdio-nosession", gp),

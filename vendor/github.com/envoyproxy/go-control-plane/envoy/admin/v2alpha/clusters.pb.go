...
func (*Clusters) Descriptor() ([]byte, []int) {
	return fileDescriptor_clusters_61cf569d81990140, []int{0}
}
...
func (*ClusterStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_clusters_61cf569d81990140, []int{1}
}
...
func (*HostStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_clusters_61cf569d81990140, []int{2}
}
...
func (*HostHealthStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_clusters_61cf569d81990140, []int{3}
}
...
func init() {
	proto.RegisterFile("envoy/admin/v2alpha/clusters.proto", fileDescriptor_clusters_61cf569d81990140)
}

var fileDescriptor_clusters_61cf569d81990140 = []byte{

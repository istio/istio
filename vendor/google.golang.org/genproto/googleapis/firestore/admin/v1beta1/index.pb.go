...
func (IndexField_Mode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_index_5d3506e203273b1f, []int{0, 0}
}
...
func (Index_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_index_5d3506e203273b1f, []int{1, 0}
}
...
func (*IndexField) Descriptor() ([]byte, []int) {
	return fileDescriptor_index_5d3506e203273b1f, []int{0}
}
...
func (*Index) Descriptor() ([]byte, []int) {
	return fileDescriptor_index_5d3506e203273b1f, []int{1}
}
...
func init() {
	proto.RegisterFile("google/firestore/admin/v1beta1/index.proto", fileDescriptor_index_5d3506e203273b1f)
}

var fileDescriptor_index_5d3506e203273b1f = []byte{

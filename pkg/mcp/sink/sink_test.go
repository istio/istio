...
func makeChange(collection string, inc bool, removed []string, fakes ...*test.Fake) *Change {
	change := &Change{
...
func TestSinkACKWithIncrementalAddUpdateDelete(t *testing.T) {
	steps := []testStep{
		{
		...
		},
		{
			...
			wantChange:  makeChange(test.FakeType0Collection, true, nil, test.Type0A[1], test.Type0B[0]),
		},
		{
			name:        "ACK remove A update B add C",
			resources:   test.MakeResources(test.FakeType0Collection, "type0/v2", "type0/n2", []string{"a"}, test.Type0B[1], test.Type0C[0]),
			wantRequest: test.MakeRequest(test.FakeType0Collection, "type0/n2", codes.OK),
			wantChange:  makeChange(test.FakeType0Collection, true, []string{"a"}, test.Type0B[1], test.Type0C[0]),
		},
		{
			name:        "ACK remove B",
			resources:   test.MakeResources(test.FakeType0Collection, "type0/v3", "type0/n3", []string{"b"}),
			wantRequest: test.MakeRequest(test.FakeType0Collection, "type0/n3", codes.OK),
			wantChange:  makeChange(test.FakeType0Collection, true, []string{"b"}),
		},
		{
			name:        "ACK remove B again",
			resources:   test.MakeResources(test.FakeType0Collection, "type0/v4", "type0/n4", []string{"b"}),
		...
		},
		{
			...
			wantChange:  makeChange(test.FakeType0Collection, true, nil, test.Type0C[1]),
		},
	}
...
func TestSinkNACK(t *testing.T) {
	steps := []testStep{
		...
		},
		{
			...
			wantRequest: test.MakeRequest(test.FakeType0Collection, "type0/n5", codes.OK),
			wantChange:  makeChange(test.FakeType0Collection, true, nil, test.Type0A[1]),
		},
	}
	...
	steps1 := []testStep{
		{
			...
			resources:   test.MakeResources(test.FakeType0Collection, "type0/v0", "type0/n0", []string{"a", "b"}),
			wantRequest: test.MakeRequest(test.FakeType0Collection, "type0/n0", codes.OK),
			wantChange:  makeChange(test.FakeType0Collection, true, []string{"a", "b"}),
		},
		{
			name:        "ACK remove test.Type1 A",
			resources:   test.MakeResources(test.FakeType1Collection, "type1/v0", "type1/n0", []string{"a"}),
			wantRequest: test.MakeRequest(test.FakeType1Collection, "type1/n0", codes.OK),
			wantChange:  makeChange(test.FakeType1Collection, true, []string{"a"}),
		},
	}

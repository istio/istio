...
func buildHTTPFaultFilter(cluster string, faultRule *routerule.HTTPFaultInjection, headers Headers) *HTTPFilter {
...
func buildAbortConfig(abortRule *routerule.HTTPFaultInjection_Abort) *AbortFilter {
...
func buildDelayConfig(delayRule *routerule.HTTPFaultInjection_Delay) *DelayFilter {

...
export ISTIO_INSTALLER?=${GOPATH}/src/istio-ecosystem/istio-installer
...
INSTALLER_LOCALREPO=${GOPATH}/src/istio-ecosystem/istio-installer

force: ;

${GOPATH}/src/istio-ecosystem/istio-installer: force

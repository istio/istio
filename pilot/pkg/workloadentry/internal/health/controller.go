...
func NewController(wleStore *workloadentrystore.Controller, maxRetries int) *Controller {
	c := &Controller{
		wleStore: wleStore,
	}
...
func (c *Controller) updateWorkloadEntryHealth(obj any) error {
	...
	return c.wleStore.UpdateHealth(condition.proxy.ID, condition.entryName, condition.proxy.Metadata.Namespace, condition.condition)
}

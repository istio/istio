...
func TestLabels(t *testing.T) {
	tests := []struct {
		...
		{filter: "", labels: NewSet(Postsubmit, Presubmit), expected: true},
		{filter: "$requires.kube", labels: NewSet(Postsubmit, Presubmit), err: true},
		{filter: "zoo", labels: NewSet(Postsubmit, Presubmit), err: true},
		{filter: "postsubmit", labels: NewSet(Postsubmit), expected: true},
		{filter: "postsubmit", labels: NewSet(Presubmit), expected: false},
		{filter: "postsubmit", labels: NewSet(Presubmit, Postsubmit), expected: true},
		{filter: "postsubmit,presubmit", labels: NewSet(Postsubmit, Presubmit), expected: true},
		{filter: "postsubmit,presubmit", labels: NewSet(Postsubmit), expected: false},
		{filter: "+postsubmit,+presubmit", labels: NewSet(Postsubmit), expected: false},
		{filter: "postsubmit,+presubmit", labels: NewSet(Postsubmit, Presubmit), expected: true},
		{filter: "-postsubmit", labels: NewSet(), expected: true},
		{filter: "-postsubmit", labels: NewSet(Postsubmit), expected: false},
		{filter: "-postsubmit,-presubmit", labels: NewSet(), expected: true},
		{filter: "-postsubmit,presubmit", labels: NewSet(Postsubmit, Presubmit), expected: false},
		{filter: "-postsubmit,presubmit", labels: NewSet(Presubmit), expected: true},
		{filter: "-postsubmit,presubmit", labels: NewSet(Postsubmit), expected: false},
		{filter: "-postsubmit,presubmit", labels: NewSet(), expected: false},

...
PILOT_GO_BINS:=${ISTIO_OUT}/pilot-discovery ${ISTIO_OUT}/pilot-agent \
               ${ISTIO_OUT}/sidecar-injector ${ISTIO_OUT}/rpc-controller ${ISTIO_OUT}/register-agent
PILOT_GO_BINS_SHORT:=pilot-discovery pilot-agent sidecar-injector rpc-controller register-agent
define pilotbuild
$(1):

...
import (
	...
	config "istio.io/istio/mixer/adapter/prometheus/config"
...
// NewPrometheusNoSessionServer creates a new no session server based on given args.
func NewPrometheusNoSessionServer(addr uint16, poolSize int, c *Cert) (*NoSession, error) {

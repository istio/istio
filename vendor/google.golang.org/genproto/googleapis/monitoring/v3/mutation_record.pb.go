...
func (*MutationRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_mutation_record_20cb38a918044630, []int{0}
}
...
func init() {
	proto.RegisterFile("google/monitoring/v3/mutation_record.proto", fileDescriptor_mutation_record_20cb38a918044630)
}

var fileDescriptor_mutation_record_20cb38a918044630 = []byte{

...
func init() {
	...
	discoveryCmd.PersistentFlags().MarkDeprecated("appNamespace",
		"Use --appNamespaces instead, and specify in list of application namespaces the controller to watch, separated by comma")
	discoveryCmd.PersistentFlags().StringVar(&serverArgs.Config.ControllerOptions.WatchedNamespaces, "appNamespaces",

...
_PROXYCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='google_grpc_xds_client', full_name='istio.mesh.v1alpha1.ProxyConfig.google_grpc_xds_client', index=19,

...
func (Finding_FindingType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_finding_e10fb627a6dc32cd, []int{0, 0}
}
...
func (*Finding) Descriptor() ([]byte, []int) {
	return fileDescriptor_finding_e10fb627a6dc32cd, []int{0}
}
...
func init() {
	proto.RegisterFile("google/cloud/websecurityscanner/v1alpha/finding.proto", fileDescriptor_finding_e10fb627a6dc32cd)
}

var fileDescriptor_finding_e10fb627a6dc32cd = []byte{

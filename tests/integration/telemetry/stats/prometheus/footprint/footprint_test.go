...
// Package footprint validates that the Prometheus metrics footprint exposed
// by istio-agent does not grow unexpectedly. Growth in the metrics footprint
// can have signficant impact on large clusters, due to the increased resources
...
var (
	canonicalMetrics = map[string]bool{
		...
		"envoy_cluster_ssl_ciphers_ECDHE_RSA_AES256_GCM_SHA384":                        true,
		"envoy_cluster_ssl_connection_error":                                           true,
		"envoy_cluster_ssl_curves_P_256":                                               true,
		...
		"envoy_server_worker_0_watchdog_mega_miss":                                     true,
		"envoy_server_worker_0_watchdog_miss":                                          true,
		"envoy_server_worker_1_watchdog_mega_miss":                                     true,
		"envoy_server_worker_1_watchdog_miss":                                          true,
		"envoy_server_worker_2_watchdog_mega_miss":                                     true,
		"envoy_server_worker_2_watchdog_miss":                                          true,
		"envoy_server_worker_3_watchdog_mega_miss":                                     true,
		"envoy_server_worker_3_watchdog_miss":                                          true,

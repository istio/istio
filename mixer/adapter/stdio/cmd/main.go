...
import (
	...
	"istio.io/istio/mixer/adapter/stdio/cmd/server"
)
...
func GetCmd(_ []string) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "stdio",
		Short: "Istio stdio out of process adapter.",
...
func runServer(args *Args) {
	s, err := server.NewStdioNoSessionServer(args.AdapterPort, args.APIWorkerPoolSize, args.Cert)
	if err != nil {

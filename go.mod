...
require (
	...
	github.com/envoyproxy/go-control-plane v0.11.2-0.20230927135814-60e8938f6a6f
	...
	istio.io/api v1.19.0-alpha.1.0.20230927221631-4bc3c01da7d1
	istio.io/client-go v1.19.0-alpha.1.0.20230927222530-0fe84edc0f40
	k8s.io/api v0.28.2

...
EXCLUDES="${EXCLUDES}1113,"
EXCLUDES="${EXCLUDES}1117,"
EXCLUDES="${EXCLUDES}1128,"
...
EXCLUDES="${EXCLUDES}2021,"
EXCLUDES="${EXCLUDES}2028,"
EXCLUDES="${EXCLUDES}2034,"
EXCLUDES="${EXCLUDES}2035,"
EXCLUDES="${EXCLUDES}2039,"
EXCLUDES="${EXCLUDES}2043,"

...
func setupConfig(cfg *istio.Config) {
	...
	// Disable Citadel Agent but keep other Citadel Agent flags set, to verify that Citadel Agent
	// is not deployed even those flags are not empty.
	cfg.Values["nodeagent.enabled"] = "false"

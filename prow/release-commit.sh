...
DOCKER_PUSH_HUB=${DOCKER_PUSH_HUB:-ghcr.io/istio/testing}
DOCKER_HUB=${DOCKER_HUB:-registry.istio.io/testing}
HELM_HUB=${HELM_HUB:-ghcr.io/istio/testing/charts}
...
BUILDER_SHA=2241d0a237035dac7879e2d7f08027a12d855a49

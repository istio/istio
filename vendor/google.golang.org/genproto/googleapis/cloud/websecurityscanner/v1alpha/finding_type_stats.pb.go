...
func (*FindingTypeStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_finding_type_stats_ccb0930baec1d039, []int{0}
}
...
func init() {
	proto.RegisterFile("google/cloud/websecurityscanner/v1alpha/finding_type_stats.proto", fileDescriptor_finding_type_stats_ccb0930baec1d039)
}

var fileDescriptor_finding_type_stats_ccb0930baec1d039 = []byte{

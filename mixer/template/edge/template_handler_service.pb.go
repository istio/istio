...
func (*HandleEdgeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_32825cae7b62dec2, []int{0}
}
...
func (dst *HandleEdgeRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HandleEdgeRequest.Merge(dst, src)
}
...
type InstanceMsg struct {
	...
	Timestamp *v1beta1.TimeStamp `protobuf:"bytes,1,opt,name=timestamp" json:"timestamp,omitempty"`
...
func (*InstanceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_32825cae7b62dec2, []int{1}
}
...
func (*Type) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_32825cae7b62dec2, []int{2}
}
...
func (*InstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_32825cae7b62dec2, []int{3}
}
...
func init() {
	proto.RegisterFile("mixer/template/edge/template_handler_service.proto", fileDescriptor_template_handler_service_32825cae7b62dec2)
}

var fileDescriptor_template_handler_service_32825cae7b62dec2 = []byte{

...
func (m *OutlierDetection) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ConsecutiveGatewayFailure != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.ConsecutiveGatewayFailure))
	}
	return i, nil
}
...
func (m *OutlierDetection) Size() (n int) {
	...
	if m.ConsecutiveGatewayFailure != 0 {
		n += 1 + sovDestinationRule(uint64(m.ConsecutiveGatewayFailure))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ConsecutiveGatewayFailure |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorDestinationRule = []byte{
	...
	,
}

...
var (
	...
	setFlagValues = map[string]interface{}{
		...
		"addonComponents.prometheus.enabled":     boolValues,
		"addonComponents.prometheus.namespace":   validate.CheckNamespaceName,
		"addonComponents.grafana.enabled":        boolValues,
		"addonComponents.grafana.namespace":      validate.CheckNamespaceName,
		"addonComponents.kiali.enabled":          boolValues,
		"addonComponents.kiali.namespace":        validate.CheckNamespaceName,
		"addonComponents.tracing.enabled":        boolValues,
		"addonComponents.tracing.namespace":      validate.CheckNamespaceName,
		"addonComponents.istiocoredns.enabled":   boolValues,
		"addonComponents.istiocoredns.namespace": validate.CheckNamespaceName,
		"addonComponents.certManager.enabled":    boolValues,
		"addonComponents.certManager.namespace":  validate.CheckNamespaceName,

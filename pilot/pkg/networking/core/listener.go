...
func BuildListenerTLSContext(serverTLSSettings *networking.ServerTLSSettings,
	...
	case serverTLSSettings.Mode == networking.ServerTLSSettings_ISTIO_MUTUAL:
		authnmodel.ApplyToCommonTLSContext(
			...
			[]string{}, validateClient, nil, serverTLSSettings.InsecureSkipVerify.GetValue())
	...
	default:
		...
		authnmodel.ApplyToCommonTLSContext(
			...
			[]string{}, validateClient, serverTLSSettings.TlsCertificates, serverTLSSettings.InsecureSkipVerify.GetValue())
	}

...
type typedXdsCache[K comparable] interface {
	...
	GetWithRequest(key K, pushReq *PushRequest) *discovery.Resource
...
func (l *lruCache[K]) GetWithRequest(key K, pushReq *PushRequest) *discovery.Resource {
	return l.get(key, CacheToken(pushReq.Start.UnixNano()))
}
...
func (d disabledCache[K]) GetWithRequest(k K, pushReq *PushRequest) *discovery.Resource {
	return nil
}

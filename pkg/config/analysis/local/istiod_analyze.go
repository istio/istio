...
type IstiodAnalyzer struct {
	...
	// How long to wait for the analysis process to complete before aborting. Default 0 means no timeout.
...
func NewSourceAnalyzer(analyzer *analysis.CombinedAnalyzer, namespace, istioNamespace resource.Namespace,
	...
	return NewIstiodAnalyzer(analyzer, namespace, istioNamespace, cr, serviceDiscovery, timeout)
}

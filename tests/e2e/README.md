...
> NOTE: You have to wait "prow/istio-presubmit" to succeed before you can trigger e2e tests against specific commit/SHA. It needs artifacts generated by istio-presubmit.

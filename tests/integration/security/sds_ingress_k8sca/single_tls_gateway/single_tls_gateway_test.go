...
// TestSingleTlsGateway_SecretRotation_K8sca tests a single TLS ingress gateway with SDS enabled.
...
func TestSingleTlsGateway_SecretRotation_K8sca(t *testing.T) {
	framework.
		NewTest(t).

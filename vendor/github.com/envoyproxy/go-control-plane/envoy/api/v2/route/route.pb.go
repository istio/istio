...
func (m *RouteAction) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MaxGrpcTimeout != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintRoute(dAtA, i, uint64(types.SizeOfStdDuration(*m.MaxGrpcTimeout)))
		n30, err := types.StdDurationMarshalTo(*m.MaxGrpcTimeout, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n30
	...
	if m.IdleTimeout != nil {
		...
		n31, err := types.StdDurationMarshalTo(*m.IdleTimeout, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n31
...
func (m *RouteAction_RetryPolicy) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PerTryTimeout != nil {
		...
		n35, err := types.StdDurationMarshalTo(*m.PerTryTimeout, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n35
...
func (m *RouteAction_HashPolicy_Cookie) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Ttl != nil {
		...
		n40, err := types.StdDurationMarshalTo(*m.Ttl, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n40
...
func (m *RouteAction_WebSocketProxyConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IdleTimeout != nil {
		...
		i++
		i = encodeVarintRoute(dAtA, i, uint64(types.SizeOfStdDuration(*m.IdleTimeout)))
		n41, err := types.StdDurationMarshalTo(*m.IdleTimeout, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n41
...
func (m *RouteAction) Size() (n int) {
	...
	if m.MaxGrpcTimeout != nil {
		l = types.SizeOfStdDuration(*m.MaxGrpcTimeout)
		n += 2 + l + sovRoute(uint64(l))
	}
	if m.IdleTimeout != nil {
...
func (m *RouteAction) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 23:
			...
			if err := types.StdDurationUnmarshal(m.MaxGrpcTimeout, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 24:

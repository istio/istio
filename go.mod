...
require (
	...
	istio.io/api v0.0.0-20221103140222-82609203190a
	istio.io/client-go v1.14.6-0.20221103141022-b9db8e3cf1ff
	istio.io/pkg v0.0.0-20221103140622-b5d4f45b715d
	k8s.io/api v0.24.2

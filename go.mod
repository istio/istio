...
// Latest version has OSX compatibility issue. See https://github.com/ory/dockertest/issues/212
...
require (
	...
	github.com/thalescpl-io/k8s-kms-plugin v0.5.1-0.20200921230108-72051fb36f12

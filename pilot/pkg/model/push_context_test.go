...
func TestSetDestinationRuleInheritance(t *testing.T) {
	...
	ps.updateDestinationRules([]config.Config{meshDestinationRule, nsDestinationRule, svcDestinationRule, destinationRuleNamespace2, workloadSpecificDrNamespace2})
...
func TestSetDestinationRuleWithWorkloadSelector(t *testing.T) {
	...
	ps.updateDestinationRules([]config.Config{app1DestinationRule, app2DestinationRule, app3DestinationRule, namespaceDestinationRule})
...
func TestSetDestinationRuleMerging(t *testing.T) {
	...
	ps.updateDestinationRules([]config.Config{destinationRuleNamespace1, destinationRuleNamespace2})
...
func TestSetDestinationRuleWithExportTo(t *testing.T) {
	...
	ps.updateDestinationRules([]config.Config{

...
func init() {
	proto.RegisterFile("google/bigtable/v1/bigtable_service.proto", fileDescriptor_bigtable_service_8f283aa5a219babd)
}

var fileDescriptor_bigtable_service_8f283aa5a219babd = []byte{

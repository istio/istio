...
package quaternion // import "google.golang.org/genproto/googleapis/type/quaternion"
...
func (dst *Quaternion) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Quaternion.Merge(dst, src)
}

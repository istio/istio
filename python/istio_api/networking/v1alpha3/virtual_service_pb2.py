...
_TLSMATCHATTRIBUTES = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='alpn_protocols', full_name='istio.networking.v1alpha3.TLSMatchAttributes.alpn_protocols', index=3,

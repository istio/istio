...
for suffix in "" "-alt" "-alt-2"; do
  ...
  openssl x509 -req -days 36500 -in ca-cert.csr -sha256 -CA root-cert.pem -CAkey root-key.pem -CAcreateserial -out "ca-cert${suffix}.pem" -extensions v3_req -extfile ca.cfg

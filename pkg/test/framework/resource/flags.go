...
func init() {
	...
	flag.Var(&settingsFromCommandLine.RevVerMap, "istio.test.revVerMap", "Istio CP versions available to the test framework and th corresponding revisions.")
}

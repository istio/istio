...
func (*Deployment) Descriptor() ([]byte, []int) {
	return fileDescriptor_deploy_4a59a9192bf081bb, []int{0}
}
...
func (*FileInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_deploy_4a59a9192bf081bb, []int{1}
}
...
func (*ContainerInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_deploy_4a59a9192bf081bb, []int{2}
}
...
func (*ZipInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_deploy_4a59a9192bf081bb, []int{3}
}
...
func init() {
	proto.RegisterFile("google/appengine/v1/deploy.proto", fileDescriptor_deploy_4a59a9192bf081bb)
}

var fileDescriptor_deploy_4a59a9192bf081bb = []byte{

...
var (
	...
	EnableGatewayAPIHTTPRouteAuth = env.Register("ENABLE_GATEWAY_API_HTTPROUTE_AUTH", false,
		"If true, support targeting Gateway API HTTPRoute resources with AuthorizationPolicy").Get()

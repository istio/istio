...
import v1beta11 "istio.io/api/policy/v1beta1"
...
type HandleSampleQuotaRequest struct {
	...
	QuotaRequest         *v1beta1.QuotaRequest `protobuf:"bytes,4,opt,name=quota_request,json=quotaRequest" json:"quota_request,omitempty"`
...
func (*HandleSampleQuotaRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_quotatmpl_handler_service_9c8990a3c0dde765, []int{0}
}
...
func (dst *HandleSampleQuotaRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HandleSampleQuotaRequest.Merge(dst, src)
}
...
type InstanceMsg struct {
	...
	Dimensions           map[string]*v1beta11.Value `protobuf:"bytes,1,rep,name=dimensions" json:"dimensions,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	XXX_NoUnkeyedLiteral struct{}                   `json:"-"`
	XXX_sizecache        int32                      `json:"-"`
}
...
func (*InstanceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_quotatmpl_handler_service_9c8990a3c0dde765, []int{1}
}
...
type Type struct {
	// The unique identity of the particular quota to manipulate.
	Dimensions           map[string]v1beta11.ValueType `protobuf:"bytes,1,rep,name=dimensions" json:"dimensions,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=istio.policy.v1beta1.ValueType"`
	XXX_NoUnkeyedLiteral struct{}                      `json:"-"`
	XXX_sizecache        int32                         `json:"-"`
}
...
func (*Type) Descriptor() ([]byte, []int) {
	return fileDescriptor_quotatmpl_handler_service_9c8990a3c0dde765, []int{2}
}
...
func (*InstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptor_quotatmpl_handler_service_9c8990a3c0dde765, []int{3}
}
...
func init() {
	proto.RegisterFile("mixer/test/spyAdapter/template/quota/quotatmpl_handler_service.proto", fileDescriptor_quotatmpl_handler_service_9c8990a3c0dde765)
}

var fileDescriptor_quotatmpl_handler_service_9c8990a3c0dde765 = []byte{

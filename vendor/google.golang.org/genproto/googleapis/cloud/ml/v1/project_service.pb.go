...
func (*GetConfigRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_service_bfab71f1ac16d243, []int{0}
}
...
func (*GetConfigResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_service_bfab71f1ac16d243, []int{1}
}
...
func init() {
	proto.RegisterFile("google/cloud/ml/v1/project_service.proto", fileDescriptor_project_service_bfab71f1ac16d243)
}

var fileDescriptor_project_service_bfab71f1ac16d243 = []byte{

...
// If match_labels are specified, the policy will only be applied to the workloads
// for which all label requirements are satisfied.
type TargetSelector struct {
	...
	//     env: 'testing'
	// ```
	MatchLabels map[string]string `protobuf:"bytes,3,rep,name=match_labels,json=matchLabels" json:"match_labels,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *TargetSelector) GetMatchLabels() map[string]string {
	if m != nil {
...
var fileDescriptorPolicy = []byte{
	...
	,
}

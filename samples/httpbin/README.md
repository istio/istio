...
A third option of accessing the service from outside of the mesh is to do it through an Ingress Gateway. This [Control Ingress Trafic](https://istio.io/docs/tasks/traffic-management/ingress/) explains in details how to do it.

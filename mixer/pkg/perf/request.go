...
type Request interface {
	...
	createRequestProtos(identityAttribute, identityAttributeDomain string) []interface{}
}
...
func (r BasicReport) createRequestProtos(identityAttribute, identityAttributeDomain string) []interface{} {
	requestBag := attribute.GetMutableBag(nil)
	requestBag.Set(identityAttribute, identityAttributeDomain)
...
// CreateRequest creates a request proto.
func (c BasicCheck) createRequestProtos(identityAttribute, identityAttributeDomain string) []interface{} {
	requestBag := attribute.GetMutableBag(nil)
	requestBag.Set(identityAttribute, identityAttributeDomain)

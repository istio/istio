...
require (
	...
	github.com/envoyproxy/go-control-plane/contrib v1.36.1-0.20260917191952-76d65350c086
	github.com/envoyproxy/go-control-plane/envoy v1.39.1-0.20260917080528-9f36692b52bb

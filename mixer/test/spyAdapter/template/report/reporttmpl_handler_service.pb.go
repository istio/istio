...
func (*HandleSampleReportRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_reporttmpl_handler_service_7c710a5ffc97cfca, []int{0}
}
...
func (dst *HandleSampleReportRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HandleSampleReportRequest.Merge(dst, src)
}
...
func (*InstanceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_reporttmpl_handler_service_7c710a5ffc97cfca, []int{1}
}
...
func (*Type) Descriptor() ([]byte, []int) {
	return fileDescriptor_reporttmpl_handler_service_7c710a5ffc97cfca, []int{2}
}
...
func (*InstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptor_reporttmpl_handler_service_7c710a5ffc97cfca, []int{3}
}
...
func init() {
	proto.RegisterFile("mixer/test/spyAdapter/template/report/reporttmpl_handler_service.proto", fileDescriptor_reporttmpl_handler_service_7c710a5ffc97cfca)
}

var fileDescriptor_reporttmpl_handler_service_7c710a5ffc97cfca = []byte{

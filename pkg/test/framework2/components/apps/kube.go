...
func (d *deploymentFactory) waitUntilPodIsReady(e *kube.Environment, ns *kube.Namespace) (kubeApiCore.Pod, error) {
...
func (d *deploymentFactory) waitUntilPodIsDeleted(e *kube.Environment, ns *kube.Namespace) error {

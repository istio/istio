...
import (
	...
	"istio.io/istio/mixer/adapter/noop/cmd/server"
)
...
func GetCmd(_ []string) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "noop",
		Short: "Istio noop out of process adapter.",
...
func runServer(args *Args) {
	s, err := server.NewNoopNoSessionServer(args.AdapterPort, args.APIWorkerPoolSize, args.Cert)
	if err != nil {

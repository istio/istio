...
func buildInboundCatchAllFilterChains(configgen *ConfigGeneratorImpl,
	...
	filters = append(filters, buildMetadataExchangeNetworkFilters(istionetworking.ListenerClassSidecarInbound, node.IstioVersion)...)
	...
	for _, opt := range newOpts {
		...
		case istionetworking.ListenerProtocolHTTP:
			...
			fcOpt.filterChain.TCP = append(
				buildMetadataExchangeNetworkFilters(istionetworking.ListenerClassSidecarInbound, in.Node.IstioVersion),

...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_ab1311cc049d7a2c, []int{0}
}
...
func (this *Params) String() string {
	...
	s := strings.Join([]string{`&Params{`,
		...
		`CacheDuration:` + strings.Replace(strings.Replace(this.CacheDuration.String(), "Duration", "types.Duration", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func init() {
	proto.RegisterFile("mixer/adapter/rbac/config/config.proto", fileDescriptor_config_ab1311cc049d7a2c)
}

var fileDescriptor_config_ab1311cc049d7a2c = []byte{

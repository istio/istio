...
import (
	...
	"istio.io/istio/mixer/adapter/memquota/cmd/server"
)
...
func GetCmd(_ []string) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "memquota",
		Short: "Istio memquota out of process adapter.",
...
func runServer(args *Args) {
	s, err := server.NewMemquotaNoSessionServer(args.AdapterPort, args.APIWorkerPoolSize, args.Cert)
	if err != nil {

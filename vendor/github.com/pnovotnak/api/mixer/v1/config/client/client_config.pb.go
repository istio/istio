...
// Defines the client config for Thrift.
type ThriftClientConfig struct {
	...
	// Quota specifications to generate quota requirements.
	// It applies on the new TCP connections.
	ConnectionQuotaSpec *QuotaSpec `protobuf:"bytes,6,opt,name=connection_quota_spec,json=connectionQuotaSpec,proto3" json:"connection_quota_spec,omitempty"`
	// Specify report interval to send periodical reports for long Thrift
	// connections. If not specified, the interval is 10 seconds. This interval
	// should not be less than 1 second, otherwise it will be reset to 1 second.
	ReportInterval *types.Duration `protobuf:"bytes,7,opt,name=report_interval,json=reportInterval,proto3" json:"report_interval,omitempty"`
}

func (m *ThriftClientConfig) Reset()      { *m = ThriftClientConfig{} }
func (*ThriftClientConfig) ProtoMessage() {}
func (*ThriftClientConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_27bf0dec365e2f6f, []int{5}
}
...
func (m *ThriftClientConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ThriftClientConfig.Merge(m, src)
}
...
func init() {
	...
	proto.RegisterType((*ThriftClientConfig)(nil), "istio.mixer.v1.config.client.ThriftClientConfig")
	proto.RegisterMapType((map[string]*ServiceConfig)(nil), "istio.mixer.v1.config.client.ThriftClientConfig.ServiceConfigsEntry")
}
...
var fileDescriptor_27bf0dec365e2f6f = []byte{
	...
	,
}
...
func (m *ThriftClientConfig) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ThriftClientConfig) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Transport != nil {
		...
		i++
		i = encodeVarintClientConfig(dAtA, i, uint64(m.Transport.Size()))
		n18, err18 := m.Transport.MarshalTo(dAtA[i:])
		if err18 != nil {
			return 0, err18
		}
		i += n18
	...
	if m.MixerAttributes != nil {
		...
		i++
		i = encodeVarintClientConfig(dAtA, i, uint64(m.MixerAttributes.Size()))
		n20, err20 := m.MixerAttributes.MarshalTo(dAtA[i:])
		if err20 != nil {
			return 0, err20
		}
		i += n20
	...
	if m.ForwardAttributes != nil {
		...
		i++
		i = encodeVarintClientConfig(dAtA, i, uint64(m.ForwardAttributes.Size()))
		n21, err21 := m.ForwardAttributes.MarshalTo(dAtA[i:])
		if err21 != nil {
			return 0, err21
		}
		i += n21
	...
	if m.ConnectionQuotaSpec != nil {
		...
		i++
		i = encodeVarintClientConfig(dAtA, i, uint64(m.ConnectionQuotaSpec.Size()))
		n22, err22 := m.ConnectionQuotaSpec.MarshalTo(dAtA[i:])
		if err22 != nil {
			return 0, err22
		}
		i += n22
	...
	if m.ReportInterval != nil {
		...
		i++
		i = encodeVarintClientConfig(dAtA, i, uint64(m.ReportInterval.Size()))
		n23, err23 := m.ReportInterval.MarshalTo(dAtA[i:])
		if err23 != nil {
			return 0, err23
		}
		i += n23
...
func (m *ThriftClientConfig) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ThriftClientConfig) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ThriftClientConfig: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ThriftClientConfig: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {

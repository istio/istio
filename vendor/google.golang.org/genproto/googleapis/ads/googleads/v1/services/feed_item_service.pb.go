...
func (*GetFeedItemRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_feed_item_service_8002e8de4a0863d0, []int{0}
}
...
func (*MutateFeedItemsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_feed_item_service_8002e8de4a0863d0, []int{1}
}
...
func (*FeedItemOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_feed_item_service_8002e8de4a0863d0, []int{2}
}
...
func (*MutateFeedItemsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_feed_item_service_8002e8de4a0863d0, []int{3}
}
...
func (*MutateFeedItemResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_feed_item_service_8002e8de4a0863d0, []int{4}
}
...
var fileDescriptor_feed_item_service_8002e8de4a0863d0 = []byte{

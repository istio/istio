...
var (
	...
	CitadelEccSigAlgEnv = env.Register("CITADEL_ECC_SIGNATURE_ALGORITHM", "ECDSA",
		"The type of ECC signature algorithm to use when generating private keys for istiod").Get()
	EccSigAlgEnv = env.Register("ECC_SIGNATURE_ALGORITHM", "",
		"The type of ECC signature algorithm to use when generating private keys for workloads").Get()
	EccCurvEnv = env.Register("ECC_CURVE", "P256",
		"The elliptic curve to use when ECC certs are used").Get()
)

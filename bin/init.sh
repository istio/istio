...
ISTIO_ENVOY_ASAN_URL="${ISTIO_ENVOY_ASAN_URL:-${ISTIO_ENVOY_BASE_URL}/envoy-asan-${ISTIO_ENVOY_VERSION}${ISTIO_ENVOY_ARCH_SUFFIX}.tar.gz}"
...
ISTIO_ENVOY_LINUX_ASAN_URL="${ISTIO_ENVOY_LINUX_ASAN_URL:-${ISTIO_ENVOY_ASAN_URL}}"
...
ISTIO_ENVOY_LINUX_ASAN_DIR="${ISTIO_ENVOY_LINUX_ASAN_DIR:-${TARGET_OUT_LINUX}/asan}"
ISTIO_ENVOY_LINUX_ASAN_NAME="${ISTIO_ENVOY_LINUX_ASAN_NAME:-envoy-asan-${ISTIO_ENVOY_LINUX_VERSION}}"
ISTIO_ENVOY_LINUX_ASAN_PATH="${ISTIO_ENVOY_LINUX_ASAN_PATH:-${ISTIO_ENVOY_LINUX_ASAN_DIR}/${ISTIO_ENVOY_LINUX_ASAN_NAME}}"

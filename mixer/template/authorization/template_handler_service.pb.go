...
import v1beta11 "istio.io/api/mixer/adapter/model/v1beta1"
...
func (*HandleAuthorizationRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_3ed1f719f0b78196, []int{0}
}
...
func (dst *HandleAuthorizationRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HandleAuthorizationRequest.Merge(dst, src)
}
...
func (*InstanceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_3ed1f719f0b78196, []int{1}
}
...
type SubjectMsg struct {
	...
	Properties           map[string]*v1beta1.Value `protobuf:"bytes,3,rep,name=properties" json:"properties,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}
...
func (*SubjectMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_3ed1f719f0b78196, []int{2}
}
...
func (dst *SubjectMsg) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SubjectMsg.Merge(dst, src)
}
...
type ActionMsg struct {
	...
	Properties           map[string]*v1beta1.Value `protobuf:"bytes,5,rep,name=properties" json:"properties,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}
...
func (*ActionMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_3ed1f719f0b78196, []int{3}
}
...
func (*Type) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_3ed1f719f0b78196, []int{4}
}
...
type SubjectType struct {
	// Additional attributes about the subject.
	Properties           map[string]v1beta1.ValueType `protobuf:"bytes,3,rep,name=properties" json:"properties,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=istio.policy.v1beta1.ValueType"`
	XXX_NoUnkeyedLiteral struct{}                     `json:"-"`
	XXX_sizecache        int32                        `json:"-"`
}
...
func (*SubjectType) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_3ed1f719f0b78196, []int{5}
}
...
func (dst *SubjectType) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SubjectType.Merge(dst, src)
}
...
type ActionType struct {
	// Additional data about the action for use in policy.
	Properties           map[string]v1beta1.ValueType `protobuf:"bytes,5,rep,name=properties" json:"properties,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=istio.policy.v1beta1.ValueType"`
	XXX_NoUnkeyedLiteral struct{}                     `json:"-"`
	XXX_sizecache        int32                        `json:"-"`
}
...
func (*ActionType) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_3ed1f719f0b78196, []int{6}
}
...
func (*InstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_3ed1f719f0b78196, []int{7}
}
...
func (*SubjectInstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_3ed1f719f0b78196, []int{8}
}
...
func (dst *SubjectInstanceParam) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SubjectInstanceParam.Merge(dst, src)
}
...
func (*ActionInstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_3ed1f719f0b78196, []int{9}
}
...
func (dst *ActionInstanceParam) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ActionInstanceParam.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("mixer/template/authorization/template_handler_service.proto", fileDescriptor_template_handler_service_3ed1f719f0b78196)
}

var fileDescriptor_template_handler_service_3ed1f719f0b78196 = []byte{

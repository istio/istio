...
func (*HandleListEntryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_1df45e679b7025b5, []int{0}
}
...
func (dst *HandleListEntryRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HandleListEntryRequest.Merge(dst, src)
}
...
func (*InstanceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_1df45e679b7025b5, []int{1}
}
...
func (*Type) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_1df45e679b7025b5, []int{2}
}
...
func (*InstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_1df45e679b7025b5, []int{3}
}
...
type HandleListEntryServiceClient interface {
	...
	HandleListEntry(ctx context.Context, in *HandleListEntryRequest, opts ...grpc.CallOption) (*v1beta1.CheckResult, error)
}
...
func (c *handleListEntryServiceClient) HandleListEntry(ctx context.Context, in *HandleListEntryRequest, opts ...grpc.CallOption) (*v1beta1.CheckResult, error) {
...
type HandleListEntryServiceServer interface {
	// HandleListEntry is called by Mixer at request-time to deliver 'listentry' instances to the backend.
	HandleListEntry(context.Context, *HandleListEntryRequest) (*v1beta1.CheckResult, error)
}
...
func init() {
	proto.RegisterFile("mixer/template/listentry/template_handler_service.proto", fileDescriptor_template_handler_service_1df45e679b7025b5)
}

var fileDescriptor_template_handler_service_1df45e679b7025b5 = []byte{

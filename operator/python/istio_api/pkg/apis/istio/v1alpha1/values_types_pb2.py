...
_GLOBALCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mountMtlsCerts', full_name='v1alpha1.GlobalConfig.mountMtlsCerts', index=57,
...
_TRACINGZIPKINCONFIG = _descriptor.Descriptor(
  ...
  serialized_start=26193,
  serialized_end=26521,
)
...
_TRACINGZIPKINNODECONFIG = _descriptor.Descriptor(
  ...
  serialized_start=26523,
  serialized_end=26562,
)

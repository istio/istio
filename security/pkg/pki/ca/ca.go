...
func NewIstioCA(opts *IstioCAOptions) (*IstioCA, error) {
	ca := &IstioCA{
		...
		// TODO: Config ID should be generated by keycertbundle.
		monitoringCounters: monitoring.NewCAOperationCounters(100),
	}
...
func (ca *IstioCA) Sign(csrPEM []byte, ttl time.Duration, forCA bool) ([]byte, error) {
	...
	if err != nil {
		ca.monitoringCounters.CertGenerationError.Inc()
		return nil, err
	}
	...
	ca.monitoringCounters.SuccessCertIssuance.Inc()
	return cert, nil
}

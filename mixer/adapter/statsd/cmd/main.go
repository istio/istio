...
import (
	...
	"istio.io/istio/mixer/adapter/statsd/cmd/server"
)
...
func GetCmd(_ []string) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "statsd",
		Short: "Istio statsd out of process adapter.",
...
func runServer(args *Args) {
	s, err := server.NewStatsdNoSessionServer(args.AdapterPort, args.APIWorkerPoolSize, args.Cert)
	if err != nil {

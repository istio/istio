...
func mixerConfigMatches(ns string, name string, mixer *gogo_types.Struct, tmixer *gogo_types.Any) bool {
	if mixer != nil {
...
func getTypedMixerDestinationSvc(tmixer *gogo_types.Any) (string, string, error) {
	serviceCfg := &mixerclient.ServiceConfig{}
	if err := gogo_types.UnmarshalAny(tmixer, serviceCfg); err != nil {
		return "", "", err
	}

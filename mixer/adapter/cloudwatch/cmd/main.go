...
import (
	...
	"istio.io/istio/mixer/adapter/cloudwatch/cmd/server"
)
...
func GetCmd(_ []string) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "cloudwatch",
		Short: "Istio cloudwatch out of process adapter.",
...
func runServer(args *Args) {
	s, err := server.NewCloudwatchNoSessionServer(args.AdapterPort, args.APIWorkerPoolSize, args.Cert)
	if err != nil {

...
func (*ReadGroup) Descriptor() ([]byte, []int) {
	return fileDescriptor_readgroup_a78eb80d30ad5eb0, []int{0}
}
...
func (*ReadGroup_Experiment) Descriptor() ([]byte, []int) {
	return fileDescriptor_readgroup_a78eb80d30ad5eb0, []int{0, 0}
}
...
func (*ReadGroup_Program) Descriptor() ([]byte, []int) {
	return fileDescriptor_readgroup_a78eb80d30ad5eb0, []int{0, 1}
}
...
func init() {
	proto.RegisterFile("google/genomics/v1/readgroup.proto", fileDescriptor_readgroup_a78eb80d30ad5eb0)
}

var fileDescriptor_readgroup_a78eb80d30ad5eb0 = []byte{

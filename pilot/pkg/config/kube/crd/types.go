...
var knownTypes = map[string]schemaType{
	...
	model.MeshRbacConfig.Type: {
		schema: model.MeshRbacConfig,
		object: &MeshRbacConfig{
			TypeMeta: meta_v1.TypeMeta{
				Kind:       "MeshRbacConfig",
				APIVersion: apiVersion(&model.MeshRbacConfig),
			},
		},
		collection: &MeshRbacConfigList{},
	},
}
...
// MeshRbacConfig is the generic Kubernetes API object wrapper
type MeshRbacConfig struct {
	meta_v1.TypeMeta   `json:",inline"`
	meta_v1.ObjectMeta `json:"metadata"`
	Spec               map[string]interface{} `json:"spec"`
}
...
// GetSpec from a wrapper
func (in *MeshRbacConfig) GetSpec() map[string]interface{} {
	return in.Spec
}

// SetSpec for a wrapper
func (in *MeshRbacConfig) SetSpec(spec map[string]interface{}) {
	in.Spec = spec
}

// GetObjectMeta from a wrapper
func (in *MeshRbacConfig) GetObjectMeta() meta_v1.ObjectMeta {
	return in.ObjectMeta
}

// SetObjectMeta for a wrapper
func (in *MeshRbacConfig) SetObjectMeta(metadata meta_v1.ObjectMeta) {
	in.ObjectMeta = metadata
}

// MeshRbacConfigList is the generic Kubernetes API list wrapper
type MeshRbacConfigList struct {
	meta_v1.TypeMeta `json:",inline"`
	meta_v1.ListMeta `json:"metadata"`
	Items            []MeshRbacConfig `json:"items"`
}

// GetItems from a wrapper
func (in *MeshRbacConfigList) GetItems() []IstioObject {
	out := make([]IstioObject, len(in.Items))
	for i := range in.Items {
		out[i] = &in.Items[i]
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MeshRbacConfig) DeepCopyInto(out *MeshRbacConfig) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MeshRbacConfig.
func (in *MeshRbacConfig) DeepCopy() *MeshRbacConfig {
	if in == nil {
		return nil
	}
	out := new(MeshRbacConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *MeshRbacConfig) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MeshRbacConfigList) DeepCopyInto(out *MeshRbacConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]MeshRbacConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MeshRbacConfigList.
func (in *MeshRbacConfigList) DeepCopy() *MeshRbacConfigList {
	if in == nil {
		return nil
	}
	out := new(MeshRbacConfigList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *MeshRbacConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}

...
func (*HandleSampleReportRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_reporttmpl_handler_service_136528995d62ba5d, []int{0}
}
...
func (*InstanceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_reporttmpl_handler_service_136528995d62ba5d, []int{1}
}
...
func (*Type) Descriptor() ([]byte, []int) {
	return fileDescriptor_reporttmpl_handler_service_136528995d62ba5d, []int{2}
}
...
func (*InstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptor_reporttmpl_handler_service_136528995d62ba5d, []int{3}
}
...
func init() {
	proto.RegisterFile("mixer/test/spyAdapter/template/report/reporttmpl_handler_service.proto", fileDescriptor_reporttmpl_handler_service_136528995d62ba5d)
}

var fileDescriptor_reporttmpl_handler_service_136528995d62ba5d = []byte{

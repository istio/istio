...
// This is used by Istio CA to delegate - the CSR should be generated by Istio agent or ztunnel and
// be 'clean' - no unsupported extensions, subject fields, SANs or any other extension.

...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_5ca843b3bfd18960, []int{0}
}
...
func init() {
	proto.RegisterFile("mixer/adapter/bypass/config/config.proto", fileDescriptor_config_5ca843b3bfd18960)
}

var fileDescriptor_config_5ca843b3bfd18960 = []byte{

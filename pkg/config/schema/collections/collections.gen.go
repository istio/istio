...
var (
	...
	K8SAdmissionregistrationK8SIoV1Mutatingwebhookconfigurations = resource.Builder{
	...
	K8SApiextensionsK8SIoV1Customresourcedefinitions = resource.Builder{
	...
	K8SAppsV1Deployments = resource.Builder{
	...
	K8SCoreV1Namespaces = resource.Builder{
	...
	K8SCoreV1Nodes = resource.Builder{
		Identifier:    "Node",
		Group:         "",
		Kind:          "Node",
		Plural:        "nodes",
	...
	K8SCoreV1Secrets = resource.Builder{
		Identifier:    "Secret",
		Group:         "",
		Kind:          "Secret",
		Plural:        "secrets",
	...
	K8SCoreV1Serviceaccounts = resource.Builder{
	...
	K8SGatewayApiV1Alpha2Referencegrants = resource.Builder{
	...
	K8SGatewayApiV1Alpha2Tcproutes = resource.Builder{
		Identifier: "TCPRoute",
		Group:      "gateway.networking.k8s.io",
		Kind:       "TCPRoute",
		Plural:     "tcproutes",
	...
	K8SGatewayApiV1Alpha2Tlsroutes = resource.Builder{
		Identifier: "TLSRoute",
		Group:      "gateway.networking.k8s.io",
		Kind:       "TLSRoute",
		Plural:     "tlsroutes",
	...
	K8SGatewayApiV1Beta1Gatewayclasses = resource.Builder{
	...
	K8SGatewayApiV1Beta1Gateways = resource.Builder{
	...
	K8SGatewayApiV1Beta1Httproutes = resource.Builder{
	...
	K8SNetworkingV1Ingresses = resource.Builder{
		Identifier: "Ingress",

...
const (
	...
	Operator_Configuration_Switch                                    Feature = "operator.configuration.switch"
	Operator_Configuration_Error                                     Feature = "operator.configuration.error"
	Operator_Install_Remove                                          Feature = "operator.install.remove"
)

...
// process data associated with the 'samplecheck' template.
//
...
type HandlerBuilder interface {
	...
	// SetSampleCheckTypes is invoked by Mixer to pass the template-specific Type information for instances that an adapter
	// may receive at runtime. The type information describes the shape of the instance.
	SetSampleCheckTypes(map[string]*Type /*Instance name -> Type*/)
}
...
// at configuration time via the method 'SetSampleCheckTypes'.
// These Type associated with an instance describes the shape of the instance
type Handler interface {
	adapter.Handler

	// HandleSampleCheck is called by Mixer at request time to deliver instances to
	// to an adapter.
	HandleSampleCheck(context.Context, *Instance) (adapter.CheckResult, error)
}

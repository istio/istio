...
// buildAgwTCPDestination builds the agw RouteBackend for a given list of BackendRefs for TCPRoute
...
// buildAgwHTTPDestination builds the RouteBackend for a given list of HTTPBackendRefs

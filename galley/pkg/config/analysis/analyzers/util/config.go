...
func IstioNamespace(ctx analysis.Context) string {
	// This assumes that rootNamespace is an accurate proxy for the control plane namespace. If this is ever not the case, we will need to be
	// a bit smarter about how we get this value.

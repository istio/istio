...
func (m *InstanceParam) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.OriginUid) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintGoDefaultLibraryTmpl(dAtA, i, uint64(len(m.OriginUid)))
		i += copy(dAtA[i:], m.OriginUid)
	}
	if len(m.OriginIp) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintGoDefaultLibraryTmpl(dAtA, i, uint64(len(m.OriginIp)))
...
var fileDescriptorGoDefaultLibraryTmpl = []byte{
	...
	,
}

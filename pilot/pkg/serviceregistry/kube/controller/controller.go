...
func NewController(kubeClient kubelib.Client, options Options) *Controller {
	...
	c := &Controller{
		...
		foreignRegistryInstancesByIP: make(map[string]*model.ForeignInstance),
...
func (c *Controller) hydrateForeignServiceInstance(si *model.ForeignInstance) ([]*model.ServiceInstance, error) {
...
func (c *Controller) ForeignServiceInstanceHandler(si *model.ForeignInstance, event model.Event) {

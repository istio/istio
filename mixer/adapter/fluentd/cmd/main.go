...
import (
	...
	"istio.io/istio/mixer/adapter/fluentd/cmd/server"
)
...
func GetCmd(_ []string) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "fluentd",
		Short: "Istio fluentd out of process adapter.",
...
func runServer(args *Args) {
	s, err := server.NewFluentdNoSessionServer(args.AdapterPort, args.APIWorkerPoolSize, args.Cert)
	if err != nil {

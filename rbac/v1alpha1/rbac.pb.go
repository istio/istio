...
func (RbacConfig_Mode) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{5, 0} }
...
func (*RbacConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
func (*RbacConfig_Target) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5, 0} }

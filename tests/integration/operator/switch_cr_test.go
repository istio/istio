...
func verifyInstallation(t *testing.T, ctx resource.Context,
	istioCtl istioctl.Instance, profileName string, revision string, cs resource.Cluster) object.K8sObjects {
...
func compareInClusterAndGeneratedResources(t *testing.T, cs resource.Cluster, k8sObjects object.K8sObjects,
	expectRemoved bool) {
	if k8sObjects == nil {

...
type Params struct {
	...
	Status rpc.Status `protobuf:"bytes,1,opt,name=status" json:"status"`
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_3da75d16dfa249a7, []int{0}
}
...
func init() {
	proto.RegisterFile("mixer/adapter/denier/config/config.proto", fileDescriptor_config_3da75d16dfa249a7)
}

var fileDescriptor_config_3da75d16dfa249a7 = []byte{

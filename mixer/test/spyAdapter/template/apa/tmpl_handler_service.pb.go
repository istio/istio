...
func (*HandleSampleApaRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tmpl_handler_service_259a157571f10e33, []int{0}
}
...
func (dst *HandleSampleApaRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HandleSampleApaRequest.Merge(dst, src)
}
...
type OutputMsg struct {
	...
	Ip                   *v1beta1.IPAddress `protobuf:"bytes,6,opt,name=ip" json:"ip,omitempty"`
	Duration             *v1beta1.Duration  `protobuf:"bytes,7,opt,name=duration" json:"duration,omitempty"`
	Timestamp            *v1beta1.TimeStamp `protobuf:"bytes,8,opt,name=timestamp" json:"timestamp,omitempty"`
	Dns                  *v1beta1.DNSName   `protobuf:"bytes,9,opt,name=dns" json:"dns,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (*OutputMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_tmpl_handler_service_259a157571f10e33, []int{1}
}
...
func (*InstanceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_tmpl_handler_service_259a157571f10e33, []int{2}
}
...
func (*Type) Descriptor() ([]byte, []int) {
	return fileDescriptor_tmpl_handler_service_259a157571f10e33, []int{3}
}
...
func (*InstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptor_tmpl_handler_service_259a157571f10e33, []int{4}
}
...
func init() {
	proto.RegisterFile("mixer/test/spyAdapter/template/apa/tmpl_handler_service.proto", fileDescriptor_tmpl_handler_service_259a157571f10e33)
}

var fileDescriptor_tmpl_handler_service_259a157571f10e33 = []byte{

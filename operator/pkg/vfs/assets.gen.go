...
// charts/istio-control/istio-discovery/templates/revision-tags.yaml
// charts/istio-control/istio-discovery/templates/service.yaml
// charts/istio-control/istio-discovery/templates/telemetryv2_1.10.yaml
// charts/istio-control/istio-discovery/templates/telemetryv2_1.8.yaml
// charts/istio-control/istio-discovery/templates/telemetryv2_1.9.yaml
...
// charts/istiod-remote/templates/telemetryv2_1.10.yaml
// charts/istiod-remote/templates/telemetryv2_1.8.yaml
// charts/istiod-remote/templates/telemetryv2_1.9.yaml
// charts/istiod-remote/values.yaml
// profiles/default.yaml
// profiles/demo.yaml
// profiles/empty.yaml
// profiles/minimal.yaml
// profiles/openshift.yaml
...
var _chartsReadmeHelm3Md = []byte(`# Helm v3 support
...
var _chartsGatewaysIstioIngressTemplatesDeploymentYaml = []byte(`
...
var _chartsInstallOpenshiftMd = []byte(`# Installing Istio on OpenShift using Helm
...
func chartsInstallOpenshiftMdBytes() ([]byte, error) {
	return _chartsInstallOpenshiftMd, nil
}

func chartsInstallOpenshiftMd() (*asset, error) {
	bytes, err := chartsInstallOpenshiftMdBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "charts/install-OpenShift.md", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _chartsIstioControlIstioDiscoveryFilesInjectionTemplateYaml = []byte(` {{- $containers := list }}
{{- range $index, $container := .Spec.Containers }}{{ if not (eq $container.Name "istio-proxy") }}{{ $containers = append $containers $container.Name }}{{end}}{{- end}}
metadata:
  labels:
    security.istio.io/tlsMode: {{ index .ObjectMeta.Labels `+"`"+`security.istio.io/tlsMode`+"`"+` | default "istio"  | quote }}
...
var _chartsIstioControlIstioDiscoveryTemplatesMutatingwebhookYaml = []byte(`{{- /* Core defines the common configuration used by all webhook segments */}}
{{- define "core" }}
...
var _chartsIstioControlIstioDiscoveryTemplatesRevisionTagsYaml = []byte(`# Adapted from istio-discovery/templates/mutatingwebhook.yaml
# Removed paths for legacy and default selectors since a revision tag
# is inherently created from a specific revision
{{- define "core" }}
- name: {{.Prefix}}sidecar-injector.istio.io
...
func chartsIstioControlIstioDiscoveryTemplatesRevisionTagsYamlBytes() ([]byte, error) {
	return _chartsIstioControlIstioDiscoveryTemplatesRevisionTagsYaml, nil
}

func chartsIstioControlIstioDiscoveryTemplatesRevisionTagsYaml() (*asset, error) {
	bytes, err := chartsIstioControlIstioDiscoveryTemplatesRevisionTagsYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "charts/istio-control/istio-discovery/templates/revision-tags.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _chartsIstioControlIstioDiscoveryTemplatesTelemetryv2_110Yaml = []byte(`{{- if and .Values.telemetry.enabled .Values.telemetry.v2.enabled }}
# Note: metadata exchange filter is wasm enabled only in sidecars.
apiVersion: networking.istio.io/v1alpha3
kind: EnvoyFilter
metadata:
...
func chartsIstioControlIstioDiscoveryTemplatesTelemetryv2_110YamlBytes() ([]byte, error) {
	return _chartsIstioControlIstioDiscoveryTemplatesTelemetryv2_110Yaml, nil
}

func chartsIstioControlIstioDiscoveryTemplatesTelemetryv2_110Yaml() (*asset, error) {
	bytes, err := chartsIstioControlIstioDiscoveryTemplatesTelemetryv2_110YamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "charts/istio-control/istio-discovery/templates/telemetryv2_1.10.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _chartsIstioControlIstioDiscoveryTemplatesTelemetryv2_19Yaml = []byte(`{{- if and .Values.telemetry.enabled .Values.telemetry.v2.enabled }}
# Note: metadata exchange filter is wasm enabled only in sidecars.
apiVersion: networking.istio.io/v1alpha3
kind: EnvoyFilter
metadata:
...
func chartsIstioControlIstioDiscoveryTemplatesTelemetryv2_19YamlBytes() ([]byte, error) {
	return _chartsIstioControlIstioDiscoveryTemplatesTelemetryv2_19Yaml, nil
}

func chartsIstioControlIstioDiscoveryTemplatesTelemetryv2_19Yaml() (*asset, error) {
	bytes, err := chartsIstioControlIstioDiscoveryTemplatesTelemetryv2_19YamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "charts/istio-control/istio-discovery/templates/telemetryv2_1.9.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _chartsIstiodRemoteFilesInjectionTemplateYaml = []byte(` {{- $containers := list }}
{{- range $index, $container := .Spec.Containers }}{{ if not (eq $container.Name "istio-proxy") }}{{ $containers = append $containers $container.Name }}{{end}}{{- end}}
metadata:
  labels:
    security.istio.io/tlsMode: {{ index .ObjectMeta.Labels `+"`"+`security.istio.io/tlsMode`+"`"+` | default "istio"  | quote }}
...
var _chartsIstiodRemoteTemplatesConfigmapYaml = []byte(`{{- define "mesh" }}
    # The trust domain corresponds to the trust root of a system.
    # Refer to https://github.com/spiffe/spiffe/blob/master/standards/SPIFFE-ID.md#21-trust-domain
    trustDomain: "cluster.local"
...
var _chartsIstiodRemoteTemplatesMutatingwebhookYaml = []byte(`{{- /* Core defines the common configuration used by all webhook segments */}}
{{- define "core" }}
{{- /* Kubernetes unfortunately requires a unique name for the webhook in some newer versions, so we assign
a unique prefix to each. */}}
- name: {{.Prefix}}sidecar-injector.istio.io
...
var _chartsIstiodRemoteTemplatesTelemetryv2_110Yaml = []byte(`{{- if and .Values.telemetry.enabled .Values.telemetry.v2.enabled }}
# Note: metadata exchange filter is wasm enabled only in sidecars.
apiVersion: networking.istio.io/v1alpha3
kind: EnvoyFilter
metadata:
...
func chartsIstiodRemoteTemplatesTelemetryv2_110YamlBytes() ([]byte, error) {
	return _chartsIstiodRemoteTemplatesTelemetryv2_110Yaml, nil
}

func chartsIstiodRemoteTemplatesTelemetryv2_110Yaml() (*asset, error) {
	bytes, err := chartsIstiodRemoteTemplatesTelemetryv2_110YamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "charts/istiod-remote/templates/telemetryv2_1.10.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _chartsIstiodRemoteTemplatesTelemetryv2_19Yaml = []byte(`{{- if and .Values.telemetry.enabled .Values.telemetry.v2.enabled }}
# Note: metadata exchange filter is wasm enabled only in sidecars.
apiVersion: networking.istio.io/v1alpha3
kind: EnvoyFilter
metadata:
...
func chartsIstiodRemoteTemplatesTelemetryv2_19YamlBytes() ([]byte, error) {
	return _chartsIstiodRemoteTemplatesTelemetryv2_19Yaml, nil
}

func chartsIstiodRemoteTemplatesTelemetryv2_19Yaml() (*asset, error) {
	bytes, err := chartsIstiodRemoteTemplatesTelemetryv2_19YamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "charts/istiod-remote/templates/telemetryv2_1.9.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _chartsIstiodRemoteValuesYaml = []byte(`#.Values.pilot for discovery and mesh wide config
...
var _profilesOpenshiftYaml = []byte(`apiVersion: install.istio.io/v1alpha1
kind: IstioOperator
spec:
  components:
    cni:
...
func profilesOpenshiftYamlBytes() ([]byte, error) {
	return _profilesOpenshiftYaml, nil
}

func profilesOpenshiftYaml() (*asset, error) {
	bytes, err := profilesOpenshiftYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "profiles/openshift.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"charts/install-OpenShift.md":                                                   chartsInstallOpenshiftMd,
	...
	"charts/istio-control/istio-discovery/templates/revision-tags.yaml":             chartsIstioControlIstioDiscoveryTemplatesRevisionTagsYaml,
	"charts/istio-control/istio-discovery/templates/service.yaml":                   chartsIstioControlIstioDiscoveryTemplatesServiceYaml,
	"charts/istio-control/istio-discovery/templates/telemetryv2_1.10.yaml":          chartsIstioControlIstioDiscoveryTemplatesTelemetryv2_110Yaml,
	...
	"charts/istio-control/istio-discovery/templates/telemetryv2_1.9.yaml":           chartsIstioControlIstioDiscoveryTemplatesTelemetryv2_19Yaml,
	...
	"charts/istiod-remote/templates/telemetryv2_1.10.yaml":                          chartsIstiodRemoteTemplatesTelemetryv2_110Yaml,
	"charts/istiod-remote/templates/telemetryv2_1.8.yaml":                           chartsIstiodRemoteTemplatesTelemetryv2_18Yaml,
	"charts/istiod-remote/templates/telemetryv2_1.9.yaml":                           chartsIstiodRemoteTemplatesTelemetryv2_19Yaml,
	...
	"profiles/openshift.yaml":                                                       profilesOpenshiftYaml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"charts": &bintree{nil, map[string]*bintree{
		...
		"install-OpenShift.md": &bintree{chartsInstallOpenshiftMd, map[string]*bintree{}},
		...
		"istio-control": &bintree{nil, map[string]*bintree{
			"istio-discovery": &bintree{nil, map[string]*bintree{
				...
				"templates": &bintree{nil, map[string]*bintree{
					...
					"revision-tags.yaml":             &bintree{chartsIstioControlIstioDiscoveryTemplatesRevisionTagsYaml, map[string]*bintree{}},
					"service.yaml":                   &bintree{chartsIstioControlIstioDiscoveryTemplatesServiceYaml, map[string]*bintree{}},
					"telemetryv2_1.10.yaml":          &bintree{chartsIstioControlIstioDiscoveryTemplatesTelemetryv2_110Yaml, map[string]*bintree{}},
					"telemetryv2_1.8.yaml":           &bintree{chartsIstioControlIstioDiscoveryTemplatesTelemetryv2_18Yaml, map[string]*bintree{}},
					"telemetryv2_1.9.yaml":           &bintree{chartsIstioControlIstioDiscoveryTemplatesTelemetryv2_19Yaml, map[string]*bintree{}},
				}},
		...
		"istiod-remote": &bintree{nil, map[string]*bintree{
			...
			"templates": &bintree{nil, map[string]*bintree{
				...
				"telemetryv2_1.10.yaml":          &bintree{chartsIstiodRemoteTemplatesTelemetryv2_110Yaml, map[string]*bintree{}},
				"telemetryv2_1.8.yaml":           &bintree{chartsIstiodRemoteTemplatesTelemetryv2_18Yaml, map[string]*bintree{}},
				"telemetryv2_1.9.yaml":           &bintree{chartsIstiodRemoteTemplatesTelemetryv2_19Yaml, map[string]*bintree{}},
			}},
	...
	"profiles": &bintree{nil, map[string]*bintree{
		...
		"openshift.yaml": &bintree{profilesOpenshiftYaml, map[string]*bintree{}},

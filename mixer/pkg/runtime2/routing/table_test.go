...
var tableTests = []struct {
	...
	V istio_mixer_v1_template.TemplateVariety
...
}{
	{
		...
		V:       istio_mixer_v1_template.TEMPLATE_VARIETY_CHECK,
		Ns:      "istio-system",
		E: `
[#0] hcheck1.acheck.istio-system {H}
  [#0]
	...
	},
	{
		...
		Configs: []string{data.HandlerACheck1, data.InstanceCheck1, data.RuleCheck1},
		V:       istio_mixer_v1_template.TEMPLATE_VARIETY_REPORT,
		Ns:      "istio-system",
		E:       ``,
	},
	{
...
func TestEmpty(t *testing.T) {
	...
	destinations := table.GetDestinations(istio_mixer_v1_template.TEMPLATE_VARIETY_CHECK, "istio-system")

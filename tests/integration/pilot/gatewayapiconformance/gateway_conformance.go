...
var GatewayConformanceTestInputs GatewayConformanceInputs
...
func RunGatewayConformance(t *testing.T) {
	framework.
		NewTest(t).
		Run(func(ctx framework.TestContext) {
			...
			mapper, _ := GatewayConformanceTestInputs.Client.UtilFactory().ToRESTMapper()
			c, err := client.New(GatewayConformanceTestInputs.Client.RESTConfig(), client.Options{
			...
			opts := suite.ConformanceOptions{
				Client:                   c,
				Clientset:                GatewayConformanceTestInputs.Client.Kube(),
				RestConfig:               GatewayConformanceTestInputs.Client.RESTConfig(),
				GatewayClassName:         "istio",
				Debug:                    scopes.Framework.DebugEnabled(),
				CleanupBaseResources:     GatewayConformanceTestInputs.Cleanup,

...
type Params struct {
	...
	Params *types.Any `protobuf:"bytes,2,opt,name=params" json:"params,omitempty"`
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_118fe88f9b1ba80b, []int{0}
}
...
func init() {
	proto.RegisterFile("mixer/adapter/bypass/config/config.proto", fileDescriptor_config_118fe88f9b1ba80b)
}

var fileDescriptor_config_118fe88f9b1ba80b = []byte{

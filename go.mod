...
require (
	...
	github.com/envoyproxy/go-control-plane v0.11.2-0.20231104202517-ef8d30d68b0c
	...
	istio.io/api v1.19.0-alpha.1.0.20231109173120-0da4203dc843
	istio.io/client-go v1.19.0-alpha.1.0.20231109174020-2917b7471fc4
	k8s.io/api v0.28.3

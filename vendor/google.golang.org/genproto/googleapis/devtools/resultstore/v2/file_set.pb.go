...
func (*FileSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_file_set_280c2e38d8963036, []int{0}
}
...
func (*FileSet_Id) Descriptor() ([]byte, []int) {
	return fileDescriptor_file_set_280c2e38d8963036, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("google/devtools/resultstore/v2/file_set.proto", fileDescriptor_file_set_280c2e38d8963036)
}

var fileDescriptor_file_set_280c2e38d8963036 = []byte{

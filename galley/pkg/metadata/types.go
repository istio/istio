...
func init() {
	...
	b.Register("type.googleapis.com/istio.routing.v1alpha1.DestinationPolicy", false)
	b.Register("type.googleapis.com/istio.routing.v1alpha1.EgressRule", false)
	b.Register("type.googleapis.com/istio.routing.v1alpha1.RouteRule", false)

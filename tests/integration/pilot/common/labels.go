...
// RunLabelChangeTests verifies that VirtualService subset routing reacts
// dynamically when workload labels are updated at runtime.
func RunLabelChangeTests(t framework.TestContext, apps deployment.SingleNamespaceView) {
	t.Helper()

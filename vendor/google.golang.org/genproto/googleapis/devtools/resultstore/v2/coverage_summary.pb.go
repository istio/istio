...
func (*LineCoverageSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_coverage_summary_391ab5d1bf003efe, []int{0}
}
...
func (*BranchCoverageSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_coverage_summary_391ab5d1bf003efe, []int{1}
}
...
func (*LanguageCoverageSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_coverage_summary_391ab5d1bf003efe, []int{2}
}
...
func init() {
	proto.RegisterFile("google/devtools/resultstore/v2/coverage_summary.proto", fileDescriptor_coverage_summary_391ab5d1bf003efe)
}

var fileDescriptor_coverage_summary_391ab5d1bf003efe = []byte{

...
require (
	...
	github.com/envoyproxy/go-control-plane v0.11.2-0.20231201010245-4d7ddbeb202d
	...
	istio.io/api v1.19.0-alpha.1.0.20231205163453-515df8dbc3a3
	istio.io/client-go v1.19.0-alpha.1.0.20231205163753-f6f4347fbd33
	k8s.io/api v0.28.4

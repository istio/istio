...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_915285d16e0ea61f, []int{0}
}
...
func init() {
	proto.RegisterFile("mixer/adapter/kubernetesenv/config/config.proto", fileDescriptor_config_915285d16e0ea61f)
}

var fileDescriptor_config_915285d16e0ea61f = []byte{

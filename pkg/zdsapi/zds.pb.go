...
// Add a workload to the ztunnel. Ancillary data containing
// the workload's netns file descriptor will be appended to the end of this message.
...
var file_zdsapi_zds_proto_rawDesc = []byte{
	...
	0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	...
	0x63, 0x6b, 0x42, 0x09, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x42, 0x0c, 0x5a,
	0x0a, 0x70, 0x6b, 0x67, 0x2f, 0x7a, 0x64, 0x73, 0x61, 0x70, 0x69, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_zdsapi_zds_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_zdsapi_zds_proto_goTypes = []interface{}{
	...
	(*Ack)(nil),              // 4: istio.workload.zds.Ack
	(*WorkloadRequest)(nil),  // 5: istio.workload.zds.WorkloadRequest
	(*WorkloadResponse)(nil), // 6: istio.workload.zds.WorkloadResponse
}
var file_zdsapi_zds_proto_depIdxs = []int32{
	...
	4, // 4: istio.workload.zds.WorkloadResponse.ack:type_name -> istio.workload.zds.Ack
...
func file_zdsapi_zds_proto_init() {
	...
	file_zdsapi_zds_proto_msgTypes[5].OneofWrappers = []interface{}{

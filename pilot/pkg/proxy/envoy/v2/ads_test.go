...
func TestAdsClusterUpdate(t *testing.T) {
	...
	_ = server.EnvoyXdsServer.MemRegistry.AddEndpoint("adsclusterupdate.default.svc.cluster.local",
	...
	_ = server.EnvoyXdsServer.MemRegistry.AddEndpoint("adsclusterupdate2.default.svc.cluster.local",

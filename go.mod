...
require (
	...
	istio.io/api v1.26.0-alpha.0.0.20250819205620-f7e25069711d
	istio.io/client-go v1.26.0-alpha.0.0.20250819205920-3170c138da93
	k8s.io/api v0.33.4
	...
	sigs.k8s.io/gateway-api-inference-extension v0.0.0-20250819155735-f36111cab0ed

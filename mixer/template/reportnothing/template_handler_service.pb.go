...
func (*HandleReportNothingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_24d4537111a08510, []int{0}
}
...
func (*InstanceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_24d4537111a08510, []int{1}
}
...
func (*Type) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_24d4537111a08510, []int{2}
}
...
func (*InstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_24d4537111a08510, []int{3}
}
...
func init() {
	proto.RegisterFile("mixer/template/reportnothing/template_handler_service.proto", fileDescriptor_template_handler_service_24d4537111a08510)
}

var fileDescriptor_template_handler_service_24d4537111a08510 = []byte{

...
CRDS="MockConfig RouteRule V1alpha2RouteRule IngressRule Gateway EgressRule ForeignService DestinationPolicy DestinationRule HTTPAPISpec HTTPAPISpecBinding QuotaSpec QuotaSpecBinding EndUserAuthenticationPolicySpec EndUserAuthenticationPolicySpecBinding"

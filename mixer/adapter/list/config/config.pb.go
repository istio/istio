...
func (Params_ListEntryType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_config_cc8f84d8b8eed181, []int{0, 0}
}
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_cc8f84d8b8eed181, []int{0}
}
...
func init() {
	proto.RegisterFile("mixer/adapter/list/config/config.proto", fileDescriptor_config_cc8f84d8b8eed181)
}

var fileDescriptor_config_cc8f84d8b8eed181 = []byte{

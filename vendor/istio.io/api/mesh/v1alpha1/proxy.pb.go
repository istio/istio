...
type ProxyConfig struct {
	...
	// Envoy node metadata as described [here](https://www.envoyproxy.io/docs/envoy/latest/api-v2/api/v2/core/base.proto)
	// Values in this map may be overloaded by environment variables.
	EnvoyNodeMetadata    map[string]string `protobuf:"bytes,21,rep,name=envoy_node_metadata,json=envoyNodeMetadata,proto3" json:"envoy_node_metadata,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *ProxyConfig) GetEnvoyNodeMetadata() map[string]string {
	if m != nil {
		return m.EnvoyNodeMetadata
	}
	return nil
}
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "istio.mesh.v1alpha1.ProxyConfig.EnvoyNodeMetadataEntry")
}
...
var fileDescriptor_5efecd978cf3d28d = []byte{
	...
	,
}
...
func (m *ProxyConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.EnvoyNodeMetadata) > 0 {
		for k, _ := range m.EnvoyNodeMetadata {
			dAtA[i] = 0xaa
			i++
			dAtA[i] = 0x1
			i++
			v := m.EnvoyNodeMetadata[k]
			mapSize := 1 + len(k) + sovProxy(uint64(len(k))) + 1 + len(v) + sovProxy(uint64(len(v)))
			i = encodeVarintProxy(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
...
func (m *ProxyConfig) Size() (n int) {
	...
	if len(m.EnvoyNodeMetadata) > 0 {
		for k, v := range m.EnvoyNodeMetadata {
			_ = k
			_ = v
...
func (m *ProxyConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 21:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnvoyNodeMetadata", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.EnvoyNodeMetadata == nil {
				m.EnvoyNodeMetadata = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.EnvoyNodeMetadata[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipProxy(dAtA[iNdEx:])

...
func (Plugin) OnInboundCluster(in *plugin.InputParams, cluster *clusterv3.Cluster) {
}
...
func (Plugin) OnOutboundCluster(in *plugin.InputParams, cluster *clusterv3.Cluster) {
}

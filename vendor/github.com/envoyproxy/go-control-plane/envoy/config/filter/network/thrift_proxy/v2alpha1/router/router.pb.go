...
func (*Router) Descriptor() ([]byte, []int) {
	return fileDescriptor_router_4f4aeca09a987c07, []int{0}
}
...
func init() {
	proto.RegisterFile("envoy/config/filter/network/thrift_proxy/v2alpha1/router/router.proto", fileDescriptor_router_4f4aeca09a987c07)
}

var fileDescriptor_router_4f4aeca09a987c07 = []byte{

...
func skipQuotaTesterTemplateHandlerService(dAtA []byte) (n int, err error) {
	...
	for iNdEx < l {
		...
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupQuotaTesterTemplateHandlerService
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	...
	ErrUnexpectedEndOfGroupQuotaTesterTemplateHandlerService = fmt.Errorf("proto: unexpected end of group")
)

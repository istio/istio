...
type ConfigGenerator interface {
	...
	BuildDeltaClusters(node *model.Proxy, push *model.PushContext, updates *model.PushRequest, watched *model.WatchedResource) ([]*discovery.Resource, []string, model.XdsLogDetails, bool)

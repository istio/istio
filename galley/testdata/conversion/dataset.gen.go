...
// sources:
// dataset/config.istio.io/v1alpha2/instance.yaml
...
func datasetConfigIstioIoV1alpha2CirconusYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "dataset/config.istio.io/v1alpha2/instance.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
...
var _bindata = map[string]func() (*asset, error){
	"dataset/config.istio.io/v1alpha2/instance.yaml": datasetConfigIstioIoV1alpha2CirconusYaml,
	...
	"dataset": &bintree{nil, map[string]*bintree{
		"config.istio.io": &bintree{nil, map[string]*bintree{
			"v1alpha2": &bintree{nil, map[string]*bintree{
				"instance.yaml": &bintree{datasetConfigIstioIoV1alpha2CirconusYaml, map[string]*bintree{}},

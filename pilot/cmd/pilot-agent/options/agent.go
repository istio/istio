...
func NewAgentOptions(proxy *model.Proxy, cfg *meshconfig.ProxyConfig) *istioagent.AgentOptions {
	...
	o := &istioagent.AgentOptions{
		...
		TdInterceptionPort:          tdInterceptionPortEnv.Get(),
		TdInboundInterceptionPort:   tdInboundInterceptionPortEnv.Get(),
		TdInboundBackendPorts:       tdInboundBackendPortsEnv.Get(),

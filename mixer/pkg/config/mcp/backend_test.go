...
func createState(t *testing.T) *testState {
	...
	var typeUrls []string
	var kinds []string
	st.mapping = constructMapping([]string{})
...
func TestBackend_List(t *testing.T) {
	...
	b.SetEntry(st.mapping.typeURL(constant.RulesKind), "ns1/e1", r1)
	b.SetEntry(st.mapping.typeURL(constant.RulesKind), "ns2/e2", r2)
	b.SetEntry(st.mapping.typeURL(constant.RulesKind), "e3", r3)
	b.SetVersion(st.mapping.typeURL(constant.RulesKind), "v1")
	sn := b.Build()
...
loop:
	...
	// delete ns1/e1
	// update ns2/e2 (r2 -> r1)
	b.SetEntry(st.mapping.typeURL(constant.RulesKind), "ns2/e2", r1)
	// e3 doesn't change
	b.SetEntry(st.mapping.typeURL(constant.RulesKind), "e3", r3)
	b.SetVersion(st.mapping.typeURL(constant.RulesKind), "v2")

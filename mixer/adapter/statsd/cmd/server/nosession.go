...
// NewStatsdNoSessionServer creates a new no session server based on given args.
func NewStatsdNoSessionServer(addr uint16, poolSize int, c *Cert) (*NoSession, error) {

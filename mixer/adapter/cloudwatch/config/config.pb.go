...
func (Params_MetricDatum_Unit) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_config_f1ddeb38f8ed6bc0, []int{0, 1, 0}
}
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_f1ddeb38f8ed6bc0, []int{0}
}
...
func (*Params_MetricDatum) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_f1ddeb38f8ed6bc0, []int{0, 1}
}
...
func (dst *Params_MetricDatum) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Params_MetricDatum.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("mixer/adapter/cloudwatch/config/config.proto", fileDescriptor_config_f1ddeb38f8ed6bc0)
}

var fileDescriptor_config_f1ddeb38f8ed6bc0 = []byte{

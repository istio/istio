...
const TemplateName = "mylistchecker"

// Instance is constructed by Mixer for the 'mylistchecker' template.
...
// process data associated with the 'mylistchecker' template.
//
...
type HandlerBuilder interface {
	...
	// SetMylistCheckerTypes is invoked by Mixer to pass the template-specific Type information for instances that an adapter
	// may receive at runtime. The type information describes the shape of the instance.
	SetMylistCheckerTypes(map[string]*Type /*Instance name -> Type*/)
}
...
// at configuration time via the method 'SetMylistCheckerTypes'.
// These Type associated with an instance describes the shape of the instance
type Handler interface {
	adapter.Handler

	// HandleMylistChecker is called by Mixer at request time to deliver instances to
	// to an adapter.
	HandleMylistChecker(context.Context, *Instance) (adapter.CheckResult, error)
}

...
func (FaultDelay_FaultDelayType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_fault_c9ff32f78fd64a59, []int{0, 0}
}
...
func (*FaultDelay) Descriptor() ([]byte, []int) {
	return fileDescriptor_fault_c9ff32f78fd64a59, []int{0}
}
...
func init() {
	proto.RegisterFile("envoy/config/filter/fault/v2/fault.proto", fileDescriptor_fault_c9ff32f78fd64a59)
}

var fileDescriptor_fault_c9ff32f78fd64a59 = []byte{

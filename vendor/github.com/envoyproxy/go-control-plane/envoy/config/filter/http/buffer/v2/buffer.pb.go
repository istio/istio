...
func (*Buffer) Descriptor() ([]byte, []int) {
	return fileDescriptor_buffer_283149dca49e2882, []int{0}
}
...
func (*BufferPerRoute) Descriptor() ([]byte, []int) {
	return fileDescriptor_buffer_283149dca49e2882, []int{1}
}
...
func init() {
	proto.RegisterFile("envoy/config/filter/http/buffer/v2/buffer.proto", fileDescriptor_buffer_283149dca49e2882)
}

var fileDescriptor_buffer_283149dca49e2882 = []byte{

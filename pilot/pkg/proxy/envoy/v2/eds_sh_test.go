	...
	tests := []struct {
	...
	}{
		{
			...
			want: expectedResults{
				...
				weights:   map[string]uint32{"159.122.219.2": 29, "159.122.219.3": 43},
			},
		},
		{
			...
			want: expectedResults{
				...
				weights:   map[string]uint32{"159.122.219.1": 15, "159.122.219.3": 43, "179.114.119.3": 43},
			},
		},
		{
			...
			want: expectedResults{
				...
				weights:   map[string]uint32{"159.122.219.1": 22, "159.122.219.2": 43},
			},
		},
		{
			...
			want: expectedResults{
				...
				weights:   map[string]uint32{"159.122.219.1": 10, "159.122.219.2": 20, "159.122.219.3": 30, "179.114.119.3": 30},
			},
		},
	}

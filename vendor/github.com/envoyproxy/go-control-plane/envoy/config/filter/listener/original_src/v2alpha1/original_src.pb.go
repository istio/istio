...
func (*OriginalSrc) Descriptor() ([]byte, []int) {
	return fileDescriptor_original_src_c0965da55b890770, []int{0}
}
...
func (dst *OriginalSrc) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OriginalSrc.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("envoy/config/filter/listener/original_src/v2alpha1/original_src.proto", fileDescriptor_original_src_c0965da55b890770)
}

var fileDescriptor_original_src_c0965da55b890770 = []byte{
	...
	0x96, 0xdc, 0xc4, 0xa2, 0x6c, 0x09, 0x26, 0x05, 0x46, 0x0d, 0xde, 0x20, 0x30, 0xdb, 0x29, 0xea,
	0xc4, 0x23, 0x39, 0xc6, 0x0b, 0x8f, 0xe4, 0x18, 0x1f, 0x3c, 0x92, 0x63, 0xe4, 0x72, 0xc8, 0xcc,
	0xd7, 0x03, 0xbb, 0xae, 0xa0, 0x28, 0xbf, 0xa2, 0x52, 0x8f, 0x74, 0x87, 0x06, 0x30, 0x46, 0x71,
	0xc0, 0xd8, 0x49, 0x6c, 0x60, 0x27, 0x1a, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x58, 0x44, 0x8e,
	0x6b, 0x38, 0x01, 0x00, 0x00,
}

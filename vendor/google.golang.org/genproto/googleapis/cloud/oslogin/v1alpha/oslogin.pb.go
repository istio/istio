...
func (*LoginProfile) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_3ca03200c5852c9e, []int{0}
}
...
func (*DeletePosixAccountRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_3ca03200c5852c9e, []int{1}
}
...
func (*DeleteSshPublicKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_3ca03200c5852c9e, []int{2}
}
...
func (*GetLoginProfileRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_3ca03200c5852c9e, []int{3}
}
...
func (*GetSshPublicKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_3ca03200c5852c9e, []int{4}
}
...
func (*ImportSshPublicKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_3ca03200c5852c9e, []int{5}
}
...
func (*ImportSshPublicKeyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_3ca03200c5852c9e, []int{6}
}
...
func (*UpdateSshPublicKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_3ca03200c5852c9e, []int{7}
}
...
func init() {
	proto.RegisterFile("google/cloud/oslogin/v1alpha/oslogin.proto", fileDescriptor_oslogin_3ca03200c5852c9e)
}

var fileDescriptor_oslogin_3ca03200c5852c9e = []byte{

...
// source: mixer/template/sample/check/CheckTesterTemplate_instance.proto

/*
	Package istio_mixer_adapter_sample_check is a generated protocol buffer package.

	It is generated from these files:
		mixer/template/sample/check/CheckTesterTemplate_instance.proto
...
func (*Type) Descriptor() ([]byte, []int) { return fileDescriptorCheckTesterTemplateInstance, []int{0} }
...
func (*Res1Type) Descriptor() ([]byte, []int) {
	return fileDescriptorCheckTesterTemplateInstance, []int{1}
}
...
func (*Res2Type) Descriptor() ([]byte, []int) {
	return fileDescriptorCheckTesterTemplateInstance, []int{2}
}
...
func (*InstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptorCheckTesterTemplateInstance, []int{3}
}
...
func (*Res1InstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptorCheckTesterTemplateInstance, []int{4}
}
...
func (*Res2InstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptorCheckTesterTemplateInstance, []int{5}
}
...
func valueToGoStringCheckTesterTemplateInstance(v interface{}, typ string) string {
...
func (m *Type) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Res1 != nil {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintCheckTesterTemplateInstance(dAtA, i, uint64(m.Res1.Size()))
...
func (m *Res1Type) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Value != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintCheckTesterTemplateInstance(dAtA, i, uint64(m.Value))
	}
	if len(m.Dimensions) > 0 {
		for k, _ := range m.Dimensions {
			...
			i++
			v := m.Dimensions[k]
			mapSize := 1 + len(k) + sovCheckTesterTemplateInstance(uint64(len(k))) + 1 + sovCheckTesterTemplateInstance(uint64(v))
			i = encodeVarintCheckTesterTemplateInstance(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
			i = encodeVarintCheckTesterTemplateInstance(dAtA, i, uint64(len(k)))
			i += copy(dAtA[i:], k)
			dAtA[i] = 0x10
			i++
			i = encodeVarintCheckTesterTemplateInstance(dAtA, i, uint64(v))
		}
	}
	if m.Res2 != nil {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintCheckTesterTemplateInstance(dAtA, i, uint64(m.Res2.Size()))
	...
	if len(m.Res2Map) > 0 {
		for k, _ := range m.Res2Map {
			...
			if v != nil {
				msgSize = v.Size()
				msgSize += 1 + sovCheckTesterTemplateInstance(uint64(msgSize))
			}
			mapSize := 1 + len(k) + sovCheckTesterTemplateInstance(uint64(len(k))) + msgSize
			i = encodeVarintCheckTesterTemplateInstance(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
			i = encodeVarintCheckTesterTemplateInstance(dAtA, i, uint64(len(k)))
			...
			if v != nil {
				dAtA[i] = 0x12
				i++
				i = encodeVarintCheckTesterTemplateInstance(dAtA, i, uint64(v.Size()))
...
func (m *InstanceParam) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.CheckExpression) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintCheckTesterTemplateInstance(dAtA, i, uint64(len(m.CheckExpression)))
	...
	if len(m.StringMap) > 0 {
		for k, _ := range m.StringMap {
			...
			i++
			v := m.StringMap[k]
			mapSize := 1 + len(k) + sovCheckTesterTemplateInstance(uint64(len(k))) + 1 + len(v) + sovCheckTesterTemplateInstance(uint64(len(v)))
			i = encodeVarintCheckTesterTemplateInstance(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
			i = encodeVarintCheckTesterTemplateInstance(dAtA, i, uint64(len(k)))
			...
			dAtA[i] = 0x12
			i++
			i = encodeVarintCheckTesterTemplateInstance(dAtA, i, uint64(len(v)))
			i += copy(dAtA[i:], v)
		}
	}
	if m.Res1 != nil {
...
func (m *Res1InstanceParam) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Value) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintCheckTesterTemplateInstance(dAtA, i, uint64(len(m.Value)))
	...
	if len(m.Int64Primitive) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintCheckTesterTemplateInstance(dAtA, i, uint64(len(m.Int64Primitive)))
		i += copy(dAtA[i:], m.Int64Primitive)
	}
	if len(m.BoolPrimitive) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintCheckTesterTemplateInstance(dAtA, i, uint64(len(m.BoolPrimitive)))
		i += copy(dAtA[i:], m.BoolPrimitive)
	}
	if len(m.DoublePrimitive) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintCheckTesterTemplateInstance(dAtA, i, uint64(len(m.DoublePrimitive)))
		i += copy(dAtA[i:], m.DoublePrimitive)
	}
	if len(m.StringPrimitive) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintCheckTesterTemplateInstance(dAtA, i, uint64(len(m.StringPrimitive)))
	...
	if len(m.TimeStamp) > 0 {
		dAtA[i] = 0x4a
		i++
		i = encodeVarintCheckTesterTemplateInstance(dAtA, i, uint64(len(m.TimeStamp)))
		i += copy(dAtA[i:], m.TimeStamp)
	}
	if len(m.Duration) > 0 {
		dAtA[i] = 0x52
		i++
		i = encodeVarintCheckTesterTemplateInstance(dAtA, i, uint64(len(m.Duration)))
...
func encodeVarintCheckTesterTemplateInstance(dAtA []byte, offset int, v uint64) int {
	for v >= 1<<7 {
...
func (m *Type) Size() (n int) {
	...
	if m.Res1 != nil {
		l = m.Res1.Size()
		n += 1 + l + sovCheckTesterTemplateInstance(uint64(l))
	}
	return n
}
...
func (m *Res1Type) Size() (n int) {
	...
	_ = l
	if m.Value != 0 {
		n += 1 + sovCheckTesterTemplateInstance(uint64(m.Value))
	}
	if len(m.Dimensions) > 0 {
		for k, v := range m.Dimensions {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovCheckTesterTemplateInstance(uint64(len(k))) + 1 + sovCheckTesterTemplateInstance(uint64(v))
			n += mapEntrySize + 1 + sovCheckTesterTemplateInstance(uint64(mapEntrySize))
		}
	}
	if m.Res2 != nil {
		l = m.Res2.Size()
	...
	if len(m.Res2Map) > 0 {
		for k, v := range m.Res2Map {
			...
			if v != nil {
				l = v.Size()
				l += 1 + sovCheckTesterTemplateInstance(uint64(l))
			}
			mapEntrySize := 1 + len(k) + sovCheckTesterTemplateInstance(uint64(len(k))) + l
			n += mapEntrySize + 1 + sovCheckTesterTemplateInstance(uint64(mapEntrySize))
		}
	}
	return n
...
func (m *InstanceParam) Size() (n int) {
	...
	if len(m.StringMap) > 0 {
		for k, v := range m.StringMap {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovCheckTesterTemplateInstance(uint64(len(k))) + 1 + len(v) + sovCheckTesterTemplateInstance(uint64(len(v)))
			n += mapEntrySize + 1 + sovCheckTesterTemplateInstance(uint64(mapEntrySize))
		}
	}
	if m.Res1 != nil {
...
func sovCheckTesterTemplateInstance(x uint64) (n int) {
	for {
		n++
		x >>= 7
		if x == 0 {
...
func sozCheckTesterTemplateInstance(x uint64) (n int) {
	return sovCheckTesterTemplateInstance(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
...
func valueToStringCheckTesterTemplateInstance(v interface{}) string {
	rv := reflect.ValueOf(v)
	if rv.IsNil() {
		return "nil"
	}
...
func (m *Type) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowCheckTesterTemplateInstance
			}
			if iNdEx >= l {
		...
		case 11:
			...
			if msglen < 0 {
				return ErrInvalidLengthCheckTesterTemplateInstance
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipCheckTesterTemplateInstance(dAtA[iNdEx:])
			if err != nil {
				return err
			}
			if skippy < 0 {
...
func skipCheckTesterTemplateInstance(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		var wire uint64
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowCheckTesterTemplateInstance
			}
			if iNdEx >= l {
		...
		case 2:
			...
			iNdEx += length
			if length < 0 {
				return 0, ErrInvalidLengthCheckTesterTemplateInstance
			}
			return iNdEx, nil
		case 3:
			for {
				...
				next, err := skipCheckTesterTemplateInstance(dAtA[start:])
				if err != nil {
					return 0, err
				}
				iNdEx = start + next
...
var (
	ErrInvalidLengthCheckTesterTemplateInstance = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowCheckTesterTemplateInstance   = fmt.Errorf("proto: integer overflow")
)

func init() {
	proto.RegisterFile("mixer/template/sample/check/CheckTesterTemplate_instance.proto", fileDescriptorCheckTesterTemplateInstance)
}

var fileDescriptorCheckTesterTemplateInstance = []byte{
	// 713 bytes of a gzipped FileDescriptorProto
	,
}

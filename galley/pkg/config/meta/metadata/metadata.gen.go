...
var _bindataMetadatayaml = []byte(`# Copyright 2019 Istio Authors
#
...
func bindataMetadatayamlBytes() ([]byte, error) {
	return _bindataMetadatayaml, nil
}



func bindataMetadatayaml() (*asset, error) {
	bytes, err := bindataMetadatayamlBytes()
	if err != nil {
		return nil, err
	}
...
var _bindata = map[string]func() (*asset, error){
	"metadata.yaml": bindataMetadatayaml,
}
...
var _bintree = &bintree{Func: nil, Children: map[string]*bintree{
	"metadata.yaml": {Func: bindataMetadatayaml, Children: map[string]*bintree{}},
}}

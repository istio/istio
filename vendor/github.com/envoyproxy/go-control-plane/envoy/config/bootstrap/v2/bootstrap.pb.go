...
type Admin struct {
	...
	Address envoy_api_v2_core1.Address `protobuf:"bytes,3,opt,name=address" json:"address"`
}
...
func (m *Watchdog) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.MissTimeout == nil {
				m.MissTimeout = &google_protobuf3.Duration{}
			}
		...
		case 2:
			...
			if m.MegamissTimeout == nil {
				m.MegamissTimeout = &google_protobuf3.Duration{}
			}
		...
		case 3:
			...
			if m.KillTimeout == nil {
				m.KillTimeout = &google_protobuf3.Duration{}
			}
		...
		case 4:
			...
			if m.MultikillTimeout == nil {
				m.MultikillTimeout = &google_protobuf3.Duration{}
			}

...
func BlockingBatchedTrackerHandler[T any](allowEvents chan struct{}, tracker *assert.Tracker[string]) func([]Event[T], bool) {
	return func(o []Event[T], initialSync bool) {
		<-allowEvents
...
func BatchedTrackerHandler[T any](tracker *assert.Tracker[string]) func([]Event[T], bool) {
	return func(o []Event[T], initialSync bool) {
		tracker.Record(slices.Join(",", slices.Map(o, func(o Event[T]) string {
			return fmt.Sprintf("%v/%v", o.Event, GetKey(o.Latest()))
		})...))

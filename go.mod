...
replace istio.io/api => github.com/Nordix/api v0.0.0-20231206105417-bc264140136d // TODO: REMOVE BEFORE MERGE
...
require (
	...
	istio.io/api v1.19.0-alpha.1.0.20240220203040-bfa7ba498efe
	istio.io/client-go v1.19.0-alpha.1.0.20240220203343-d855de33a746
	k8s.io/api v0.29.1

...
func (*HandleLogEntryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_068083cd854cf5b6, []int{0}
}
...
func (dst *HandleLogEntryRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HandleLogEntryRequest.Merge(dst, src)
}
...
type InstanceMsg struct {
	...
	Variables map[string]*v1beta1.Value `protobuf:"bytes,1,rep,name=variables" json:"variables,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	// Timestamp is the time value for the log entry
	Timestamp *v1beta1.TimeStamp `protobuf:"bytes,2,opt,name=timestamp" json:"timestamp,omitempty"`
	...
	// Otherwise these fields will be ignored by the adapter.
	MonitoredResourceDimensions map[string]*v1beta1.Value `protobuf:"bytes,5,rep,name=monitored_resource_dimensions,json=monitoredResourceDimensions" json:"monitored_resource_dimensions,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	XXX_NoUnkeyedLiteral        struct{}                  `json:"-"`
	XXX_sizecache               int32                     `json:"-"`
}
...
func (*InstanceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_068083cd854cf5b6, []int{1}
}
...
type Type struct {
	// Variables that are delivered for each log entry.
	Variables map[string]v1beta1.ValueType `protobuf:"bytes,1,rep,name=variables" json:"variables,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=istio.policy.v1beta1.ValueType"`
	// Optional. A set of expressions that will form the dimensions of the monitored resource this log entry is being
	// recorded on. If the logging backend supports monitored resources, these fields are used to populate that resource.
	// Otherwise these fields will be ignored by the adapter.
...
func (*Type) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_068083cd854cf5b6, []int{2}
}
...
func (*InstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_handler_service_068083cd854cf5b6, []int{3}
}
...
func init() {
	proto.RegisterFile("mixer/template/logentry/template_handler_service.proto", fileDescriptor_template_handler_service_068083cd854cf5b6)
}

var fileDescriptor_template_handler_service_068083cd854cf5b6 = []byte{
	// 731 bytes of a gzipped FileDescriptorProto
	,
}

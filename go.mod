...
require (
	...
	github.com/envoyproxy/go-control-plane v0.11.2-0.20231020231331-be7ae8824462
	...
	istio.io/api v1.19.0-alpha.1.0.20231020024335-5854e8c6bb9c
	istio.io/client-go v1.19.0-alpha.1.0.20231020025024-19c3131c73d5
	k8s.io/api v0.28.3

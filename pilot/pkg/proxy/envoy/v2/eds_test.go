...
func verifyNoLocalityPriorities(eps []*endpointv3.LocalityLbEndpoints, t *testing.T) {
	for _, ep := range eps {
		if ep.GetPriority() != 0 {
...
func verifyLocalityPriorities(proxyLocality string, eps []*endpointv3.LocalityLbEndpoints, t *testing.T) {

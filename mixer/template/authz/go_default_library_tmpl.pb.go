...
// source: bazel-out/local-fastbuild/genfiles/mixer/template/authz/go_default_library_tmpl.proto

/*
	Package authz is a generated protocol buffer package.

	It is generated from these files:
		bazel-out/local-fastbuild/genfiles/mixer/template/authz/go_default_library_tmpl.proto
...
func init() {
	proto.RegisterType((*Type)(nil), "authz.Type")
	proto.RegisterType((*SubjectType)(nil), "authz.SubjectType")
	proto.RegisterType((*ActionType)(nil), "authz.ActionType")
	proto.RegisterType((*InstanceParam)(nil), "authz.InstanceParam")
	proto.RegisterType((*SubjectInstanceParam)(nil), "authz.SubjectInstanceParam")
	proto.RegisterType((*ActionInstanceParam)(nil), "authz.ActionInstanceParam")
}
...
func (this *InstanceParam) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&authz.InstanceParam{")
	if this.Subject != nil {
		s = append(s, "Subject: "+fmt.Sprintf("%#v", this.Subject)+",\n")
	}
	if this.Action != nil {
...
func (this *SubjectInstanceParam) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&authz.SubjectInstanceParam{")
...
func (this *ActionInstanceParam) GoString() string {
	...
	s := make([]string, 0, 9)
	s = append(s, "&authz.ActionInstanceParam{")
...
func init() {
	proto.RegisterFile("bazel-out/local-fastbuild/genfiles/mixer/template/authz/go_default_library_tmpl.proto", fileDescriptorGoDefaultLibraryTmpl)
}
...
var fileDescriptorGoDefaultLibraryTmpl = []byte{
	...
	,
}

...
import (
	...
	"istio.io/istio/mixer/adapter/prometheus/cmd/server"
)
...
func GetCmd(_ []string) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "prometheus",
		Short: "Istio prometheus out of process adapter.",
...
func runServer(args *Args) {
	s, err := server.NewPrometheusNoSessionServer(args.AdapterPort, args.APIWorkerPoolSize, args.Cert)
	if err != nil {

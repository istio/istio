...
require (
	...
	google.golang.org/grpc v1.50.0-dev.0.20220818173707-97cb7b1653d7
	...
	istio.io/client-go v1.12.0-alpha.5.0.20220817131910-79d4c5aadb88
	istio.io/pkg v0.0.0-20220817213312-f8c82a98f06c
	k8s.io/api v0.24.4

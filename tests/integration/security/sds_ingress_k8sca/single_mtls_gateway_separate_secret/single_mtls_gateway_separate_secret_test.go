...
// TestSingleMTLSGateway_ServerKeyCertRotation_K8sca tests a single mTLS ingress gateway with SDS enabled.
...
func TestSingleMTLSGateway_ServerKeyCertRotation_K8sca(t *testing.T) {
	framework.
		NewTest(t).

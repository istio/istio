...
func (ClusterOperationStatus_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_operations_b5f0912bfbd4b982, []int{0, 0}
}
...
func (*ClusterOperationStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_operations_b5f0912bfbd4b982, []int{0}
}
...
func (*ClusterOperationMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_operations_b5f0912bfbd4b982, []int{1}
}
...
func init() {
	proto.RegisterFile("google/cloud/dataproc/v1beta2/operations.proto", fileDescriptor_operations_b5f0912bfbd4b982)
}

var fileDescriptor_operations_b5f0912bfbd4b982 = []byte{

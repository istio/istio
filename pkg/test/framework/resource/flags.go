...
func init() {
	...
	flag.BoolVar(&settingsFromCommandLine.WDSMetadata, "istio.test.wds_metadata", settingsFromCommandLine.WDSMetadata,
		"Force the use of WDS fallback for metadata exchange")

...
var (
	...
	requestWithErrorCount = prometheus.NewCounter(prometheus.CounterOpts{
		Namespace: "mixer",
		Subsystem: "dispatcher",
		Name:      "request_with_error_count",
		Help:      "Number of requests that had errors during handling.",
	})
...
func init() {
	...
	prometheus.MustRegister(requestWithErrorCount)

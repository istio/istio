...
type Service struct {
	...
	// The presence of the opaque_service field indicates this service is an "Opaque Service".
	// This means that the service is not associated with any Workloads, and should instead be reached
	// directly by its address/hostname.
	// This field serves both to indicate that this is an "Opaque Service", as well as how to connect to
	// it; typical services do not need these properties as they are expressed on the workloads themselves.
	// TODO: support this field
	OpaqueEndpoint *OpaqueEndpoint `protobuf:"bytes,7,opt,name=opaque_endpoint,json=opaqueEndpoint,proto3" json:"opaque_endpoint,omitempty"`
}
...
func (x *Service) GetOpaqueEndpoint() *OpaqueEndpoint {
	if x != nil {
		return x.OpaqueEndpoint
	}
	return nil
}
...
type OpaqueEndpoint struct {
	...
	// Tunneling protocol to use when connecting to the service, if any.
	TunnelProtocol TunnelProtocol `protobuf:"varint,1,opt,name=tunnel_protocol,json=tunnelProtocol,proto3,enum=istio.workload.TunnelProtocol" json:"tunnel_protocol,omitempty"`
}

func (x *OpaqueEndpoint) Reset() {
	*x = OpaqueEndpoint{}
	if protoimpl.UnsafeEnabled {
...
func (x *OpaqueEndpoint) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OpaqueEndpoint) ProtoMessage() {}

func (x *OpaqueEndpoint) ProtoReflect() protoreflect.Message {
	mi := &file_workloadapi_workload_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OpaqueEndpoint.ProtoReflect.Descriptor instead.
func (*OpaqueEndpoint) Descriptor() ([]byte, []int) {
	return file_workloadapi_workload_proto_rawDescGZIP(), []int{2}
}

func (x *OpaqueEndpoint) GetTunnelProtocol() TunnelProtocol {
	if x != nil {
...
type Workload struct {
	...
	// The key is a NetworkAddress string of the format network/IP, or just an IP if network
	// of the service desired matches the network of the workload.
	// TODO: add support for network-prefixed IPs so services can select workloads in another network
...
var file_workloadapi_workload_proto_rawDesc = []byte{
	...
	0x76, 0x69, 0x63, 0x65, 0x42, 0x06, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0xb6, 0x02, 0x0a,
	...
	,
	...
	0x6f, 0x72, 0x6b, 0x12, 0x47, 0x0a, 0x0f, 0x74, 0x75, 0x6e, 0x6e, 0x65, 0x6c, 0x5f, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1e, 0x2e, 0x69,
	0x73, 0x74, 0x69, 0x6f, 0x2e, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x2e, 0x54, 0x75,
	0x6e, 0x6e, 0x65, 0x6c, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x52, 0x0e, 0x74, 0x75,
	0x6e, 0x6e, 0x65, 0x6c, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x12, 0x21, 0x0a, 0x0c,
	0x74, 0x72, 0x75, 0x73, 0x74, 0x5f, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x18, 0x06, 0x20, 0x01,
	...
	,
	...
	,
	...
	0x0a, 0x0a, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x12, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x09, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x49, 0x64, 0x1a, 0x57, 0x0a,
	0x0f, 0x56, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x49, 0x70, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79,
	...
	,
	...
	,
	...
	0x72, 0x65, 0x73, 0x73, 0x22, 0x4e, 0x0a, 0x12, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63,
	0x65, 0x64, 0x48, 0x6f, 0x73, 0x74, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x6e, 0x61,
	0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6e,
	0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x68, 0x6f, 0x73, 0x74,
	0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x68, 0x6f, 0x73, 0x74,
	0x6e, 0x61, 0x6d, 0x65, 0x2a, 0x2c, 0x0a, 0x0e, 0x57, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64,
	...
	,
}
...
var file_workloadapi_workload_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_workloadapi_workload_proto_goTypes = []interface{}{
	...
	(*OpaqueEndpoint)(nil),     // 5: istio.workload.OpaqueEndpoint
	(*Workload)(nil),           // 6: istio.workload.Workload
	(*PortList)(nil),           // 7: istio.workload.PortList
	(*Port)(nil),               // 8: istio.workload.Port
	(*GatewayAddress)(nil),     // 9: istio.workload.GatewayAddress
	(*NetworkAddress)(nil),     // 10: istio.workload.NetworkAddress
	(*NamespacedHostname)(nil), // 11: istio.workload.NamespacedHostname
	nil,                        // 12: istio.workload.Workload.VirtualIpsEntry
}
var file_workloadapi_workload_proto_depIdxs = []int32{
	6,  // 0: istio.workload.Address.workload:type_name -> istio.workload.Workload
	4,  // 1: istio.workload.Address.service:type_name -> istio.workload.Service
	10, // 2: istio.workload.Service.addresses:type_name -> istio.workload.NetworkAddress
	8,  // 3: istio.workload.Service.ports:type_name -> istio.workload.Port
	5,  // 4: istio.workload.Service.opaque_endpoint:type_name -> istio.workload.OpaqueEndpoint
	2,  // 5: istio.workload.OpaqueEndpoint.tunnel_protocol:type_name -> istio.workload.TunnelProtocol
	2,  // 6: istio.workload.Workload.tunnel_protocol:type_name -> istio.workload.TunnelProtocol
	9,  // 7: istio.workload.Workload.waypoint:type_name -> istio.workload.GatewayAddress
	9,  // 8: istio.workload.Workload.network_gateway:type_name -> istio.workload.GatewayAddress
	1,  // 9: istio.workload.Workload.workload_type:type_name -> istio.workload.WorkloadType
	12, // 10: istio.workload.Workload.virtual_ips:type_name -> istio.workload.Workload.VirtualIpsEntry
	0,  // 11: istio.workload.Workload.status:type_name -> istio.workload.WorkloadStatus
	8,  // 12: istio.workload.PortList.ports:type_name -> istio.workload.Port
	11, // 13: istio.workload.GatewayAddress.hostname:type_name -> istio.workload.NamespacedHostname
	10, // 14: istio.workload.GatewayAddress.address:type_name -> istio.workload.NetworkAddress
	7,  // 15: istio.workload.Workload.VirtualIpsEntry.value:type_name -> istio.workload.PortList
...
func file_workloadapi_workload_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_workloadapi_workload_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
	...
	file_workloadapi_workload_proto_msgTypes[6].OneofWrappers = []interface{}{

...
import (
	...
	"istio.io/istio/mixer/adapter/circonus/cmd/server"
)
...
func GetCmd(_ []string) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "circonus",
		Short: "Istio circonus out of process adapter.",
...
func runServer(args *Args) {
	s, err := server.NewCirconusNoSessionServer(args.AdapterPort, args.APIWorkerPoolSize, args.Cert)
	if err != nil {

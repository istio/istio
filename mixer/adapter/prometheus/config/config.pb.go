...
func (Params_MetricInfo_Kind) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_config_f5dac97247346f1b, []int{0, 0, 0}
}
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_f5dac97247346f1b, []int{0}
}
...
func (*Params_MetricInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_f5dac97247346f1b, []int{0, 0}
}
...
func (dst *Params_MetricInfo_BucketsDefinition) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Params_MetricInfo_BucketsDefinition.Merge(dst, src)
}
...
func (*Params_MetricInfo_BucketsDefinition_Linear) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_f5dac97247346f1b, []int{0, 0, 0, 0}
}
...
func (dst *Params_MetricInfo_BucketsDefinition_Linear) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Params_MetricInfo_BucketsDefinition_Linear.Merge(dst, src)
}
...
func (*Params_MetricInfo_BucketsDefinition_Exponential) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_f5dac97247346f1b, []int{0, 0, 0, 1}
}
...
func (dst *Params_MetricInfo_BucketsDefinition_Exponential) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Params_MetricInfo_BucketsDefinition_Exponential.Merge(dst, src)
}
...
func (*Params_MetricInfo_BucketsDefinition_Explicit) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_f5dac97247346f1b, []int{0, 0, 0, 2}
}
...
func (dst *Params_MetricInfo_BucketsDefinition_Explicit) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Params_MetricInfo_BucketsDefinition_Explicit.Merge(dst, src)
}
...
func (*Params_MetricsExpirationPolicy) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_f5dac97247346f1b, []int{0, 1}
}
...
func (dst *Params_MetricsExpirationPolicy) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Params_MetricsExpirationPolicy.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("mixer/adapter/prometheus/config/config.proto", fileDescriptor_config_f5dac97247346f1b)
}

var fileDescriptor_config_f5dac97247346f1b = []byte{

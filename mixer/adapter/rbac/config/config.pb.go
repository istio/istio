...
type Params struct {
	...
	CacheDuration time.Duration `protobuf:"bytes,2,opt,name=cache_duration,json=cacheDuration,proto3,stdduration" json:"cache_duration"`
}

func (m *Params) Reset()      { *m = Params{} }
func (*Params) ProtoMessage() {}
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_a40d0bab7f74e8f0, []int{0}
}
...
func init() {
	proto.RegisterFile("mixer/adapter/rbac/config/config.proto", fileDescriptor_a40d0bab7f74e8f0)
}

var fileDescriptor_a40d0bab7f74e8f0 = []byte{
	...
	0xf1, 0x82, 0xb5, 0xc2, 0x25, 0x1c, 0x4e, 0x3c, 0x94, 0x63, 0xb8, 0xf0, 0x50, 0x8e, 0xe1, 0xc6,
	...
	0xc7, 0x10, 0xc5, 0x06, 0x71, 0x55, 0x12, 0x1b, 0xd8, 0x36, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff,
	0xff, 0xea, 0xe0, 0x03, 0x79, 0x3d, 0x01, 0x00, 0x00,
}
...
func (m *Params) MarshalTo(dAtA []byte) (int, error) {
	...
	n1, err1 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.CacheDuration, dAtA[i:])
	if err1 != nil {
		return 0, err1
	}
	i += n1
...
func (this *Params) String() string {
	...
	s := strings.Join([]string{`&Params{`,
		...
		`CacheDuration:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.CacheDuration), "Duration", "types.Duration", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}

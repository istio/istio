...
type MeshConfig struct {
	...
	// Whether the JWKSResolver should use the default RootCA bundle (defaults to true)
	AuthnJwksUseDefaultRootCa bool `protobuf:"varint,42,opt,name=authn_jwks_use_default_root_ca,json=authnJwksUseDefaultRootCa,proto3" json:"authn_jwks_use_default_root_ca,omitempty"`
	// Specify certificates of trusted CAs for JWKS retrieval here, in PEM format
	AuthnJwksCustomRootCa string   `protobuf:"bytes,43,opt,name=authn_jwks_custom_root_ca,json=authnJwksCustomRootCa,proto3" json:"authn_jwks_custom_root_ca,omitempty"`
...
func (m *MeshConfig) GetAuthnJwksUseDefaultRootCa() bool {
	if m != nil {
		return m.AuthnJwksUseDefaultRootCa
	}
	return false
}

func (m *MeshConfig) GetAuthnJwksCustomRootCa() string {
	if m != nil {
		return m.AuthnJwksCustomRootCa
	}
	return ""
}
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AuthnJwksUseDefaultRootCa {
		dAtA[i] = 0xd0
		i++
		dAtA[i] = 0x2
		i++
	...
	if len(m.AuthnJwksCustomRootCa) > 0 {
		dAtA[i] = 0xda
		i++
		dAtA[i] = 0x2
		i++
		i = encodeVarintConfig(dAtA, i, uint64(len(m.AuthnJwksCustomRootCa)))
		i += copy(dAtA[i:], m.AuthnJwksCustomRootCa)
	}
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 42:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AuthnJwksUseDefaultRootCa", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AuthnJwksUseDefaultRootCa = bool(v != 0)
		case 43:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AuthnJwksCustomRootCa", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AuthnJwksCustomRootCa = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex

...
# export TARGET_OUT_LINUX="${TARGET_OUT_LINUX:-$(pwd)/out/${TARGET_OS}_${TARGET_ARCH}}"
...
# export CONTAINER_TARGET_OUT_LINUX="${CONTAINER_TARGET_OUT_LINUX:-/work/out/${TARGET_OS}_${TARGET_ARCH}}"

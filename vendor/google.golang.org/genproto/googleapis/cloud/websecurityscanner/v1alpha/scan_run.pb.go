...
func (ScanRun_ExecutionState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_scan_run_902013285666484a, []int{0, 0}
}
...
func (ScanRun_ResultState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_scan_run_902013285666484a, []int{0, 1}
}
...
func (*ScanRun) Descriptor() ([]byte, []int) {
	return fileDescriptor_scan_run_902013285666484a, []int{0}
}
...
func init() {
	proto.RegisterFile("google/cloud/websecurityscanner/v1alpha/scan_run.proto", fileDescriptor_scan_run_902013285666484a)
}

var fileDescriptor_scan_run_902013285666484a = []byte{

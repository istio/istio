...
const (
	AppProtocol_UNKNOWN AppProtocol = 0
...
const (
	...
	TunnelProtocol_LEGACY_ISTIO_MTLS TunnelProtocol = 2 // Future options may include things like QUIC/HTTP3, etc.
)
...
type Port struct {
	...
	AppProtocol   AppProtocol `protobuf:"varint,3,opt,name=app_protocol,json=appProtocol,proto3,enum=istio.workload.AppProtocol" json:"app_protocol,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Port) GetAppProtocol() AppProtocol {
	if x != nil {
		return x.AppProtocol
	}
	return AppProtocol_UNKNOWN
}
...
const file_workloadapi_workload_proto_rawDesc = "" +
	...
	"\bPortList\x12*\n" +
	"\x05ports\x18\x01 \x03(\v2\x14.istio.workload.PortR\x05ports\"\x8a\x01\n" +
	"\x04Port\x12!\n" +
	"\fservice_port\x18\x01 \x01(\rR\vservicePort\x12\x1f\n" +
	"\vtarget_port\x18\x02 \x01(\rR\n" +
	"targetPort\x12>\n" +
	"\fapp_protocol\x18\x03 \x01(\x0e2\x1b.istio.workload.AppProtocolR\vappProtocol\"\x90\x01\n" +
...
var file_workloadapi_workload_proto_depIdxs = []int32{
	...
	18, // 16: istio.workload.Workload.application_tunnel:type_name -> istio.workload.ApplicationTunnel
	...
	15, // 19: istio.workload.Workload.locality:type_name -> istio.workload.Locality
	...
	17, // 23: istio.workload.PortList.ports:type_name -> istio.workload.Port
	4,  // 24: istio.workload.Port.app_protocol:type_name -> istio.workload.AppProtocol
	10, // 25: istio.workload.ApplicationTunnel.protocol:type_name -> istio.workload.ApplicationTunnel.Protocol
	...
	16, // 29: istio.workload.Workload.ServicesEntry.value:type_name -> istio.workload.PortList

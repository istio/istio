...
type EnvoyFilter struct {
	...
	// $hide_from_docs
	// Criteria used to select the specific set of pods/VMs
	// on which this EnvoyFilter configuration should be applied. Precisely
	// one of workloadLabels or workloadSelector must be specified.
...
var fileDescriptorEnvoyFilter = []byte{
	...
	,
}

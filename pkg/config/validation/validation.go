		...
		for i, rule := range in.GetRules() {
			...
			for _, from := range rule.From {
				...
				if from.Source == nil {
					...
					errs = appendErrors(errs, security.CheckEmptyOrInvalidRegex("Principals", src.Principals))
					errs = appendErrors(errs, security.CheckEmptyOrInvalidRegex("RequestPrincipals", src.RequestPrincipals))
					errs = appendErrors(errs, security.CheckEmptyOrInvalidRegex("Namespaces", src.Namespaces))
					errs = appendErrors(errs, security.CheckEmptyOrInvalidRegex("IpBlocks", src.IpBlocks))
					errs = appendErrors(errs, security.CheckEmptyOrInvalidRegex("RemoteIpBlocks", src.RemoteIpBlocks))
					errs = appendErrors(errs, security.CheckEmptyOrInvalidRegex("NotPrincipals", src.NotPrincipals))
					errs = appendErrors(errs, security.CheckEmptyOrInvalidRegex("NotRequestPrincipals", src.NotRequestPrincipals))
					errs = appendErrors(errs, security.CheckEmptyOrInvalidRegex("NotNamespaces", src.NotNamespaces))
					errs = appendErrors(errs, security.CheckEmptyOrInvalidRegex("NotIpBlocks", src.NotIpBlocks))
					errs = appendErrors(errs, security.CheckEmptyOrInvalidRegex("NotRemoteIpBlocks", src.NotRemoteIpBlocks))
				}
			}
			...
			for _, to := range rule.To {
				...
				if to.Operation == nil {
					...
					errs = appendErrors(errs, security.CheckEmptyOrInvalidRegex("Ports", op.Ports))
					errs = appendErrors(errs, security.CheckEmptyOrInvalidRegex("Methods", op.Methods))
					errs = appendErrors(errs, security.CheckEmptyOrInvalidRegex("Paths", op.Paths))
					errs = appendErrors(errs, security.CheckEmptyOrInvalidRegex("Hosts", op.Hosts))
					errs = appendErrors(errs, security.CheckEmptyOrInvalidRegex("NotPorts", op.NotPorts))
					errs = appendErrors(errs, security.CheckEmptyOrInvalidRegex("NotMethods", op.NotMethods))
					errs = appendErrors(errs, security.CheckEmptyOrInvalidRegex("NotPaths", op.NotPaths))
					errs = appendErrors(errs, security.CheckEmptyOrInvalidRegex("NotHosts", op.NotHosts))
				}
			}

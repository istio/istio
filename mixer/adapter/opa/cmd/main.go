...
import (
	...
	"istio.io/istio/mixer/adapter/opa/cmd/server"
)
...
func GetCmd(_ []string) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "opa",
		Short: "Istio opa out of process adapter.",
...
func runServer(args *Args) {
	s, err := server.NewOpaNoSessionServer(args.AdapterPort, args.APIWorkerPoolSize, args.Cert)
	if err != nil {

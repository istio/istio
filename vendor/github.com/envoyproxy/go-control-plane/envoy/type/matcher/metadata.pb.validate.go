...
// Validate checks the field values on MetadataMatcher_Value with the rules
...
func (m *MetadataMatcher_Value) Validate() error {
	...
	case *MetadataMatcher_Value_NullMatch_:
		...
		if v, ok := interface{}(m.GetNullMatch()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return MetadataMatcher_ValueValidationError{
					Field:  "NullMatch",
					Reason: "embedded message failed validation",
					Cause:  err,
				}
...
// MetadataMatcher_ValueValidationError is the validation error returned by
// MetadataMatcher_Value.Validate if the designated constraints aren't met.
...
func (e MetadataMatcher_ValueValidationError) Error() string {
	...
	return fmt.Sprintf(
		"invalid %sMetadataMatcher_Value.%s: %s%s",
		key,
		e.Field,
		e.Reason,
		cause)
...
var _ error = MetadataMatcher_ValueValidationError{}

// Validate checks the field values on MetadataMatcher_Value_NullMatch with the
// rules defined in the proto definition for this message. If any rules are
// violated, an error is returned.
...
// MetadataMatcher_Value_NullMatchValidationError is the validation error
// returned by MetadataMatcher_Value_NullMatch.Validate if the designated
...
func (e MetadataMatcher_Value_NullMatchValidationError) Error() string {
	...
	return fmt.Sprintf(
		"invalid %sMetadataMatcher_Value_NullMatch.%s: %s%s",
		key,
		e.Field,
		e.Reason,
		cause)
...
var _ error = MetadataMatcher_Value_NullMatchValidationError{}

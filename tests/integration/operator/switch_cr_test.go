...
func TestController(t *testing.T) {
	framework.
		...
		Run(func(t framework.TestContext) {
			...
			installWithCRFile(t, cs, istioCtl, "demo", "")
			...
			installWithCRFile(t, cs, istioCtl, "default", "v2")
			installWithCRFile(t, cs, istioCtl, "default", "")
...
func installWithCRFile(t framework.TestContext, cs cluster.Cluster,
...
`
	...
	verifyInstallation(t, istioCtl, profileName, revision, cs)
}
...
func verifyInstallation(t framework.TestContext,
	...
	sanitycheck.RunTrafficTest(t, false)

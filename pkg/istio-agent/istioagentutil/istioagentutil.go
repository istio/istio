...
var (
	...
	// CacheDefaultRootCertFilePath is the well-known path for an existing root certificate file
	CacheDefaultRootCertFilePath = "./etc/certs/root-cert.pem"
)

func NewIstiodCAClient(pilotCertProvider, caEndpoint, clusterID string, tlsEnabled, isRotate bool) (caClientInterface.Client, []byte, error) {

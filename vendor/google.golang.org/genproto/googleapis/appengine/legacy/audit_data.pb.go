...
func (*AuditData) Descriptor() ([]byte, []int) {
	return fileDescriptor_audit_data_3c156138bff33477, []int{0}
}
...
func init() {
	proto.RegisterFile("google/appengine/legacy/audit_data.proto", fileDescriptor_audit_data_3c156138bff33477)
}

var fileDescriptor_audit_data_3c156138bff33477 = []byte{

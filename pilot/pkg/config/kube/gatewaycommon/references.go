...
func (s ReferenceSet) LocalPolicyTargetRef(ctx krt.HandlerContext, ref gateway.LocalPolicyTargetReference, localNamespace string) (any, error) {
...
func (s ReferenceSet) LocalPolicyRef(ctx krt.HandlerContext, ref gateway.LocalObjectReference, localNamespace string) (any, error) {
	return s.internal(ctx, string(ref.Name), string(ref.Group), string(ref.Kind), localNamespace)
}

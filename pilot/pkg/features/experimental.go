...
var (
	...
	EnableGatewayAPIInfrastructureStandardAttributeStrategy = env.Register("PILOT_ENABLE_GATEWAY_API_INFRASTRUCTURE_STANDARD_ATTRIBUTE_STRATEGY", false,
		"If this is set to true, istiod will not copy any attributes from the Gateway resource onto its related Deployment resources.").Get()

...
_TRACER = _descriptor.EnumDescriptor(
  ...
  containing_type=None,
  serialized_options=None,
  serialized_start=29419,
  serialized_end=29484,
)
...
_KIALIDASHBOARDCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='jaegerInClusterURL', full_name='v1alpha1.KialiDashboardConfig.jaegerInClusterURL', index=6,
      number=8, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='auth', full_name='v1alpha1.KialiDashboardConfig.auth', index=7,
      number=7, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_VALUES = _descriptor.Descriptor(
  ...
  serialized_start=28133,
  serialized_end=29090,
)

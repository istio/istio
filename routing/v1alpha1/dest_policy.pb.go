...
/*
Package istio_routing_v1alpha1_config is a generated protocol buffer package.
...
type LoadBalancing_Name struct {
	Name LoadBalancing_SimpleLBPolicy `protobuf:"varint,1,opt,name=name,enum=istio.routing.v1alpha1.config.LoadBalancing_SimpleLBPolicy,oneof"`
}
...
func init() {
	proto.RegisterType((*DestinationPolicy)(nil), "istio.routing.v1alpha1.config.DestinationPolicy")
	proto.RegisterType((*LoadBalancing)(nil), "istio.routing.v1alpha1.config.LoadBalancing")
	proto.RegisterType((*CircuitBreaker)(nil), "istio.routing.v1alpha1.config.CircuitBreaker")
	proto.RegisterType((*CircuitBreaker_SimpleCircuitBreakerPolicy)(nil), "istio.routing.v1alpha1.config.CircuitBreaker.SimpleCircuitBreakerPolicy")
	proto.RegisterEnum("istio.routing.v1alpha1.config.LoadBalancing_SimpleLBPolicy", LoadBalancing_SimpleLBPolicy_name, LoadBalancing_SimpleLBPolicy_value)
}
...
var fileDescriptor0 = []byte{
	...
	,
}

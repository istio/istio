...
func (s *Server) initMonitor(args *bootstrap.PilotArgs) error { //nolint: unparam
	s.AddStartFunc(func(stop <-chan struct{}) error {
...
func (s *Server) initMeshNetworks(args *bootstrap.PilotArgs) error { //nolint: unparam
...
func (s *Server) initMCPConfigController(args *bootstrap.PilotArgs) error {
	clientNodeID := ""
...
func (s *Server) initConfigController(args *bootstrap.PilotArgs) error {
...
func (s *Server) initDiscoveryService(args *bootstrap.PilotArgs, onXDSStart func(model.XDSUpdater)) error {
...
func (s *Server) AddStartFunc(fn bootstrap.StartFunc) {

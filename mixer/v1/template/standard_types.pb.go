...
func (*DNSName) Descriptor() ([]byte, []int) { return fileDescriptorStandardTypes, []int{1} }
...
func (*EmailAddress) Descriptor() ([]byte, []int) { return fileDescriptorStandardTypes, []int{2} }
...
func (*Uri) Descriptor() ([]byte, []int) { return fileDescriptorStandardTypes, []int{3} }
...
func (*Duration) Descriptor() ([]byte, []int) { return fileDescriptorStandardTypes, []int{4} }
...
func (*TimeStamp) Descriptor() ([]byte, []int) { return fileDescriptorStandardTypes, []int{5} }
...
func encodeFixed64StandardTypes(dAtA []byte, offset int, v uint64) int {
	dAtA[offset] = uint8(v)
...
func encodeFixed32StandardTypes(dAtA []byte, offset int, v uint32) int {
	dAtA[offset] = uint8(v)
	dAtA[offset+1] = uint8(v >> 8)
	dAtA[offset+2] = uint8(v >> 16)
	dAtA[offset+3] = uint8(v >> 24)
...
var fileDescriptorStandardTypes = []byte{
	...
	0xe2, 0xe4, 0x62, 0x77, 0xf1, 0x0b, 0xf6, 0x4b, 0xcc, 0x4d, 0x55, 0xe2, 0xe3, 0xe2, 0x71, 0xcd,
	0x4d, 0xcc, 0xcc, 0x81, 0x49, 0xb1, 0x72, 0x31, 0x87, 0x16, 0x65, 0x2a, 0x71, 0x71, 0x71, 0xb8,
	0x94, 0x16, 0x25, 0x96, 0x64, 0xe6, 0xe7, 0x81, 0xb4, 0x86, 0x64, 0xe6, 0xa6, 0x06, 0x97, 0x24,
	0xe6, 0x16, 0x38, 0xe9, 0x5c, 0x78, 0x28, 0xc7, 0x70, 0xe3, 0xa1, 0x1c, 0xc3, 0x87, 0x87, 0x72,
	...
	0x63, 0x39, 0x86, 0x24, 0x36, 0xb0, 0xab, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xc1, 0x21,
	0xfa, 0x22, 0xbf, 0x00, 0x00, 0x00,
}

...
require (
	...
	github.com/envoyproxy/go-control-plane v0.11.2-0.20231012203354-9454891c1279
	...
	istio.io/api v1.19.0-alpha.1.0.20231010223154-f9a5d9345cae
	istio.io/client-go v1.19.0-alpha.1.0.20231007021157-8697a6266e0a
	k8s.io/api v0.28.2

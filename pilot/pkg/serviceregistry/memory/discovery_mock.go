...
var (
	...
	HelloService = MakeServiceWithSA("hello.default.svc.cluster.local", "10.1.0.0", []string{})
	...
	ReplicatedFooServiceV1   = MakeServiceWithSA(ReplicatedFooServiceName, "10.3.0.0", []string{
		"spiffe://cluster.local/ns/default/sa/foo1",
		"spiffe://cluster.local/ns/default/sa/foo-share",
	})
	ReplicatedFooServiceV2 = MakeServiceWithSA(ReplicatedFooServiceName, "10.3.0.1", []string{
	...
	WorldService = MakeServiceWithSA("world.default.svc.cluster.local", "10.2.0.0", []string{

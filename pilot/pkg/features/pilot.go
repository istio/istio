...
var (
	...
	IstiodService = env.RegisterStringVar("ISTIOD_ADDR", "istio-pilot.istio-system.svc:15012",
	...
	//
	// This is primarily used in K8S env, and injected by the install template.

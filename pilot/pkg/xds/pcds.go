...
func (e *PcdsGenerator) Generate(proxy *model.Proxy, push *model.PushContext, w *model.WatchedResource, req *model.PushRequest, delta bool) (model.Resources, model.XdsLogDetails, error) {

...
var knownTypes = map[string]struct {
	...
	model.RouteRuleV1Alpha2.Type: {
		object: &RouteRuleV1Alpha2{
			TypeMeta: meta_v1.TypeMeta{
				Kind:       "RouteRuleV1Alpha2",
				APIVersion: model.IstioAPIGroup + "/" + model.IstioAPIVersion,
			},
		},
		collection: &RouteRuleV1Alpha2List{},
	},
...
// RouteRuleV1Alpha2 is the generic Kubernetes API object wrapper
type RouteRuleV1Alpha2 struct {
	meta_v1.TypeMeta   `json:",inline"`
	meta_v1.ObjectMeta `json:"metadata"`
	Spec               map[string]interface{} `json:"spec"`
}
...
// GetSpec from a wrapper
func (in *RouteRuleV1Alpha2) GetSpec() map[string]interface{} {
	return in.Spec
}

// SetSpec for a wrapper
func (in *RouteRuleV1Alpha2) SetSpec(spec map[string]interface{}) {
	in.Spec = spec
}

// GetObjectMeta from a wrapper
func (in *RouteRuleV1Alpha2) GetObjectMeta() meta_v1.ObjectMeta {
	return in.ObjectMeta
}

// SetObjectMeta for a wrapper
func (in *RouteRuleV1Alpha2) SetObjectMeta(metadata meta_v1.ObjectMeta) {
	in.ObjectMeta = metadata
}

// RouteRuleV1Alpha2List is the generic Kubernetes API list wrapper
type RouteRuleV1Alpha2List struct {
	meta_v1.TypeMeta `json:",inline"`
	meta_v1.ListMeta `json:"metadata"`
	Items            []RouteRuleV1Alpha2 `json:"items"`
}

// GetItems from a wrapper
func (in *RouteRuleV1Alpha2List) GetItems() []IstioObject {
	out := make([]IstioObject, len(in.Items))
	for i := range in.Items {
		out[i] = &in.Items[i]
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RouteRuleV1Alpha2) DeepCopyInto(out *RouteRuleV1Alpha2) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RouteRuleV1Alpha2.
func (in *RouteRuleV1Alpha2) DeepCopy() *RouteRuleV1Alpha2 {
	if in == nil {
		return nil
	}
	out := new(RouteRuleV1Alpha2)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RouteRuleV1Alpha2) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RouteRuleV1Alpha2List) DeepCopyInto(out *RouteRuleV1Alpha2List) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]RouteRuleV1Alpha2, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RouteRuleV1Alpha2List.
func (in *RouteRuleV1Alpha2List) DeepCopy() *RouteRuleV1Alpha2List {
	if in == nil {
		return nil
	}
	out := new(RouteRuleV1Alpha2List)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RouteRuleV1Alpha2List) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}

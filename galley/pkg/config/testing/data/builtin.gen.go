...
var _builtinGetGo = []byte(`// Copyright 2019 Istio Authors
//
...
func builtinGetGoBytes() ([]byte, error) {
	return _builtinGetGo, nil
}

func builtinGetGo() (*asset, error) {
	bytes, err := builtinGetGoBytes()
	if err != nil {
		return nil, err
	}

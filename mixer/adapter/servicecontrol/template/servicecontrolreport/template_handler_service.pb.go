...
type InstanceMsg struct {
	...
	RequestTime     *istio_mixer_adapter_model_v1beta12.TimeStamp `protobuf:"bytes,6,opt,name=request_time,json=requestTime" json:"request_time,omitempty"`
	...
	ResponseTime    *istio_mixer_adapter_model_v1beta12.TimeStamp `protobuf:"bytes,10,opt,name=response_time,json=responseTime" json:"response_time,omitempty"`
	...
	ResponseLatency *istio_mixer_adapter_model_v1beta12.Duration  `protobuf:"bytes,13,opt,name=response_latency,json=responseLatency" json:"response_latency,omitempty"`
}
...
func (this *InstanceMsg) String() string {
	...
	s := strings.Join([]string{`&InstanceMsg{`,
		...
		`RequestTime:` + strings.Replace(fmt.Sprintf("%v", this.RequestTime), "TimeStamp", "istio_mixer_adapter_model_v1beta12.TimeStamp", 1) + `,`,
		...
		`ResponseTime:` + strings.Replace(fmt.Sprintf("%v", this.ResponseTime), "TimeStamp", "istio_mixer_adapter_model_v1beta12.TimeStamp", 1) + `,`,
		`ResponseCode:` + fmt.Sprintf("%v", this.ResponseCode) + `,`,
		`ResponseBytes:` + fmt.Sprintf("%v", this.ResponseBytes) + `,`,
		`ResponseLatency:` + strings.Replace(fmt.Sprintf("%v", this.ResponseLatency), "Duration", "istio_mixer_adapter_model_v1beta12.Duration", 1) + `,`,
...
func (m *InstanceMsg) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if m.RequestTime == nil {
				m.RequestTime = &istio_mixer_adapter_model_v1beta12.TimeStamp{}
			}
		...
		case 10:
			...
			if m.ResponseTime == nil {
				m.ResponseTime = &istio_mixer_adapter_model_v1beta12.TimeStamp{}
			}
		...
		case 13:
			...
			if m.ResponseLatency == nil {
				m.ResponseLatency = &istio_mixer_adapter_model_v1beta12.Duration{}
			}
...
var fileDescriptorTemplateHandlerService = []byte{
	...
	,
}

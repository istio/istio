...
type AccessLogging int32

const (
	// No Logs.
	AccessLogging_NONE AccessLogging = 0
	// All logs including both success and error logs.
	AccessLogging_FULL AccessLogging = 1
	...
	// response_flag != "-"`
	AccessLogging_ERRORS_ONLY AccessLogging = 2
)

var AccessLogging_name = map[int32]string{
	0: "NONE",
	1: "FULL",
	2: "ERRORS_ONLY",
}

var AccessLogging_value = map[string]int32{
	"NONE":        0,
	"FULL":        1,
	"ERRORS_ONLY": 2,
}
...
func (x AccessLogging) String() string {
	return proto.EnumName(AccessLogging_name, int32(x))
}

func (AccessLogging) EnumDescriptor() ([]byte, []int) {
...
type TelemetryV2StackDriverConfig struct {
	...
	OutboundAccessLogging AccessLogging           `protobuf:"varint,7,opt,name=outboundAccessLogging,proto3,enum=v1alpha1.AccessLogging" json:"outboundAccessLogging,omitempty"`
	InboundAccessLogging  AccessLogging           `protobuf:"varint,8,opt,name=inboundAccessLogging,proto3,enum=v1alpha1.AccessLogging" json:"inboundAccessLogging,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}                `json:"-"`
	XXX_unrecognized      []byte                  `json:"-"`
	XXX_sizecache         int32                   `json:"-"`
}
...
func (m *TelemetryV2StackDriverConfig) GetOutboundAccessLogging() AccessLogging {
	if m != nil {
		return m.OutboundAccessLogging
	}
	return AccessLogging_NONE
}

func (m *TelemetryV2StackDriverConfig) GetInboundAccessLogging() AccessLogging {
	if m != nil {
...
func init() {
	...
	proto.RegisterEnum("v1alpha1.AccessLogging", AccessLogging_name, AccessLogging_value)
...
var fileDescriptor_261260e22432516f = []byte{
	...
	,
}

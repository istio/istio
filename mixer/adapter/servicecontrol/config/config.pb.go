...
type RuntimeConfig struct {
	...
	CheckResultExpiration *types.Duration `protobuf:"bytes,2,opt,name=check_result_expiration,json=checkResultExpiration" json:"check_result_expiration,omitempty"`
...
func (*RuntimeConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_49f0630bff645803, []int{0}
}
...
type Quota struct {
	...
	Expiration           *types.Duration `protobuf:"bytes,3,opt,name=expiration" json:"expiration,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (*Quota) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_49f0630bff645803, []int{1}
}
...
func (*GcpServiceSetting) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_49f0630bff645803, []int{2}
}
func (m *GcpServiceSetting) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GcpServiceSetting) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GcpServiceSetting.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *GcpServiceSetting) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GcpServiceSetting.Merge(dst, src)
}
func (m *GcpServiceSetting) XXX_Size() int {
	return m.Size()
}
func (m *GcpServiceSetting) XXX_DiscardUnknown() {
	xxx_messageInfo_GcpServiceSetting.DiscardUnknown(m)
}

var xxx_messageInfo_GcpServiceSetting proto.InternalMessageInfo
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_49f0630bff645803, []int{3}
}
...
func (this *RuntimeConfig) String() string {
	...
	s := strings.Join([]string{`&RuntimeConfig{`,
		...
		`CheckResultExpiration:` + strings.Replace(fmt.Sprintf("%v", this.CheckResultExpiration), "Duration", "types.Duration", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *Quota) String() string {
	...
	s := strings.Join([]string{`&Quota{`,
		...
		`Expiration:` + strings.Replace(fmt.Sprintf("%v", this.Expiration), "Duration", "types.Duration", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *RuntimeConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.CheckResultExpiration == nil {
				m.CheckResultExpiration = &types.Duration{}
			}
...
func init() {
	proto.RegisterFile("mixer/adapter/servicecontrol/config/config.proto", fileDescriptor_config_49f0630bff645803)
}

var fileDescriptor_config_49f0630bff645803 = []byte{

...
func (s *DiscoveryServer) pushDeltaXds(con *Connection,
	...
	switch {
	case !req.Full && w.TypeUrl != v3.WorkloadType && w.TypeUrl != v3.RBACType:
...
func requiresResourceNamesModification(url string) bool {
	return url == v3.WorkloadType || url == v3.RBACType
}

func isWildcardResource(w *model.WatchedResource) bool {
	if w.TypeUrl == v3.WorkloadType || w.TypeUrl == v3.RBACType {
		// Both are supported
		return w.Wildcard
	}

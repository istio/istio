...
func (Params_QuotaAlgorithm) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_config_510d19eea46b110a, []int{0, 0}
}
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_510d19eea46b110a, []int{0}
}
...
func (dst *Params_Override) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Params_Override.Merge(dst, src)
}
...
func (*Params_Quota) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_510d19eea46b110a, []int{0, 1}
}
...
func (dst *Params_Quota) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Params_Quota.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("mixer/adapter/redisquota/config/config.proto", fileDescriptor_config_510d19eea46b110a)
}

var fileDescriptor_config_510d19eea46b110a = []byte{

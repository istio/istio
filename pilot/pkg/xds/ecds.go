...
// parseSecretName parses secret resource name from WASM extension env variable.
// Secret resource names are generated by the credentials.ToResourceName function.

...
func (dst *LocationExtensionTargetingCriterionFieldEnum) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LocationExtensionTargetingCriterionFieldEnum.Merge(dst, src)
}

...
func TestAggregateStoreBasicMake(t *testing.T) {
	...
	schema1 := collections.K8SGatewayApiV1Beta1Gateways
...
func TestAggregateStoreList(t *testing.T) {
	...
	store1 := memory.Make(collection.SchemasFor(collections.K8SGatewayApiV1Beta1Gateways))
	store2 := memory.Make(collection.SchemasFor(collections.K8SGatewayApiV1Beta1Gateways))

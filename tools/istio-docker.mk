...
docker.app_sidecar_xenial: pkg/test/echo/docker/echo-start.sh
docker.app_sidecar_xenial: $(ISTIO_OUT_LINUX)/client
docker.app_sidecar_xenial: $(ISTIO_OUT_LINUX)/server
docker.app_sidecar_xenial: pkg/test/echo/docker/Dockerfile.app_sidecar
	$(DOCKER_RULE)
...
docker.app_sidecar_bionic: pkg/test/echo/docker/echo-start.sh
docker.app_sidecar_bionic: $(ISTIO_OUT_LINUX)/client
docker.app_sidecar_bionic: $(ISTIO_OUT_LINUX)/server
docker.app_sidecar_bionic: pkg/test/echo/docker/Dockerfile.app_sidecar
	$(DOCKER_RULE)
...
docker.app_sidecar_focal: pkg/test/echo/docker/echo-start.sh
docker.app_sidecar_focal: $(ISTIO_OUT_LINUX)/client
docker.app_sidecar_focal: $(ISTIO_OUT_LINUX)/server
docker.app_sidecar_focal: pkg/test/echo/docker/Dockerfile.app_sidecar
	$(DOCKER_RULE)
...
docker.app_sidecar_debian9: pkg/test/echo/docker/echo-start.sh
docker.app_sidecar_debian9: $(ISTIO_OUT_LINUX)/client
docker.app_sidecar_debian9: $(ISTIO_OUT_LINUX)/server
docker.app_sidecar_debian9: pkg/test/echo/docker/Dockerfile.app_sidecar
	$(DOCKER_RULE)
...
docker.app_sidecar_debian10: pkg/test/echo/docker/echo-start.sh
docker.app_sidecar_debian10: $(ISTIO_OUT_LINUX)/client
docker.app_sidecar_debian10: $(ISTIO_OUT_LINUX)/server
docker.app_sidecar_debian10: pkg/test/echo/docker/Dockerfile.app_sidecar
	$(DOCKER_RULE)

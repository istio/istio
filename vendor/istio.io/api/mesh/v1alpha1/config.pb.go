...
type MeshConfig struct {
	...
	// Use mesh_traffic_server_cert_paths instead of SDS if set to empty.
	...
	// The cert files to use when configuring Envoy listeners for mesh traffic.
	// Used only when sds_uds_path is not set.
	// If not set these defaults will be used:
	//  cert_chain = '/etc/certs/cert-chain.pem'
	//  key = '/etc/certs/key.pem'
	//  root_cert = '/etc/certs/root-cert.pem'
	MeshTrafficServerCertPaths *ServerCertPaths `protobuf:"bytes,36,opt,name=mesh_traffic_server_cert_paths,json=meshTrafficServerCertPaths" json:"mesh_traffic_server_cert_paths,omitempty"`
}
...
func (m *MeshConfig) GetMeshTrafficServerCertPaths() *ServerCertPaths {
	if m != nil {
		return m.MeshTrafficServerCertPaths
	}
	return nil
}
...
// Defines absolute file paths for certs + key used by a TLS server
...
func (m *ServerCertPaths) Reset()                    { *m = ServerCertPaths{} }
func (m *ServerCertPaths) String() string            { return proto.CompactTextString(m) }
func (*ServerCertPaths) ProtoMessage()               {}
func (*ServerCertPaths) Descriptor() ([]byte, []int) { return fileDescriptorConfig, []int{3} }

func (m *ServerCertPaths) GetCertChain() string {
	if m != nil {
		return m.CertChain
	}
	return ""
...
func (m *ServerCertPaths) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func (m *ServerCertPaths) GetRootCert() string {
	if m != nil {
		return m.RootCert
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*ServerCertPaths)(nil), "istio.mesh.v1alpha1.ServerCertPaths")
...
func (m *MeshConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MeshTrafficServerCertPaths != nil {
		dAtA[i] = 0xa2
		i++
		dAtA[i] = 0x2
		i++
		i = encodeVarintConfig(dAtA, i, uint64(m.MeshTrafficServerCertPaths.Size()))
		n8, err := m.MeshTrafficServerCertPaths.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
func (m *ServerCertPaths) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ServerCertPaths) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.RootCert) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintConfig(dAtA, i, uint64(len(m.RootCert)))
...
func (m *MeshConfig) Size() (n int) {
	...
	if m.MeshTrafficServerCertPaths != nil {
		l = m.MeshTrafficServerCertPaths.Size()
		n += 2 + l + sovConfig(uint64(l))
	}
	return n
}
...
func (m *ServerCertPaths) Size() (n int) {
	var l int
	_ = l
	l = len(m.CertChain)
	if l > 0 {
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 36:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MeshTrafficServerCertPaths", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.MeshTrafficServerCertPaths == nil {
				m.MeshTrafficServerCertPaths = &ServerCertPaths{}
			}
			if err := m.MeshTrafficServerCertPaths.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ServerCertPaths) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ServerCertPaths: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ServerCertPaths: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorConfig = []byte{
	...
	,
}

...
// DeleteControlPlaneByManifests removed resources by manifests and revision of control plane,
func (h *HelmReconciler) DeleteControlPlaneByManifests(manifests, revision string) error {
	labels := map[string]string{
		label.IstioRev:   revision,

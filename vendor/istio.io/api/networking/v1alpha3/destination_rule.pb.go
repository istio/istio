...
type DestinationRule struct {
	...
	// %SERVICE_FQDN%_%SERVICE_PORT% will use reviews.prod.svc.cluster.local_7443 as the stats name.
	// %SERVICE% will use reviews.prod as the stats name.
	OutboundStatName     string   `protobuf:"bytes,6,opt,name=outbound_stat_name,json=outboundStatName,proto3" json:"outbound_stat_name,omitempty"`
...
func (m *DestinationRule) GetInboundStatName() string {
	if m != nil {
		return m.InboundStatName
	}
	return ""
}

func (m *DestinationRule) GetOutboundStatName() string {
	if m != nil {
		return m.OutboundStatName
	}
	return ""
}
...
var fileDescriptor_12899beb695152c8 = []byte{
	...
	,
}
...
func (m *DestinationRule) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OutboundStatName) > 0 {
		i -= len(m.OutboundStatName)
		copy(dAtA[i:], m.OutboundStatName)
		i = encodeVarintDestinationRule(dAtA, i, uint64(len(m.OutboundStatName)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.InboundStatName) > 0 {
		i -= len(m.InboundStatName)
		copy(dAtA[i:], m.InboundStatName)
		i = encodeVarintDestinationRule(dAtA, i, uint64(len(m.InboundStatName)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.ExportTo) > 0 {
...
func (m *DestinationRule) Size() (n int) {
	...
	l = len(m.InboundStatName)
	if l > 0 {
		n += 1 + l + sovDestinationRule(uint64(l))
	}
	l = len(m.OutboundStatName)
	if l > 0 {
		n += 1 + l + sovDestinationRule(uint64(l))
	}
	if m.XXX_unrecognized != nil {
...
func (m *DestinationRule) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InboundStatName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.InboundStatName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OutboundStatName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OutboundStatName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex

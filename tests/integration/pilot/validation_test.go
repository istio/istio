	...
	framework.NewTest(t).
		Run(func(t framework.TestContext) {
			...
			for _, gvk := range []string{
				...
				"gateway.networking.k8s.io/v1beta1/HTTPRoute",
				"gateway.networking.k8s.io/v1beta1alpha2/TCPRoute",
				"gateway.networking.k8s.io/v1beta1alpha2/TLSRoute",
				"gateway.networking.k8s.io/v1beta1/ReferenceGrant",
				"gateway.networking.k8s.io/v1beta1alpha2/ReferenceGrant",
			} {

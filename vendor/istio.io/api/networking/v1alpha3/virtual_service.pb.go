...
type L4MatchAttributes struct {
	...
	DestinationSubnet []string `protobuf:"bytes,1,rep,name=destination_subnet,json=destinationSubnet" json:"destination_subnet,omitempty"`
...
func (m *L4MatchAttributes) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.DestinationSubnet) > 0 {
		for _, s := range m.DestinationSubnet {
			dAtA[i] = 0xa
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (m *L4MatchAttributes) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.DestinationSubnet = append(m.DestinationSubnet, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Port", wireType)
...
var fileDescriptorVirtualService = []byte{
	...
	,
}

...
// dataset/extensions/v1beta1/ingress_merge.yaml
// dataset/extensions/v1beta1/ingress_merge_1.yaml
// dataset/extensions/v1beta1/ingress_merge_expected.json
// dataset/extensions/v1beta1/ingress_merge_expected_1.json
// dataset/extensions/v1beta1/ingress_merge_meshconfig.yaml
...
var _datasetExtensionsV1beta1Ingress_mergeYaml = []byte(`apiVersion: extensions/v1beta1
kind: Ingress
metadata:
  name: foo
  namespace: ns
...
func datasetExtensionsV1beta1Ingress_mergeYamlBytes() ([]byte, error) {
	return _datasetExtensionsV1beta1Ingress_mergeYaml, nil
}

func datasetExtensionsV1beta1Ingress_mergeYaml() (*asset, error) {
	bytes, err := datasetExtensionsV1beta1Ingress_mergeYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "dataset/extensions/v1beta1/ingress_merge.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _datasetExtensionsV1beta1Ingress_merge_expectedJson = []byte(`{
  "type.googleapis.com/istio.networking.v1alpha3.Gateway": [
    {
      "Metadata": {
  ...
  "type.googleapis.com/istio.networking.v1alpha3.VirtualService": [
    {
      "Metadata": {
        "name": "istio-system/foo-bar-com-foo-istio-autogenerated-k8s-ingress"
      },
      "Resource": {
        "gateways": [
...
func datasetExtensionsV1beta1Ingress_merge_expectedJsonBytes() ([]byte, error) {
	return _datasetExtensionsV1beta1Ingress_merge_expectedJson, nil
}

func datasetExtensionsV1beta1Ingress_merge_expectedJson() (*asset, error) {
	bytes, err := datasetExtensionsV1beta1Ingress_merge_expectedJsonBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "dataset/extensions/v1beta1/ingress_merge_expected.json", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _datasetExtensionsV1beta1Ingress_merge_expected_1Json = []byte(`{
  "type.googleapis.com/istio.networking.v1alpha3.Gateway": [
    {
      "Metadata": {
        "name": "istio-system/bar-istio-autogenerated-k8s-ingress"
...
func datasetExtensionsV1beta1Ingress_merge_expected_1JsonBytes() ([]byte, error) {
	return _datasetExtensionsV1beta1Ingress_merge_expected_1Json, nil
}

func datasetExtensionsV1beta1Ingress_merge_expected_1Json() (*asset, error) {
	bytes, err := datasetExtensionsV1beta1Ingress_merge_expected_1JsonBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "dataset/extensions/v1beta1/ingress_merge_expected_1.json", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _datasetExtensionsV1beta1Ingress_merge_meshconfigYaml = []byte(`ingressClass: cls
ingressControllerMode: STRICT
`)

func datasetExtensionsV1beta1Ingress_merge_meshconfigYamlBytes() ([]byte, error) {
	return _datasetExtensionsV1beta1Ingress_merge_meshconfigYaml, nil
}

func datasetExtensionsV1beta1Ingress_merge_meshconfigYaml() (*asset, error) {
	bytes, err := datasetExtensionsV1beta1Ingress_merge_meshconfigYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "dataset/extensions/v1beta1/ingress_merge_meshconfig.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"dataset/extensions/v1beta1/ingress_merge.yaml": datasetExtensionsV1beta1Ingress_mergeYaml,
	"dataset/extensions/v1beta1/ingress_merge_1.yaml": datasetExtensionsV1beta1Ingress_merge_1Yaml,
	"dataset/extensions/v1beta1/ingress_merge_expected.json": datasetExtensionsV1beta1Ingress_merge_expectedJson,
	"dataset/extensions/v1beta1/ingress_merge_expected_1.json": datasetExtensionsV1beta1Ingress_merge_expected_1Json,
	"dataset/extensions/v1beta1/ingress_merge_meshconfig.yaml": datasetExtensionsV1beta1Ingress_merge_meshconfigYaml,
	...
	"dataset": &bintree{nil, map[string]*bintree{
		...
		"extensions": &bintree{nil, map[string]*bintree{
			"v1beta1": &bintree{nil, map[string]*bintree{
				...
				"ingress_merge.yaml": &bintree{datasetExtensionsV1beta1Ingress_mergeYaml, map[string]*bintree{}},
				"ingress_merge_1.yaml": &bintree{datasetExtensionsV1beta1Ingress_merge_1Yaml, map[string]*bintree{}},
				"ingress_merge_expected.json": &bintree{datasetExtensionsV1beta1Ingress_merge_expectedJson, map[string]*bintree{}},
				"ingress_merge_expected_1.json": &bintree{datasetExtensionsV1beta1Ingress_merge_expected_1Json, map[string]*bintree{}},
				"ingress_merge_meshconfig.yaml": &bintree{datasetExtensionsV1beta1Ingress_merge_meshconfigYaml, map[string]*bintree{}},
			}},
		}},

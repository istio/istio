...
func (*ErrorGroup) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_536437fc134dd545, []int{0}
}
...
func (*TrackingIssue) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_536437fc134dd545, []int{1}
}
...
func (*ErrorEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_536437fc134dd545, []int{2}
}
...
func (*ServiceContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_536437fc134dd545, []int{3}
}
...
func (*ErrorContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_536437fc134dd545, []int{4}
}
...
func (*HttpRequestContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_536437fc134dd545, []int{5}
}
...
func (*SourceLocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_536437fc134dd545, []int{6}
}
...
func init() {
	proto.RegisterFile("google/devtools/clouderrorreporting/v1beta1/common.proto", fileDescriptor_common_536437fc134dd545)
}

var fileDescriptor_common_536437fc134dd545 = []byte{

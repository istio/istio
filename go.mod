...
require (
	...
	github.com/envoyproxy/go-control-plane v0.11.2-0.20230714173708-c934c2bfce23
	...
	istio.io/api v1.19.0-alpha.1.0.20230724155435-57fa7fdf7334
	istio.io/client-go v1.19.0-alpha.1.0.20230724160136-cf6b5390541a
...
require (
	...
	k8s.io/component-base v0.28.0-beta.0 // indirect

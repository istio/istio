...
func (s ReferenceSet) LocalPolicyTargetRef(ref gateway.LocalPolicyTargetReference, localNamespace string) (any, error) {
...
func (s ReferenceSet) LocalPolicyRef(ref gateway.LocalObjectReference, localNamespace string) (any, error) {
	return s.internal(string(ref.Name), string(ref.Group), string(ref.Kind), localNamespace)
}

...
func main() {
	...
	podName := flag.String("pod", "httpbin-v2-5556cf7bcc-89jgk", "pod name. If omit, pod name will be found from k8s registry using app label.")
	...
	podIP := flag.String("ip", "10.8.0.7", "pod IP. If omit, pod IP will be found from registry.")

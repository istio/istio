...
func setupConfig(cfg *istio.Config) {
	...
	cfg.Values["security.env.CITADEL_SELF_SIGNED_CA_CERT_TTL"] = "5m"
	cfg.Values["security.workloadCertTtl"] = "5m"
...
values:
  security:
    workloadCertTtl: 5m
    env:
      CITADEL_SELF_SIGNED_CA_CERT_TTL: 5m
      CITADEL_WORKLOAD_CERT_MIN_GRACE_PERIOD: 2m
      CITADEL_SELF_SIGNED_ROOT_CERT_GRACE_PERIOD_PERCENTILE: 100
      CITADEL_SELF_SIGNED_ROOT_CERT_CHECK_INTERVAL: 20s
`
}

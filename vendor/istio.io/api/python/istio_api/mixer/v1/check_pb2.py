...
_CHECKRESPONSE_PRECONDITIONRESULT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='attributes', full_name='istio.mixer.v1.CheckResponse.PreconditionResult.attributes', index=3,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='referenced_attributes', full_name='istio.mixer.v1.CheckResponse.PreconditionResult.referenced_attributes', index=4,
...
_CHECKRESPONSE_PRECONDITIONRESULT.fields_by_name['attributes'].message_type = mixer_dot_v1_dot_attributes__pb2._COMPRESSEDATTRIBUTES
...
_CHECKRESPONSE_PRECONDITIONRESULT.fields_by_name['attributes'].has_options = True
_CHECKRESPONSE_PRECONDITIONRESULT.fields_by_name['attributes']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))

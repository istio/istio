...
replace istio.io/api => github.com/zirain/api v0.0.0-20251008091933-a1a162821d5e
...
require (
	...
	istio.io/api v1.26.0-alpha.0.0.20251013193626-3200bbf5795e
	istio.io/client-go v1.26.0-alpha.0.0.20251013194303-fbfbcf30e44a
	k8s.io/api v0.34.1

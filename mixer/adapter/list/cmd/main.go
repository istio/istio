...
import (
	...
	"istio.io/istio/mixer/adapter/list/cmd/server"
)
...
func GetCmd(_ []string) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "listchecker",
		Short: "Istio listchecker out of process adapter.",
...
func runServer(args *Args) {
	s, err := server.NewListcheckerNoSessionServer(args.AdapterPort, args.APIWorkerPoolSize, args.Cert)
	if err != nil {

...
#echo 'Running pilot multi-cluster split horizon e2e tests'
./prow/e2e-suite.sh --timeout 50 --cluster_registry_dir="$CLUSTERREG_DIR" --auth_enable=true --single_test e2e_multicluster_split_horizon "$@"

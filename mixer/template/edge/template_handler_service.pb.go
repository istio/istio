...
type InstanceMsg struct {
	...
	DestinationServiceUid string `protobuf:"bytes,24,opt,name=destination_service_uid,json=destinationServiceUid,proto3" json:"destination_service_uid,omitempty"`
...
func (m *InstanceMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.DestinationServiceUid) > 0 {
		dAtA[i] = 0xc2
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintTemplateHandlerService(dAtA, i, uint64(len(m.DestinationServiceUid)))
		i += copy(dAtA[i:], m.DestinationServiceUid)
	}
...
func (this *InstanceMsg) String() string {
	...
	s := strings.Join([]string{`&InstanceMsg{`,
		...
		`DestinationServiceUid:` + fmt.Sprintf("%v", this.DestinationServiceUid) + `,`,
...
func (m *InstanceMsg) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 24:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DestinationServiceUid", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DestinationServiceUid = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 30:
			if wireType != 2 {
...
var fileDescriptorTemplateHandlerService = []byte{
	...
	,
}

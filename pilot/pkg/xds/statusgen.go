...
func (sg *StatusGen) Generate(proxy *model.Proxy, push *model.PushContext, w *model.WatchedResource, updates *model.PushRequest, delta bool) (model.Resources, model.XdsLogDetails, error) {
	res := model.Resources{}

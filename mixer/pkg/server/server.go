...
func newServer(a *Args, p *patchTable) (*Server, error) {
	...
	if a.UseNewRuntime {
		...
		runtime := p.newRuntime2(store2, templateMap, adapterMap, a.ConfigIdentityAttribute, a.ConfigDefaultNamespace, s.gp, s.adapterGP, a.TracingOptions.TracingEnabled())

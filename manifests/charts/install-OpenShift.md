...
```console
 helm install -n istio-system istiod manifests/charts/istio-control/istio-discovery --set pilot.cnienabled=true --set pilot.cnichained=false --set global.platform=openshift
```

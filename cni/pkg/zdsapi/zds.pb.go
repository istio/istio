...
// Add a workload to the zutnnel. this will be accompanied by ancillary data contianing
...
// Let ztunnel know that no snapshot will be sent, and no reconciliation is needed.
// will be removed once we wrap up the CNI, here for now to help with testing.
type NoSnapshotPresent struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *NoSnapshotPresent) Reset() {
	*x = NoSnapshotPresent{}
	if protoimpl.UnsafeEnabled {
...
func (x *NoSnapshotPresent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NoSnapshotPresent) ProtoMessage() {}

func (x *NoSnapshotPresent) ProtoReflect() protoreflect.Message {
	mi := &file_zdsapi_zds_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NoSnapshotPresent.ProtoReflect.Descriptor instead.
func (*NoSnapshotPresent) Descriptor() ([]byte, []int) {
...
type WorkloadRequest struct {
	...
	//	*WorkloadRequest_NoSnapshotPresent
...
func (x *WorkloadRequest) GetNoSnapshotPresent() *NoSnapshotPresent {
	if x, ok := x.GetPayload().(*WorkloadRequest_NoSnapshotPresent); ok {
		return x.NoSnapshotPresent
	}
	return nil
}
...
type WorkloadRequest_NoSnapshotPresent struct {
	NoSnapshotPresent *NoSnapshotPresent `protobuf:"bytes,4,opt,name=no_snapshot_present,json=noSnapshotPresent,proto3,oneof"`
}
...
func (*WorkloadRequest_NoSnapshotPresent) isWorkloadRequest_Payload() {}
...
var file_zdsapi_zds_proto_rawDesc = []byte{
	...
	,
	...
	,
}
...
var file_zdsapi_zds_proto_goTypes = []interface{}{
	(*AddWorkload)(nil),       // 0: istio.workload.zds.AddWorkload
	(*KeepWorkload)(nil),      // 1: istio.workload.zds.KeepWorkload
	(*DelWorkload)(nil),       // 2: istio.workload.zds.DelWorkload
	(*SnapshotSent)(nil),      // 3: istio.workload.zds.SnapshotSent
	(*NoSnapshotPresent)(nil), // 4: istio.workload.zds.NoSnapshotPresent
	(*Ack)(nil),               // 5: istio.workload.zds.Ack
	(*WorkloadRequest)(nil),   // 6: istio.workload.zds.WorkloadRequest
	(*WorkloadResponse)(nil),  // 7: istio.workload.zds.WorkloadResponse
}
var file_zdsapi_zds_proto_depIdxs = []int32{
	0, // 0: istio.workload.zds.WorkloadRequest.add:type_name -> istio.workload.zds.AddWorkload
	1, // 1: istio.workload.zds.WorkloadRequest.keep:type_name -> istio.workload.zds.KeepWorkload
	2, // 2: istio.workload.zds.WorkloadRequest.del:type_name -> istio.workload.zds.DelWorkload
	3, // 3: istio.workload.zds.WorkloadRequest.snapshot_sent:type_name -> istio.workload.zds.SnapshotSent
	4, // 4: istio.workload.zds.WorkloadRequest.no_snapshot_present:type_name -> istio.workload.zds.NoSnapshotPresent
	5, // 5: istio.workload.zds.WorkloadResponse.ack:type_name -> istio.workload.zds.Ack
...
func file_zdsapi_zds_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_zdsapi_zds_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NoSnapshotPresent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_zdsapi_zds_proto_msgTypes[6].OneofWrappers = []interface{}{
		...
		(*WorkloadRequest_NoSnapshotPresent)(nil),
	}

...
```console
 helm install -n istio-system istiod manifests/charts/istio-control/istio-discovery --set pilot.cni.enabled=true --set pilot.cni.provider=multus --set platform=openshift
```

...
import (
	...
	"istio.io/istio/mixer/adapter/bypass/cmd/server"
)
...
func GetCmd(_ []string) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "bypass",
		Short: "Istio bypass out of process adapter.",
...
func runServer(args *Args) {
	s, err := server.NewBypassNoSessionServer(args.AdapterPort, args.APIWorkerPoolSize, args.Cert)
	if err != nil {

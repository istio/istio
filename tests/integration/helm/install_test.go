	...
	framework.
		...
		Run(func(t framework.TestContext) {
			...
			setupInstallationWithCustomCheck(valuesAmbient, true, DefaultNamespaceConfig, func(t framework.TestContext) {
				...
				upgradeChart := func(values map[string]any) {
					...
					if err := h.UpgradeChart(CniReleaseName, filepath.Join(ManifestsChartPath, CniChartsDir), cniNs,
						overrideValuesFile, Timeout); err != nil {

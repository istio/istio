...
func (Params_MetricInfo_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_config_24e5d48da88d30a4, []int{0, 0, 0}
}
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_24e5d48da88d30a4, []int{0}
}
...
func (*Params_MetricInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_24e5d48da88d30a4, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("mixer/adapter/circonus/config/config.proto", fileDescriptor_config_24e5d48da88d30a4)
}

var fileDescriptor_config_24e5d48da88d30a4 = []byte{

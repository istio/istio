...
_INGRESSCONTROLLERMODE = _descriptor.EnumDescriptor(
  ...
  containing_type=None,
  serialized_options=None,
  serialized_start=28658,
  serialized_end=28715,
)

...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_dd433f189533f51f, []int{0}
}
...
func init() {
	proto.RegisterFile("mixer/adapter/opa/config/config.proto", fileDescriptor_config_dd433f189533f51f)
}

var fileDescriptor_config_dd433f189533f51f = []byte{

...
func (*PosixAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_a837ca35e2ee9479, []int{0}
}
...
func (*SshPublicKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_a837ca35e2ee9479, []int{1}
}
...
func init() {
	proto.RegisterFile("google/cloud/oslogin/common/common.proto", fileDescriptor_common_a837ca35e2ee9479)
}

var fileDescriptor_common_a837ca35e2ee9479 = []byte{

...
function merge_files() {
  ...
  cp $ISTIO $ISTIO_AUTH
  execute_sed "s/optional: true # FALSE WHEN AUTH IS ENABLED/optional: false/" $ISTIO_AUTH
  ...
  execute_sed "s/optional: true # FALSE WHEN AUTH IS ENABLED/optional: false/" $ISTIO_ONE_NAMESPACE_AUTH

...
func (*HandleTraceSpanRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tracespan_handler_service_f5c8f4cb855b7063, []int{0}
}
...
func (dst *HandleTraceSpanRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HandleTraceSpanRequest.Merge(dst, src)
}
...
type InstanceMsg struct {
	...
	//
	// Required.
	StartTime *v1beta1.TimeStamp `protobuf:"bytes,5,opt,name=start_time,json=startTime" json:"start_time,omitempty"`
	// The end time of the span.
	//
	// Required.
	EndTime *v1beta1.TimeStamp `protobuf:"bytes,6,opt,name=end_time,json=endTime" json:"end_time,omitempty"`
	...
	//
	// Optional.
	SpanTags map[string]*v1beta1.Value `protobuf:"bytes,7,rep,name=span_tags,json=spanTags" json:"span_tags,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
...
func (*InstanceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_tracespan_handler_service_f5c8f4cb855b7063, []int{1}
}
...
type Type struct {
	...
	//
	// Optional.
	SpanTags             map[string]v1beta1.ValueType `protobuf:"bytes,7,rep,name=span_tags,json=spanTags" json:"span_tags,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=istio.policy.v1beta1.ValueType"`
	XXX_NoUnkeyedLiteral struct{}                     `json:"-"`
	XXX_sizecache        int32                        `json:"-"`
}
...
func (*Type) Descriptor() ([]byte, []int) {
	return fileDescriptor_tracespan_handler_service_f5c8f4cb855b7063, []int{2}
}
...
func (*InstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptor_tracespan_handler_service_f5c8f4cb855b7063, []int{3}
}
...
func init() {
	proto.RegisterFile("mixer/template/tracespan/tracespan_handler_service.proto", fileDescriptor_tracespan_handler_service_f5c8f4cb855b7063)
}

var fileDescriptor_tracespan_handler_service_f5c8f4cb855b7063 = []byte{

...
function maybe_build_ztunnel() {
  ...
  mkdir -p "${ISITO_ZTUNNEL_LINUX_DEBUG_DIR}"
  cp out/rust/debug/ztunnel "${ISITO_ZTUNNEL_LINUX_DEBUG_DIR}/ztunnel"
  popd
}
...
ISITO_ZTUNNEL_LINUX_RELEASE_DIR="${ISITO_ZTUNNEL_LINUX_RELEASE_DIR:-${TARGET_OUT_LINUX}/release}"
ISITO_ZTUNNEL_LINUX_DEBUG_DIR="${ISITO_ZTUNNEL_LINUX_DEBUG_DIR:-${TARGET_OUT_LINUX}/debug}"
ISTIO_ZTUNNEL_LINUX_RELEASE_PATH="${ISTIO_ZTUNNEL_LINUX_RELEASE_PATH:-${ISITO_ZTUNNEL_LINUX_RELEASE_DIR}/${ISTIO_ZTUNNEL_LINUX_RELEASE_NAME}}"

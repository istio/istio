...
const (
	...
	routeAllRule             = rulesDirV2 + "/" + "route-rule-all-v1"
	routeReviewsVersionsRule = rulesDirV2 + "/" + "route-rule-reviews-v2-v3"
	routeReviewsV3Rule       = rulesDirV2 + "/" + "route-rule-reviews-v3"
	tcpDbRule                = rulesDirV2 + "/" + "route-rule-ratings-db"
	bookinfoGateway          = rulesDirV2 + "/" + "bookinfo-gateway"

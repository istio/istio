...
func init() {
	...
	b.Add(kube.ResourceSpec{
		...
		Version:   "v1alpha2",
		Group:     "config.istio.io",
		Target:    metadata.Types.Get("type.googleapis.com/istio.routing.v1alpha1.DestinationPolicy"),
		Converter: converter.Get("identity"),
	})
	...
	b.Add(kube.ResourceSpec{
		...
		Version:   "v1alpha2",
		Group:     "config.istio.io",
		Target:    metadata.Types.Get("type.googleapis.com/istio.routing.v1alpha1.EgressRule"),
		Converter: converter.Get("identity"),
	})
	...
	b.Add(kube.ResourceSpec{
		...
		Version:   "v1alpha2",
		Group:     "config.istio.io",
		Target:    metadata.Types.Get("type.googleapis.com/istio.routing.v1alpha1.RouteRule"),
		Converter: converter.Get("identity"),
	})

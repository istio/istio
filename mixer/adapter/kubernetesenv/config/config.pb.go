...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_53cd43f91b9375bf, []int{0}
}
...
func init() {
	proto.RegisterFile("mixer/adapter/kubernetesenv/config/config.proto", fileDescriptor_config_53cd43f91b9375bf)
}

var fileDescriptor_config_53cd43f91b9375bf = []byte{

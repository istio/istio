...
func (*AuditData) Descriptor() ([]byte, []int) {
	return fileDescriptor_audit_data_9496dc755f7c7674, []int{0}
}
...
func (*UpdateServiceMethod) Descriptor() ([]byte, []int) {
	return fileDescriptor_audit_data_9496dc755f7c7674, []int{1}
}
...
func (*CreateVersionMethod) Descriptor() ([]byte, []int) {
	return fileDescriptor_audit_data_9496dc755f7c7674, []int{2}
}
...
func init() {
	proto.RegisterFile("google/appengine/v1/audit_data.proto", fileDescriptor_audit_data_9496dc755f7c7674)
}

var fileDescriptor_audit_data_9496dc755f7c7674 = []byte{

...
func (Params_MetricConfig_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_config_edf9a54e0e9ba83e, []int{0, 0, 0}
}
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_edf9a54e0e9ba83e, []int{0}
}
...
func (*Params_MetricConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_edf9a54e0e9ba83e, []int{0, 0}
}
...
func (dst *Params_MetricConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Params_MetricConfig.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("mixer/adapter/signalfx/config/config.proto", fileDescriptor_config_edf9a54e0e9ba83e)
}

var fileDescriptor_config_edf9a54e0e9ba83e = []byte{

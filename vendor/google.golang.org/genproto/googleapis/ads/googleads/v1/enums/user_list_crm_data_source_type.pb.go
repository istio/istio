...
func (UserListCrmDataSourceTypeEnum_UserListCrmDataSourceType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_user_list_crm_data_source_type_47ddb41366f97bc2, []int{0, 0}
}
...
func (*UserListCrmDataSourceTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_user_list_crm_data_source_type_47ddb41366f97bc2, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/enums/user_list_crm_data_source_type.proto", fileDescriptor_user_list_crm_data_source_type_47ddb41366f97bc2)
}

var fileDescriptor_user_list_crm_data_source_type_47ddb41366f97bc2 = []byte{

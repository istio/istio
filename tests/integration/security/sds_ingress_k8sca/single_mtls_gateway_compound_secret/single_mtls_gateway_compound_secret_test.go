...
import (
	...
	ingressutil "istio.io/istio/tests/integration/security/sds_ingress_k8sca/util"
)
...
// TestSingleMTLSGateway_CompoundSecretRotation_K8sca tests a single mTLS ingress gateway with SDS enabled.
...
func TestSingleMTLSGateway_CompoundSecretRotation_K8sca(t *testing.T) {
	framework.
		NewTest(t).

...
import (
	...
	"istio.io/istio/mixer/adapter/redisquota/cmd/server"
)
...
func GetCmd(_ []string) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "zipkin",
		Short: "Istio zipkin out of process adapter.",
...
func runServer(args *Args) {
	s, err := server.NewZipkinNoSessionServer(args.AdapterPort, args.APIWorkerPoolSize, args.Cert)
	if err != nil {

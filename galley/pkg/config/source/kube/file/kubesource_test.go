...
func TestKubeSource_ApplyContent_Unchanged0Add1(t *testing.T) {
	...
	err := s.ApplyContent("foo", kubeyaml2.JoinString(data.YamlN1I1V1, data.YamlN2I2V1))
	g.Expect(err).To(BeNil())
	...
	err = s.ApplyContent("foo", kubeyaml2.JoinString(data.YamlN2I2V2, data.YamlN3I3V1))
	g.Expect(err).To(BeNil())
...
func TestKubeSource_RemoveContent(t *testing.T) {
	...
	err := s.ApplyContent("foo", kubeyaml2.JoinString(data.YamlN1I1V1, data.YamlN2I2V1))
	g.Expect(err).To(BeNil())
	err = s.ApplyContent("bar", kubeyaml2.JoinString(data.YamlN3I3V1))
	g.Expect(err).To(BeNil())
...
func TestKubeSource_UnparseableSegment(t *testing.T) {
	...
	err := s.ApplyContent("foo", kubeyaml2.JoinString(data.YamlN1I1V1, "invalidyaml\n", data.YamlN2I2V1))
...
func TestKubeSource_Unrecognized(t *testing.T) {
	...
	err := s.ApplyContent("foo", kubeyaml2.JoinString(data.YamlN1I1V1, data.YamlUnrecognized))
	g.Expect(err).To(BeNil())
...
func TestKubeSource_UnparseableResource(t *testing.T) {
	...
	err := s.ApplyContent("foo", kubeyaml2.JoinString(data.YamlN1I1V1, data.YamlUnparseableResource))
	g.Expect(err).To(Not(BeNil()))
...
func TestKubeSource_NonStringKey(t *testing.T) {
	...
	err := s.ApplyContent("foo", kubeyaml2.JoinString(data.YamlN1I1V1, data.YamlNonStringKey))
	g.Expect(err).To(Not(BeNil()))
...
func TestSameNameDifferentKind(t *testing.T) {
	...
	err := s.ApplyContent("foo", kubeyaml2.JoinString(data.YamlN1I1V1, data.YamlN1I1V1Kind2))
	g.Expect(err).To(BeNil())

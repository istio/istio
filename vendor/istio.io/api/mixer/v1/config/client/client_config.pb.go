...
func (m *HttpClientConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Transport != nil {
		...
		n9, err9 := m.Transport.MarshalTo(dAtA[i:])
		if err9 != nil {
			return 0, err9
		}
		i += n9
	...
	if m.MixerAttributes != nil {
		...
		i++
		i = encodeVarintClientConfig(dAtA, i, uint64(m.MixerAttributes.Size()))
		n11, err11 := m.MixerAttributes.MarshalTo(dAtA[i:])
		if err11 != nil {
			return 0, err11
		}
		i += n11
	...
	if m.ForwardAttributes != nil {
		...
		i++
		i = encodeVarintClientConfig(dAtA, i, uint64(m.ForwardAttributes.Size()))
		n12, err12 := m.ForwardAttributes.MarshalTo(dAtA[i:])
		if err12 != nil {
			return 0, err12
		}
		i += n12
...
func (m *TcpClientConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Transport != nil {
		...
		i++
		i = encodeVarintClientConfig(dAtA, i, uint64(m.Transport.Size()))
		n13, err13 := m.Transport.MarshalTo(dAtA[i:])
		if err13 != nil {
			return 0, err13
		}
		i += n13
	...
	if m.MixerAttributes != nil {
		...
		i++
		i = encodeVarintClientConfig(dAtA, i, uint64(m.MixerAttributes.Size()))
		n14, err14 := m.MixerAttributes.MarshalTo(dAtA[i:])
		if err14 != nil {
			return 0, err14
		}
		i += n14
	...
	if m.ConnectionQuotaSpec != nil {
		...
		n15, err15 := m.ConnectionQuotaSpec.MarshalTo(dAtA[i:])
		if err15 != nil {
			return 0, err15
		}
		i += n15
	...
	if m.ReportInterval != nil {
		...
		n16, err16 := m.ReportInterval.MarshalTo(dAtA[i:])
		if err16 != nil {
			return 0, err16
		}
		i += n16

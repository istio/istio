...
func TestHandleInboundIpv6RulesWithEmptyInboundPorts(t *testing.T) {
	...
	expected := []string{
		...
		"ip6tables -t nat -A ISTIO_IN_REDIRECT -p tcp -j REDIRECT --to-port 15006",
		"ip6tables -t nat -A OUTPUT -p tcp -j ISTIO_OUTPUT",
		"ip6tables -t nat -A ISTIO_OUTPUT -o lo -s ::6/128 -j RETURN",
		"ip6tables -t nat -A ISTIO_OUTPUT -s ::1/128 ! -d ::1/128 -m owner --uid-owner 1337 -j RETURN",
		"ip6tables -t nat -A ISTIO_OUTPUT -s ::1/128 ! -d ::1/128 -m owner --gid-owner 1337 -j RETURN",
...
func TestRulesWithIpRange(t *testing.T) {
	...
	expected := []string{
		...
		"iptables -t nat -A ISTIO_OUTPUT -s 127.0.0.1/32 ! -d 127.0.0.1/32 -m owner --uid-owner 3 -j RETURN",
		"iptables -t nat -A ISTIO_OUTPUT -s 127.0.0.1/32 ! -d 127.0.0.1/32 -m owner --uid-owner 4 -j RETURN",
		"iptables -t nat -A ISTIO_OUTPUT -s 127.0.0.1/32 ! -d 127.0.0.1/32 -m owner --gid-owner 1 -j RETURN",
		"iptables -t nat -A ISTIO_OUTPUT -s 127.0.0.1/32 ! -d 127.0.0.1/32 -m owner --gid-owner 2 -j RETURN",
...
func TestHandleInboundIpv6RulesWithUidGid(t *testing.T) {
	...
	expected := []string{
		...
		"ip6tables -t nat -A OUTPUT -p tcp -j ISTIO_OUTPUT",
		"ip6tables -t nat -A ISTIO_OUTPUT -o lo -s ::6/128 -j RETURN",
		"ip6tables -t nat -A ISTIO_OUTPUT -s ::1/128 ! -d ::1/128 -m owner --uid-owner 3 -j RETURN",
		"ip6tables -t nat -A ISTIO_OUTPUT -s ::1/128 ! -d ::1/128 -m owner --uid-owner 4 -j RETURN",
		"ip6tables -t nat -A ISTIO_OUTPUT -s ::1/128 ! -d ::1/128 -m owner --gid-owner 1 -j RETURN",
		"ip6tables -t nat -A ISTIO_OUTPUT -s ::1/128 ! -d ::1/128 -m owner --gid-owner 2 -j RETURN",

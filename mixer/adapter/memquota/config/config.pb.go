...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_88761cfb7428189c, []int{0}
}
...
func (*Params_Quota) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_88761cfb7428189c, []int{0, 0}
}
...
func (*Params_Override) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_88761cfb7428189c, []int{0, 1}
}
...
func init() {
	proto.RegisterFile("mixer/adapter/memquota/config/config.proto", fileDescriptor_config_88761cfb7428189c)
}

var fileDescriptor_config_88761cfb7428189c = []byte{

...
func init() {
	...
	discoveryCmd.PersistentFlags().BoolVar(&serverArgs.Config.DisableInstallCRDs, "disable-install-crds", false,
		"Disable Pilot Discovery from verifying the existence of CRDs at startup and then installing if not detected.  It is recommended to be disable for highly available setups.")

...
0. If you are cutting a release off of a release branch other than master, you could have the `downloadIstioCandidate.sh` script in master branch to take on the release your just made by also specifying the flag `--update_rel_branches=master`.

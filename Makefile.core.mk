...
lint-go-pkgs:
	@golangci-lint run -v -c ./common/config/.golangci.yml ./galley/...
	@golangci-lint run -v -c ./common/config/.golangci.yml ./istioctl/...
	@golangci-lint run -v -c ./common/config/.golangci.yml ./mixer/...
	@golangci-lint run -v -c ./common/config/.golangci.yml ./pilot/...
	@golangci-lint run -v -c ./common/config/.golangci.yml ./pkg/...
	@golangci-lint run -v -c ./common/config/.golangci.yml ./samples/...
	@golangci-lint run -v -c ./common/config/.golangci.yml ./security/...
	@golangci-lint run -v -c ./common/config/.golangci.yml ./sidecar-injector/...
	@golangci-lint run -v -c ./common/config/.golangci.yml ./tests/...
	@golangci-lint run -v -c ./common/config/.golangci.yml ./tools/...

lint: lint-go-pkgs lint-python lint-copyright-banner lint-scripts lint-dockerfiles lint-markdown lint-yaml lint-licenses
	@bin/check_helm.sh

...
const (
	// Default is the default group that is returned for MCP requests.
	Default = snapshot.DefaultGroup
...
// IndexFunction is a snapshot.GroupIndexFn used for the Galley processor. If the request is for the
// collection metadata.SyntheticServiceEntry, the SyntheticServiceEntry snapshot is used. Otherwise the Default
// snapshot is used.

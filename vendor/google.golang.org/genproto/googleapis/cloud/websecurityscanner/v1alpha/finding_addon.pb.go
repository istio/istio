...
func (*OutdatedLibrary) Descriptor() ([]byte, []int) {
	return fileDescriptor_finding_addon_e309707b5445314c, []int{0}
}
...
func (*ViolatingResource) Descriptor() ([]byte, []int) {
	return fileDescriptor_finding_addon_e309707b5445314c, []int{1}
}
...
func (*VulnerableParameters) Descriptor() ([]byte, []int) {
	return fileDescriptor_finding_addon_e309707b5445314c, []int{2}
}
...
func (*Xss) Descriptor() ([]byte, []int) {
	return fileDescriptor_finding_addon_e309707b5445314c, []int{3}
}
...
func init() {
	proto.RegisterFile("google/cloud/websecurityscanner/v1alpha/finding_addon.proto", fileDescriptor_finding_addon_e309707b5445314c)
}

var fileDescriptor_finding_addon_e309707b5445314c = []byte{

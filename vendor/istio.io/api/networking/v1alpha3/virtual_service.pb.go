...
// ExternalService rule. VirtualServices can then be defined to control traffic
// bound to these external services. For example, the following rules define an
// ExternalService for wikipedia.org and set a timeout of 5s for http requests.
//
//     apiVersion: networking.istio.io/v1alpha3

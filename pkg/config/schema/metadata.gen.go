...
func metadataYaml() (*asset, error) {
	...
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x1f, 0xe3, 0x27, 0x76, 0x50, 0x66, 0xfc, 0xd7, 0x15, 0xa6, 0xb5, 0xad, 0x73, 0x85, 0x90, 0x8e, 0x9c, 0xf6, 0x53, 0xa3, 0x66, 0xbb, 0xec, 0x6a, 0xd6, 0xb4, 0xd6, 0x60, 0xc5, 0xf1, 0x50, 0x95}}
	return a, nil
}

...
//go:generate sh -c "go list github.com/envoyproxy/go-control-plane/contrib/... | grep 'v3' | grep -v /pkg/ | grep -v alpn | grep -v istio_stats | grep -v workload_discovery | xargs -I{} echo '\t_ \"{}\"' >> filter_types.gen.go"

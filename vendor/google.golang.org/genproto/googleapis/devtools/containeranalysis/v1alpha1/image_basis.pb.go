...
func (DockerImage_Layer_Directive) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_image_basis_dd699757c3ae6d0c, []int{0, 0, 0}
}
...
func (*DockerImage) Descriptor() ([]byte, []int) {
	return fileDescriptor_image_basis_dd699757c3ae6d0c, []int{0}
}
...
func (*DockerImage_Layer) Descriptor() ([]byte, []int) {
	return fileDescriptor_image_basis_dd699757c3ae6d0c, []int{0, 0}
}
...
func (*DockerImage_Fingerprint) Descriptor() ([]byte, []int) {
	return fileDescriptor_image_basis_dd699757c3ae6d0c, []int{0, 1}
}
...
func (*DockerImage_Basis) Descriptor() ([]byte, []int) {
	return fileDescriptor_image_basis_dd699757c3ae6d0c, []int{0, 2}
}
...
func (*DockerImage_Derived) Descriptor() ([]byte, []int) {
	return fileDescriptor_image_basis_dd699757c3ae6d0c, []int{0, 3}
}
...
func init() {
	proto.RegisterFile("google/devtools/containeranalysis/v1alpha1/image_basis.proto", fileDescriptor_image_basis_dd699757c3ae6d0c)
}

var fileDescriptor_image_basis_dd699757c3ae6d0c = []byte{

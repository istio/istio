...
func (Myenum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_types_9d5058dc07c0836e, []int{0}
}
...
func (OtherInnerenum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_types_9d5058dc07c0836e, []int{2, 0}
}
...
type Simple struct {
	...
	IstioValue                   *v1beta1.Value                   `protobuf:"bytes,65,opt,name=istio_value,json=istioValue" json:"istio_value,omitempty"`
	MapStrIstioValue             map[string]*v1beta1.Value        `protobuf:"bytes,66,rep,name=map_str_istio_value,json=mapStrIstioValue" json:"map_str_istio_value,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	IpaddressIstioValue          *v1beta1.IPAddress               `protobuf:"bytes,67,opt,name=ipaddress_istio_value,json=ipaddressIstioValue" json:"ipaddress_istio_value,omitempty"`
	MapStrIpaddressIstioValue    map[string]*v1beta1.IPAddress    `protobuf:"bytes,68,rep,name=map_str_ipaddress_istio_value,json=mapStrIpaddressIstioValue" json:"map_str_ipaddress_istio_value,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	DurationIstioValue           *v1beta1.Duration                `protobuf:"bytes,69,opt,name=duration_istio_value,json=durationIstioValue" json:"duration_istio_value,omitempty"`
	MapStrDurationIstioValue     map[string]*v1beta1.Duration     `protobuf:"bytes,70,rep,name=map_str_duration_istio_value,json=mapStrDurationIstioValue" json:"map_str_duration_istio_value,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	TimestampIstioValue          *v1beta1.TimeStamp               `protobuf:"bytes,71,opt,name=timestamp_istio_value,json=timestampIstioValue" json:"timestamp_istio_value,omitempty"`
	MapStrTimestampIstioValue    map[string]*v1beta1.TimeStamp    `protobuf:"bytes,72,rep,name=map_str_timestamp_istio_value,json=mapStrTimestampIstioValue" json:"map_str_timestamp_istio_value,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	DnsnameIstioValue            *v1beta1.DNSName                 `protobuf:"bytes,73,opt,name=dnsname_istio_value,json=dnsnameIstioValue" json:"dnsname_istio_value,omitempty"`
	MapStrDnsnameIstioValue      map[string]*v1beta1.DNSName      `protobuf:"bytes,74,rep,name=map_str_dnsname_istio_value,json=mapStrDnsnameIstioValue" json:"map_str_dnsname_istio_value,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	EmailaddressIstioValue       *v1beta1.EmailAddress            `protobuf:"bytes,75,opt,name=emailaddress_istio_value,json=emailaddressIstioValue" json:"emailaddress_istio_value,omitempty"`
	MapStrEmailaddressIstioValue map[string]*v1beta1.EmailAddress `protobuf:"bytes,76,rep,name=map_str_emailaddress_istio_value,json=mapStrEmailaddressIstioValue" json:"map_str_emailaddress_istio_value,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	UriIstioValue                *v1beta1.Uri                     `protobuf:"bytes,77,opt,name=uri_istio_value,json=uriIstioValue" json:"uri_istio_value,omitempty"`
	MapStrUriIstioValue          map[string]*v1beta1.Uri          `protobuf:"bytes,78,rep,name=map_str_uri_istio_value,json=mapStrUriIstioValue" json:"map_str_uri_istio_value,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	GoogleProtobufDuration       *types.Duration                  `protobuf:"bytes,79,opt,name=google_protobuf_duration,json=googleProtobufDuration" json:"google_protobuf_duration,omitempty"`
	GoogleProtobufTimestamp      *types.Timestamp                 `protobuf:"bytes,80,opt,name=google_protobuf_timestamp,json=googleProtobufTimestamp" json:"google_protobuf_timestamp,omitempty"`
	XXX_NoUnkeyedLiteral         struct{}                         `json:"-"`
	XXX_sizecache                int32                            `json:"-"`
}
...
func (*Simple) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_9d5058dc07c0836e, []int{1}
}
...
func (*Other) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_9d5058dc07c0836e, []int{2}
}
...
func (dst *Other) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Other.Merge(dst, src)
}
...
func (dst *OtherInnerMsg) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OtherInnerMsg.Merge(dst, src)
}
...
func (*Outer) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_9d5058dc07c0836e, []int{3}
}
...
func (dst *Outer) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Outer.Merge(dst, src)
}
...
func (*Outer_Inner) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_9d5058dc07c0836e, []int{3, 0}
}
...
func (dst *Outer_Inner) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Outer_Inner.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("mixer/pkg/protobuf/yaml/testdata/all/types.proto", fileDescriptor_types_9d5058dc07c0836e)
}

var fileDescriptor_types_9d5058dc07c0836e = []byte{

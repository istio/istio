...
import (
	...
	"istio.io/istio/mixer/adapter/solarwinds/cmd/server"
)
...
func GetCmd(_ []string) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "solarwinds",
		Short: "Istio solarwinds out of process adapter.",
...
func runServer(args *Args) {
	s, err := server.NewSolarwindsNoSessionServer(args.AdapterPort, args.APIWorkerPoolSize, args.Cert)
	if err != nil {

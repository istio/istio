...
type InstanceMsg struct {
	...
	RewriteId bool `protobuf:"varint,10,opt,name=rewrite_id,json=rewriteId,proto3" json:"rewrite_id,omitempty"`
}
...
type InstanceParam struct {
	...
	// rewriting both span id of client span and parent span id of server span
	// to the same newly generated id.
	RewriteId string `protobuf:"bytes,10,opt,name=rewrite_id,json=rewriteId,proto3" json:"rewrite_id,omitempty"`
}
...
func (m *InstanceParam) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.RewriteId) > 0 {
		dAtA[i] = 0x52
		i++
		i = encodeVarintTracespanHandlerService(dAtA, i, uint64(len(m.RewriteId)))
		i += copy(dAtA[i:], m.RewriteId)
	}
	return i, nil
}
...
func (this *InstanceMsg) String() string {
	...
	s := strings.Join([]string{`&InstanceMsg{`,
		...
		`RewriteId:` + fmt.Sprintf("%v", this.RewriteId) + `,`,
...
func (m *InstanceMsg) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RewriteId", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *InstanceParam) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			m.RewriteId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTracespanHandlerService(dAtA[iNdEx:])
...
var fileDescriptorTracespanHandlerService = []byte{
	...
	,
}

...
func (ExtensionSettingErrorEnum_ExtensionSettingError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_extension_setting_error_b5d2314027ef414a, []int{0, 0}
}
...
func (*ExtensionSettingErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_extension_setting_error_b5d2314027ef414a, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/errors/extension_setting_error.proto", fileDescriptor_extension_setting_error_b5d2314027ef414a)
}

var fileDescriptor_extension_setting_error_b5d2314027ef414a = []byte{

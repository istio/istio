...
It is generated from these files:
	envoy/extensions/filters/network/thrift_proxy/v2alpha1/router/router.proto
...
func init() {
	proto.RegisterFile("envoy/extensions/filters/network/thrift_proxy/v2alpha1/router/router.proto", fileDescriptorRouter)
}

...
var testGrid = []testCase{
	...
	},
	{
		...
		expected: []message{
			...
			{msg.NoMatchingWorkloadsFound, "AuthorizationPolicy httpbin/httpbin-L7-deny2"},
			...
			{msg.ReferencedResourceNotFound, "AuthorizationPolicy httpbin/httpbin-bogus-not-ns"},
			{msg.RejectedTCPTrafficAuthz, "AuthorizationPolicy httpbin/httpbin-L7-deny1"},
			{msg.RejectedTCPTrafficAuthz, "AuthorizationPolicy httpbin/httpbin-L7-deny2"},
			{msg.RejectedTCPTrafficAuthz, "AuthorizationPolicy httpbin/httpbin-L7-deny2"},
			{msg.RejectedTCPTrafficAuthz, "AuthorizationPolicy httpbin/httpbin-L7-deny3"},
		},
	},
	{

...
func ValidateIstioService(svc *routerule.IstioService) (errs error) {
...
func ValidateMatchCondition(mc *routerule.MatchCondition) (errs error) {
	if mc.Source != nil {
...
func ValidateStringMatch(match *routerule.StringMatch) error {
	switch match.MatchType.(type) {
	case *routerule.StringMatch_Exact, *routerule.StringMatch_Prefix, *routerule.StringMatch_Regex:
	default:
...
func ValidateL4MatchAttributes(ma *routerule.L4MatchAttributes) (errs error) {
...
func ValidateDestinationWeight(dw *routerule.DestinationWeight) (errs error) {
...
func ValidateHTTPTimeout(timeout *routerule.HTTPTimeout) (errs error) {
...
func ValidateHTTPRetries(retry *routerule.HTTPRetry) (errs error) {
...
func ValidateHTTPFault(fault *routerule.HTTPFaultInjection) (errs error) {
...
func ValidateL4Fault(fault *routerule.L4FaultInjection) (errs error) {
...
func ValidateDelay(delay *routerule.HTTPFaultInjection_Delay) (errs error) {
...
func ValidateAbortHTTPStatus(httpStatus *routerule.HTTPFaultInjection_Abort_HttpStatus) (errs error) {
...
func ValidateAbort(abort *routerule.HTTPFaultInjection_Abort) (errs error) {
	if err := ValidateFloatPercent(abort.Percent); err != nil {
		errs = multierror.Append(errs, multierror.Prefix(err, "percent invalid: "))
	}

	switch abort.ErrorType.(type) {
	case *routerule.HTTPFaultInjection_Abort_GrpcStatus:
	...
	case *routerule.HTTPFaultInjection_Abort_Http2Error:
		// TODO No validation yet for grpc_status / http2_error / http_status
	case *routerule.HTTPFaultInjection_Abort_HttpStatus:
		if err := ValidateAbortHTTPStatus(abort.ErrorType.(*routerule.HTTPFaultInjection_Abort_HttpStatus)); err != nil {
			errs = multierror.Append(errs, err)
		}
	}
...
func ValidateTerminate(terminate *routerule.L4FaultInjection_Terminate) (errs error) {
...
func ValidateThrottle(throttle *routerule.L4FaultInjection_Throttle) (errs error) {
...
func ValidateLoadBalancing(lb *routerule.LoadBalancing) (errs error) {
	if lb.LbPolicy == nil {
...
func ValidateCircuitBreaker(cb *routerule.CircuitBreaker) (errs error) {
...
func ValidateWeights(routes []*routerule.DestinationWeight) (errs error) {
	// Sum weights
	sum := 0
...
func ValidateRouteRule(msg proto.Message) error {
	value, ok := msg.(*routerule.RouteRule)
	if !ok {
...
func ValidateIngressRule(msg proto.Message) error {
	value, ok := msg.(*routerule.IngressRule)
	if !ok {
...
func ValidateEgressRule(msg proto.Message) error {
	rule, ok := msg.(*routerule.EgressRule)
	if !ok {
...
func ValidateEgressRuleDestination(destination *routerule.IstioService) error {
	if destination == nil {
...
func ValidateEgressRulePort(port *routerule.EgressRule_Port) error {
...
func ValidateDestinationPolicy(msg proto.Message) error {
	policy, ok := msg.(*routerule.DestinationPolicy)
	if !ok {

...
func TestValidateInterfaceNames(t *testing.T) {
	tests := []struct {
		...
		{"interface starting with underscore", "_eth0", false},
		{"complex valid names", "veth123abc,br-docker0,bond0.100", false},
		{"max length interface", "123456789012345", false},
		...
		{"interface with leading space", " eth0", false},
		{"interface with trailing space", "eth0 ", false},
		{"valid interface with spaces around comma", "eth0 , eth1", false},

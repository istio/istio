...
import (
	...
	"istio.io/istio/mixer/adapter/dogstatsd/cmd/server"
)
...
func GetCmd(_ []string) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "dogstatsd",
		Short: "Istio dogstatsd out of process adapter.",
...
func runServer(args *Args) {
	s, err := server.NewDogstatsdNoSessionServer(args.AdapterPort, args.APIWorkerPoolSize, args.Cert)
	if err != nil {
